...
var file_yandex_cloud_access_access_proto_rawDesc = []byte{
	...
	0x02, 0x42, 0x59, 0x0a, 0x17, 0x79, 0x61, 0x6e, 0x64, 0x65, 0x78, 0x2e, 0x63, 0x6c, 0x6f, 0x75,
	0x64, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x5a, 0x3e, 0x67, 0x69,
	...
	0x63, 0x63, 0x65, 0x73, 0x73, 0x3b, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
func file_yandex_cloud_access_access_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yandex_cloud_access_access_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_access_access_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_access_access_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_access_access_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_access_access_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_access_access_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_access_access_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_access_access_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_access_access_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_access_access_proto_msgTypes[9].Exporter = func(v any, i int) any {

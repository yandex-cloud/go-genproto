...
func file_yandex_cloud_ai_foundation_models_v1_image_generation_image_generation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yandex_cloud_ai_foundation_models_v1_image_generation_image_generation_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_ai_foundation_models_v1_image_generation_image_generation_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_ai_foundation_models_v1_image_generation_image_generation_proto_msgTypes[2].Exporter = func(v any, i int) any {

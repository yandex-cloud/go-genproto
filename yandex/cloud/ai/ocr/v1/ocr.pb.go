...
func file_yandex_cloud_ai_ocr_v1_ocr_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yandex_cloud_ai_ocr_v1_ocr_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_ai_ocr_v1_ocr_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Vertex); i {
			case 0:
				return &v.state
			case 1:
		...
		file_yandex_cloud_ai_ocr_v1_ocr_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_ai_ocr_v1_ocr_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Entity); i {
			case 0:
				return &v.state
			case 1:
		...
		file_yandex_cloud_ai_ocr_v1_ocr_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*Block); i {
			case 0:
				return &v.state
			case 1:
		...
		file_yandex_cloud_ai_ocr_v1_ocr_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*Line); i {
			case 0:
				return &v.state
			case 1:
		...
		file_yandex_cloud_ai_ocr_v1_ocr_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*Word); i {
			case 0:
				return &v.state
			case 1:
		...
		file_yandex_cloud_ai_ocr_v1_ocr_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_ai_ocr_v1_ocr_proto_msgTypes[8].Exporter = func(v any, i int) any {
			switch v := v.(*Table); i {
			case 0:
				return &v.state
			case 1:
		...
		file_yandex_cloud_ai_ocr_v1_ocr_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_ai_ocr_v1_ocr_proto_msgTypes[10].Exporter = func(v any, i int) any {

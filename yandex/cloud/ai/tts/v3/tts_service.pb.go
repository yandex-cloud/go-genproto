...
func (c *synthesizerClient) UtteranceSynthesis(ctx context.Context, in *UtteranceSynthesisRequest, opts ...grpc.CallOption) (Synthesizer_UtteranceSynthesisClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Synthesizer_serviceDesc.Streams[0], "/speechkit.tts.v3.Synthesizer/UtteranceSynthesis", opts...)
	if err != nil {
		return nil, err
	}
...
// UnimplementedSynthesizerServer can be embedded to have forward compatible implementations.

...
func file_yandex_cloud_ai_vision_v1_classification_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yandex_cloud_ai_vision_v1_classification_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_ai_vision_v1_classification_proto_msgTypes[1].Exporter = func(v any, i int) any {

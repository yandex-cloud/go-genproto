...
func file_yandex_cloud_ai_vision_v1_primitives_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yandex_cloud_ai_vision_v1_primitives_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_ai_vision_v1_primitives_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Vertex); i {
			case 0:
				return &v.state
			case 1:

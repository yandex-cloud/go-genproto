...
var file_yandex_cloud_apploadbalancer_v1_target_group_proto_rawDesc = []byte{
	...
	0x02, 0x38, 0x01, 0x22, 0x94, 0x01, 0x0a, 0x06, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x12, 0x1f,
	...
	0xc0, 0xc1, 0x31, 0x01, 0x4a, 0x04, 0x08, 0x02, 0x10, 0x03, 0x42, 0x7a, 0x0a, 0x23, 0x79, 0x61,
...
func file_yandex_cloud_apploadbalancer_v1_target_group_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yandex_cloud_apploadbalancer_v1_target_group_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_apploadbalancer_v1_target_group_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Target); i {
			case 0:
				return &v.state
			case 1:

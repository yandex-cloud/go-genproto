...
// UnimplementedBillingAccountServiceServer can be embedded to have forward compatible implementations.
...
func RegisterBillingAccountServiceServer(s *grpc.Server, srv BillingAccountServiceServer) {
	s.RegisterService(&_BillingAccountService_serviceDesc, srv)
}
...
var _BillingAccountService_serviceDesc = grpc.ServiceDesc{

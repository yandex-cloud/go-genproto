...
func file_yandex_cloud_billing_v1_customer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yandex_cloud_billing_v1_customer_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_billing_v1_customer_proto_msgTypes[1].Exporter = func(v any, i int) any {

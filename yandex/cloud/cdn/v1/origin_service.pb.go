...
type CreateOriginRequest struct {
	...
	//
	// Default value: False.
	Backup *wrappers.BoolValue `protobuf:"bytes,5,opt,name=backup,proto3" json:"backup,omitempty"`
...
func (x *CreateOriginRequest) GetEnabled() *wrappers.BoolValue {
	if x != nil {
		return x.Enabled
	}
	return nil
...
func (x *CreateOriginRequest) GetBackup() *wrappers.BoolValue {
	if x != nil {
		return x.Backup
	}
	return nil

...
const file_yandex_cloud_compute_v1_disk_type_proto_rawDesc = "" +
	"\n" +
	"'yandex/cloud/compute/v1/disk_type.proto\x12\x17yandex.cloud.compute.v1\"W\n" +
	"\bDiskType\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12\x19\n" +
	"\bzone_ids\x18\x03 \x03(\tR\azoneIdsBb\n" +
	"\x1byandex.cloud.api.compute.v1ZCgithub.com/yandex-cloud/go-genproto/yandex/cloud/compute/v1;computeb\x06proto3"

var (
	file_yandex_cloud_compute_v1_disk_type_proto_rawDescOnce sync.Once
	file_yandex_cloud_compute_v1_disk_type_proto_rawDescData []byte
)
...
func file_yandex_cloud_compute_v1_disk_type_proto_rawDescGZIP() []byte {
	file_yandex_cloud_compute_v1_disk_type_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_compute_v1_disk_type_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_yandex_cloud_compute_v1_disk_type_proto_rawDesc), len(file_yandex_cloud_compute_v1_disk_type_proto_rawDesc)))
	})
...
var file_yandex_cloud_compute_v1_disk_type_proto_goTypes = []any{
...
func file_yandex_cloud_compute_v1_disk_type_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_yandex_cloud_compute_v1_disk_type_proto_rawDesc), len(file_yandex_cloud_compute_v1_disk_type_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,

...
var file_yandex_cloud_compute_v1_host_group_proto_rawDesc = []byte{
	...
	0x64, 0x6c, 0x69, 0x6e, 0x65, 0x41, 0x74, 0x42, 0x62, 0x0a, 0x1b, 0x79, 0x61, 0x6e, 0x64, 0x65,
...
func file_yandex_cloud_compute_v1_host_group_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yandex_cloud_compute_v1_host_group_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_compute_v1_host_group_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Host); i {
			case 0:
				return &v.state
			case 1:
		...
		file_yandex_cloud_compute_v1_host_group_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_compute_v1_host_group_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_compute_v1_host_group_proto_msgTypes[5].Exporter = func(v any, i int) any {

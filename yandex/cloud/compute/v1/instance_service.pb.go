...
var file_yandex_cloud_compute_v1_instance_service_proto_rawDesc = []byte{
	...
	0x64, 0x22, 0x86, 0x01, 0x0a, 0x17, 0x52, 0x65, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x65, 0x49, 0x6e,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x5a, 0x6f, 0x6e, 0x65, 0x49, 0x64, 0x22, 0x91, 0x01, 0x0a, 0x18, 0x52,
...
var file_yandex_cloud_compute_v1_instance_service_proto_goTypes = []interface{}{
	...
	(*access.ListAccessBindingsRequest)(nil),       // 69: yandex.cloud.access.ListAccessBindingsRequest
	(*access.SetAccessBindingsRequest)(nil),        // 70: yandex.cloud.access.SetAccessBindingsRequest
	(*access.UpdateAccessBindingsRequest)(nil),     // 71: yandex.cloud.access.UpdateAccessBindingsRequest
	(*access.ListAccessBindingsResponse)(nil),      // 72: yandex.cloud.access.ListAccessBindingsResponse
}
var file_yandex_cloud_compute_v1_instance_service_proto_depIdxs = []int32{
	...
	68, // 40: yandex.cloud.compute.v1.AttachedDiskSpec.DiskSpec.disk_placement_policy:type_name -> yandex.cloud.compute.v1.DiskPlacementPolicy
	3,  // 41: yandex.cloud.compute.v1.InstanceService.Get:input_type -> yandex.cloud.compute.v1.GetInstanceRequest
	4,  // 42: yandex.cloud.compute.v1.InstanceService.List:input_type -> yandex.cloud.compute.v1.ListInstancesRequest
	6,  // 43: yandex.cloud.compute.v1.InstanceService.Create:input_type -> yandex.cloud.compute.v1.CreateInstanceRequest
	8,  // 44: yandex.cloud.compute.v1.InstanceService.Update:input_type -> yandex.cloud.compute.v1.UpdateInstanceRequest
	10, // 45: yandex.cloud.compute.v1.InstanceService.Delete:input_type -> yandex.cloud.compute.v1.DeleteInstanceRequest
	12, // 46: yandex.cloud.compute.v1.InstanceService.UpdateMetadata:input_type -> yandex.cloud.compute.v1.UpdateInstanceMetadataRequest
	14, // 47: yandex.cloud.compute.v1.InstanceService.GetSerialPortOutput:input_type -> yandex.cloud.compute.v1.GetInstanceSerialPortOutputRequest
	16, // 48: yandex.cloud.compute.v1.InstanceService.Stop:input_type -> yandex.cloud.compute.v1.StopInstanceRequest
	18, // 49: yandex.cloud.compute.v1.InstanceService.Start:input_type -> yandex.cloud.compute.v1.StartInstanceRequest
	20, // 50: yandex.cloud.compute.v1.InstanceService.Restart:input_type -> yandex.cloud.compute.v1.RestartInstanceRequest
	22, // 51: yandex.cloud.compute.v1.InstanceService.AttachDisk:input_type -> yandex.cloud.compute.v1.AttachInstanceDiskRequest
	24, // 52: yandex.cloud.compute.v1.InstanceService.DetachDisk:input_type -> yandex.cloud.compute.v1.DetachInstanceDiskRequest
	26, // 53: yandex.cloud.compute.v1.InstanceService.AttachFilesystem:input_type -> yandex.cloud.compute.v1.AttachInstanceFilesystemRequest
	28, // 54: yandex.cloud.compute.v1.InstanceService.DetachFilesystem:input_type -> yandex.cloud.compute.v1.DetachInstanceFilesystemRequest
	30, // 55: yandex.cloud.compute.v1.InstanceService.AddOneToOneNat:input_type -> yandex.cloud.compute.v1.AddInstanceOneToOneNatRequest
	32, // 56: yandex.cloud.compute.v1.InstanceService.RemoveOneToOneNat:input_type -> yandex.cloud.compute.v1.RemoveInstanceOneToOneNatRequest
	34, // 57: yandex.cloud.compute.v1.InstanceService.UpdateNetworkInterface:input_type -> yandex.cloud.compute.v1.UpdateInstanceNetworkInterfaceRequest
	36, // 58: yandex.cloud.compute.v1.InstanceService.ListOperations:input_type -> yandex.cloud.compute.v1.ListInstanceOperationsRequest
	46, // 59: yandex.cloud.compute.v1.InstanceService.Move:input_type -> yandex.cloud.compute.v1.MoveInstanceRequest
	48, // 60: yandex.cloud.compute.v1.InstanceService.Relocate:input_type -> yandex.cloud.compute.v1.RelocateInstanceRequest
	69, // 61: yandex.cloud.compute.v1.InstanceService.ListAccessBindings:input_type -> yandex.cloud.access.ListAccessBindingsRequest
	70, // 62: yandex.cloud.compute.v1.InstanceService.SetAccessBindings:input_type -> yandex.cloud.access.SetAccessBindingsRequest
	71, // 63: yandex.cloud.compute.v1.InstanceService.UpdateAccessBindings:input_type -> yandex.cloud.access.UpdateAccessBindingsRequest
	59, // 64: yandex.cloud.compute.v1.InstanceService.Get:output_type -> yandex.cloud.compute.v1.Instance
	5,  // 65: yandex.cloud.compute.v1.InstanceService.List:output_type -> yandex.cloud.compute.v1.ListInstancesResponse
	66, // 66: yandex.cloud.compute.v1.InstanceService.Create:output_type -> yandex.cloud.operation.Operation
	66, // 67: yandex.cloud.compute.v1.InstanceService.Update:output_type -> yandex.cloud.operation.Operation
	66, // 68: yandex.cloud.compute.v1.InstanceService.Delete:output_type -> yandex.cloud.operation.Operation
	66, // 69: yandex.cloud.compute.v1.InstanceService.UpdateMetadata:output_type -> yandex.cloud.operation.Operation
	15, // 70: yandex.cloud.compute.v1.InstanceService.GetSerialPortOutput:output_type -> yandex.cloud.compute.v1.GetInstanceSerialPortOutputResponse
	66, // 71: yandex.cloud.compute.v1.InstanceService.Stop:output_type -> yandex.cloud.operation.Operation
	66, // 72: yandex.cloud.compute.v1.InstanceService.Start:output_type -> yandex.cloud.operation.Operation
	66, // 73: yandex.cloud.compute.v1.InstanceService.Restart:output_type -> yandex.cloud.operation.Operation
	66, // 74: yandex.cloud.compute.v1.InstanceService.AttachDisk:output_type -> yandex.cloud.operation.Operation
	66, // 75: yandex.cloud.compute.v1.InstanceService.DetachDisk:output_type -> yandex.cloud.operation.Operation
	66, // 76: yandex.cloud.compute.v1.InstanceService.AttachFilesystem:output_type -> yandex.cloud.operation.Operation
	66, // 77: yandex.cloud.compute.v1.InstanceService.DetachFilesystem:output_type -> yandex.cloud.operation.Operation
	66, // 78: yandex.cloud.compute.v1.InstanceService.AddOneToOneNat:output_type -> yandex.cloud.operation.Operation
	66, // 79: yandex.cloud.compute.v1.InstanceService.RemoveOneToOneNat:output_type -> yandex.cloud.operation.Operation
	66, // 80: yandex.cloud.compute.v1.InstanceService.UpdateNetworkInterface:output_type -> yandex.cloud.operation.Operation
	37, // 81: yandex.cloud.compute.v1.InstanceService.ListOperations:output_type -> yandex.cloud.compute.v1.ListInstanceOperationsResponse
	66, // 82: yandex.cloud.compute.v1.InstanceService.Move:output_type -> yandex.cloud.operation.Operation
	66, // 83: yandex.cloud.compute.v1.InstanceService.Relocate:output_type -> yandex.cloud.operation.Operation
	72, // 84: yandex.cloud.compute.v1.InstanceService.ListAccessBindings:output_type -> yandex.cloud.access.ListAccessBindingsResponse
	66, // 85: yandex.cloud.compute.v1.InstanceService.SetAccessBindings:output_type -> yandex.cloud.operation.Operation
	66, // 86: yandex.cloud.compute.v1.InstanceService.UpdateAccessBindings:output_type -> yandex.cloud.operation.Operation

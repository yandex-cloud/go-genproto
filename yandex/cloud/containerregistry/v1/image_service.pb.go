...
var file_yandex_cloud_containerregistry_v1_image_service_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x2f, 0x7b, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x5f, 0x69, 0x64, 0x7d, 0x42, 0x80, 0x01,
...
func file_yandex_cloud_containerregistry_v1_image_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yandex_cloud_containerregistry_v1_image_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_containerregistry_v1_image_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_containerregistry_v1_image_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_containerregistry_v1_image_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_containerregistry_v1_image_service_proto_msgTypes[4].Exporter = func(v any, i int) any {

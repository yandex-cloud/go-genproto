...
func file_yandex_cloud_dataproc_manager_v1_job_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_yandex_cloud_dataproc_manager_v1_job_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yandex_cloud_dataproc_manager_v1_job_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yandex_cloud_dataproc_manager_v1_job_service_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yandex_cloud_dataproc_manager_v1_job_service_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {

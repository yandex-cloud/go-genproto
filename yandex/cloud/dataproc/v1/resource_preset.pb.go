...
const file_yandex_cloud_dataproc_v1_resource_preset_proto_rawDesc = "" +
	"\n" +
	".yandex/cloud/dataproc/v1/resource_preset.proto\x12\x18yandex.cloud.dataproc.v1\"i\n" +
	"\x0eResourcePreset\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x19\n" +
	"\bzone_ids\x18\x02 \x03(\tR\azoneIds\x12\x14\n" +
	"\x05cores\x18\x03 \x01(\x03R\x05cores\x12\x16\n" +
	"\x06memory\x18\x04 \x01(\x03R\x06memoryBe\n" +
...
var (
	...
	file_yandex_cloud_dataproc_v1_resource_preset_proto_rawDescData []byte
)
...
func file_yandex_cloud_dataproc_v1_resource_preset_proto_rawDescGZIP() []byte {
	file_yandex_cloud_dataproc_v1_resource_preset_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_dataproc_v1_resource_preset_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_yandex_cloud_dataproc_v1_resource_preset_proto_rawDesc), len(file_yandex_cloud_dataproc_v1_resource_preset_proto_rawDesc)))
	})
...
var file_yandex_cloud_dataproc_v1_resource_preset_proto_goTypes = []any{
...
func file_yandex_cloud_dataproc_v1_resource_preset_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_yandex_cloud_dataproc_v1_resource_preset_proto_rawDesc), len(file_yandex_cloud_dataproc_v1_resource_preset_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,

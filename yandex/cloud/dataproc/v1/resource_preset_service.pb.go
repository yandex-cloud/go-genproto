...
const file_yandex_cloud_dataproc_v1_resource_preset_service_proto_rawDesc = "" +
	...
	"\n" +
	"page_token\x18\x02 \x01(\tB\t\x8a\xc81\x05<=100R\tpageToken\"\xa5\x01\n" +
	"\x1bListResourcePresetsResponse\x12S\n" +
	"\x10resource_presets\x18\x01 \x03(\v2(.yandex.cloud.dataproc.v1.ResourcePresetR\x0fresourcePresets\x121\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tB\t\x8a\xc81\x05<=100R\rnextPageToken2\xd4\x02\n" +
	"\x15ResourcePresetService\x12\x9e\x01\n" +
	"\x03Get\x122.yandex.cloud.dataproc.v1.GetResourcePresetRequest\x1a(.yandex.cloud.dataproc.v1.ResourcePreset\"9\x82\xd3\xe4\x93\x023\x121/dataproc/v1/resourcePresets/{resource_preset_id}\x12\x99\x01\n" +
	"\x04List\x124.yandex.cloud.dataproc.v1.ListResourcePresetsRequest\x1a5.yandex.cloud.dataproc.v1.ListResourcePresetsResponse\"$\x82\xd3\xe4\x93\x02\x1e\x12\x1c/dataproc/v1/resourcePresetsBe\n" +
...
var (
	...
	file_yandex_cloud_dataproc_v1_resource_preset_service_proto_rawDescData []byte
)
...
func file_yandex_cloud_dataproc_v1_resource_preset_service_proto_rawDescGZIP() []byte {
	file_yandex_cloud_dataproc_v1_resource_preset_service_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_dataproc_v1_resource_preset_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_yandex_cloud_dataproc_v1_resource_preset_service_proto_rawDesc), len(file_yandex_cloud_dataproc_v1_resource_preset_service_proto_rawDesc)))
	})
...
var file_yandex_cloud_dataproc_v1_resource_preset_service_proto_goTypes = []any{
...
func file_yandex_cloud_dataproc_v1_resource_preset_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_yandex_cloud_dataproc_v1_resource_preset_service_proto_rawDesc), len(file_yandex_cloud_dataproc_v1_resource_preset_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,

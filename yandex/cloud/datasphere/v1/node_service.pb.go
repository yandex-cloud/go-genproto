...
func file_yandex_cloud_datasphere_v1_node_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_yandex_cloud_datasphere_v1_node_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yandex_cloud_datasphere_v1_node_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {

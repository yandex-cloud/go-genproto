...
func (c *nodeServiceClient) Execute(ctx context.Context, in *NodeExecutionRequest, opts ...grpc.CallOption) (*NodeExecutionResponse, error) {
	...
	err := c.cc.Invoke(ctx, NodeService_Execute_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nodeServiceClient) ExecuteAlias(ctx context.Context, in *AliasExecutionRequest, opts ...grpc.CallOption) (*AliasExecutionResponse, error) {
	...
	err := c.cc.Invoke(ctx, NodeService_ExecuteAlias_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedNodeServiceServer) ExecuteAlias(context.Context, *AliasExecutionRequest) (*AliasExecutionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ExecuteAlias not implemented")
}
...
func _NodeService_Execute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NodeService_Execute_FullMethodName,
	}
...
func _NodeService_ExecuteAlias_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NodeService_ExecuteAlias_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {

...
func (c *projectDataServiceClient) UploadFile(ctx context.Context, opts ...grpc.CallOption) (ProjectDataService_UploadFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ProjectDataService_serviceDesc.Streams[0], "/yandex.cloud.datasphere.v1.ProjectDataService/UploadFile", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *projectDataServiceClient) DownloadFile(ctx context.Context, in *DownloadFileRequest, opts ...grpc.CallOption) (ProjectDataService_DownloadFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ProjectDataService_serviceDesc.Streams[1], "/yandex.cloud.datasphere.v1.ProjectDataService/DownloadFile", opts...)
	if err != nil {
		return nil, err
	}
...
// UnimplementedProjectDataServiceServer can be embedded to have forward compatible implementations.
...
func RegisterProjectDataServiceServer(s *grpc.Server, srv ProjectDataServiceServer) {
	s.RegisterService(&_ProjectDataService_serviceDesc, srv)
}
...
var _ProjectDataService_serviceDesc = grpc.ServiceDesc{

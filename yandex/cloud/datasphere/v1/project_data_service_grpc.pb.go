...
func (c *projectDataServiceClient) UploadFile(ctx context.Context, opts ...grpc.CallOption) (ProjectDataService_UploadFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &ProjectDataService_ServiceDesc.Streams[0], "/yandex.cloud.datasphere.v1.ProjectDataService/UploadFile", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *projectDataServiceClient) DownloadFile(ctx context.Context, in *DownloadFileRequest, opts ...grpc.CallOption) (ProjectDataService_DownloadFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &ProjectDataService_ServiceDesc.Streams[1], "/yandex.cloud.datasphere.v1.ProjectDataService/DownloadFile", opts...)
	if err != nil {
		return nil, err
	}

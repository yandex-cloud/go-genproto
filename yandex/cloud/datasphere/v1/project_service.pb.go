...
func (x *GetNotebookMetadataResponse) GetCreatedAt() *timestamp.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
func (x *GetNotebookMetadataResponse) GetModifiedAt() *timestamp.Timestamp {
	if x != nil {
		return x.ModifiedAt
	}
	return nil
...
var file_yandex_cloud_datasphere_v1_project_service_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x3a, 0x01, 0x2a, 0x12, 0xd2, 0x01, 0x0a, 0x07, 0x45, 0x78,
	...
	0xd3, 0xe4, 0x93, 0x02, 0x31, 0x22, 0x2c, 0x2f, 0x64, 0x61, 0x74, 0x61, 0x73, 0x70, 0x68, 0x65,
	0x72, 0x65, 0x2f, 0x76, 0x31, 0x2f, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x2f, 0x7b,
	0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x5f, 0x69, 0x64, 0x7d, 0x3a, 0x65, 0x78, 0x65, 0x63,
	0x75, 0x74, 0x65, 0x3a, 0x01, 0x2a, 0xb2, 0xd2, 0x2a, 0x34, 0x0a, 0x18, 0x50, 0x72, 0x6f, 0x6a,
	0x65, 0x63, 0x74, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x4d, 0x65, 0x74, 0x61,
	0x64, 0x61, 0x74, 0x61, 0x12, 0x18, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x45, 0x78, 0x65,
	0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0xab,
...
func file_yandex_cloud_datasphere_v1_project_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_yandex_cloud_datasphere_v1_project_service_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yandex_cloud_datasphere_v1_project_service_proto_msgTypes[23].Exporter = func(v interface{}, i int) interface{} {
...
func (c *projectServiceClient) GetNotebookMetadata(ctx context.Context, in *GetNotebookMetadataRequest, opts ...grpc.CallOption) (*GetNotebookMetadataResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/yandex.cloud.datasphere.v1.ProjectService/GetNotebookMetadata", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ProjectService_GetNotebookMetadata_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/yandex.cloud.datasphere.v1.ProjectService/GetNotebookMetadata",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {

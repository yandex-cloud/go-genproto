...
func file_yandex_cloud_datatransfer_v1_endpoint_parsers_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yandex_cloud_datatransfer_v1_endpoint_parsers_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Parser); i {
			case 0:
				return &v.state
			case 1:
		...
		file_yandex_cloud_datatransfer_v1_endpoint_parsers_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_datatransfer_v1_endpoint_parsers_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_datatransfer_v1_endpoint_parsers_proto_msgTypes[3].Exporter = func(v any, i int) any {

...
const file_yandex_cloud_endpoint_api_endpoint_proto_rawDesc = "" +
	"\n" +
	"(yandex/cloud/endpoint/api_endpoint.proto\x12\x15yandex.cloud.endpoint\"7\n" +
	"\vApiEndpoint\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x18\n" +
	"\aaddress\x18\x02 \x01(\tR\aaddressB_\n" +
...
var (
	...
	file_yandex_cloud_endpoint_api_endpoint_proto_rawDescData []byte
)
...
func file_yandex_cloud_endpoint_api_endpoint_proto_rawDescGZIP() []byte {
	file_yandex_cloud_endpoint_api_endpoint_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_endpoint_api_endpoint_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_yandex_cloud_endpoint_api_endpoint_proto_rawDesc), len(file_yandex_cloud_endpoint_api_endpoint_proto_rawDesc)))
	})
...
var file_yandex_cloud_endpoint_api_endpoint_proto_goTypes = []any{
...
func file_yandex_cloud_endpoint_api_endpoint_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_yandex_cloud_endpoint_api_endpoint_proto_rawDesc), len(file_yandex_cloud_endpoint_api_endpoint_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,

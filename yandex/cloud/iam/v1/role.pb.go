...
const file_yandex_cloud_iam_v1_role_proto_rawDesc = "" +
	"\n" +
	"\x1eyandex/cloud/iam/v1/role.proto\x12\x13yandex.cloud.iam.v1\"8\n" +
	"\x04Role\x12\x0e\n" +
...
var (
	...
	file_yandex_cloud_iam_v1_role_proto_rawDescData []byte
)

func file_yandex_cloud_iam_v1_role_proto_rawDescGZIP() []byte {
	file_yandex_cloud_iam_v1_role_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_iam_v1_role_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_yandex_cloud_iam_v1_role_proto_rawDesc), len(file_yandex_cloud_iam_v1_role_proto_rawDesc)))
	})
...
var file_yandex_cloud_iam_v1_role_proto_goTypes = []any{
...
func file_yandex_cloud_iam_v1_role_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_yandex_cloud_iam_v1_role_proto_rawDesc), len(file_yandex_cloud_iam_v1_role_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,

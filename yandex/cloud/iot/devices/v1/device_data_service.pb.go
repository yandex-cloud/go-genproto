...
const file_yandex_cloud_iot_devices_v1_device_data_service_proto_rawDesc = "" +
	"\n" +
	"5yandex/cloud/iot/devices/v1/device_data_service.proto\x12\x1byandex.cloud.iot.devices.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1dyandex/cloud/validation.proto\"\x8d\x01\n" +
	"\x18PublishDeviceDataRequest\x12)\n" +
	...
	"\x11DeviceDataService\x12\xb0\x01\n" +
	"\aPublish\x125.yandex.cloud.iot.devices.v1.PublishDeviceDataRequest\x1a6.yandex.cloud.iot.devices.v1.PublishDeviceDataResponse\"6\x82\xd3\xe4\x93\x020:\x01*\"+/iot-devices/v1/devices/{device_id}/publishBj\n" +
...
var (
	...
	file_yandex_cloud_iot_devices_v1_device_data_service_proto_rawDescData []byte
)
...
func file_yandex_cloud_iot_devices_v1_device_data_service_proto_rawDescGZIP() []byte {
	file_yandex_cloud_iot_devices_v1_device_data_service_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_iot_devices_v1_device_data_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_yandex_cloud_iot_devices_v1_device_data_service_proto_rawDesc), len(file_yandex_cloud_iot_devices_v1_device_data_service_proto_rawDesc)))
	})
...
var file_yandex_cloud_iot_devices_v1_device_data_service_proto_goTypes = []any{
...
func file_yandex_cloud_iot_devices_v1_device_data_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_yandex_cloud_iot_devices_v1_device_data_service_proto_rawDesc), len(file_yandex_cloud_iot_devices_v1_device_data_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,

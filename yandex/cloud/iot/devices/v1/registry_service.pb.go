...
var file_yandex_cloud_iot_devices_v1_registry_service_proto_goTypes = []interface{}{
	...
	(*LogOptions)(nil),            // 36: yandex.cloud.iot.devices.v1.LogOptions
	(*fieldmaskpb.FieldMask)(nil), // 37: google.protobuf.FieldMask
	(*RegistryCertificate)(nil),   // 38: yandex.cloud.iot.devices.v1.RegistryCertificate
	(*RegistryPassword)(nil),      // 39: yandex.cloud.iot.devices.v1.RegistryPassword
	(*DeviceAlias)(nil),           // 40: yandex.cloud.iot.devices.v1.DeviceAlias
	(*operation.Operation)(nil),   // 41: yandex.cloud.operation.Operation
	(*DataStreamExport)(nil),      // 42: yandex.cloud.iot.devices.v1.DataStreamExport
}
var file_yandex_cloud_iot_devices_v1_registry_service_proto_depIdxs = []int32{
	...
	36, // 3: yandex.cloud.iot.devices.v1.CreateRegistryRequest.log_options:type_name -> yandex.cloud.iot.devices.v1.LogOptions
	37, // 4: yandex.cloud.iot.devices.v1.UpdateRegistryRequest.update_mask:type_name -> google.protobuf.FieldMask
	34, // 5: yandex.cloud.iot.devices.v1.UpdateRegistryRequest.labels:type_name -> yandex.cloud.iot.devices.v1.UpdateRegistryRequest.LabelsEntry
	36, // 6: yandex.cloud.iot.devices.v1.UpdateRegistryRequest.log_options:type_name -> yandex.cloud.iot.devices.v1.LogOptions
	38, // 7: yandex.cloud.iot.devices.v1.ListRegistryCertificatesResponse.certificates:type_name -> yandex.cloud.iot.devices.v1.RegistryCertificate
	39, // 8: yandex.cloud.iot.devices.v1.ListRegistryPasswordsResponse.passwords:type_name -> yandex.cloud.iot.devices.v1.RegistryPassword
	40, // 9: yandex.cloud.iot.devices.v1.ListDeviceTopicAliasesResponse.aliases:type_name -> yandex.cloud.iot.devices.v1.DeviceAlias
	41, // 10: yandex.cloud.iot.devices.v1.ListRegistryOperationsResponse.operations:type_name -> yandex.cloud.operation.Operation
	42, // 11: yandex.cloud.iot.devices.v1.ListDataStreamExportsResponse.data_stream_exports:type_name -> yandex.cloud.iot.devices.v1.DataStreamExport
	...
	35, // 29: yandex.cloud.iot.devices.v1.RegistryService.Get:output_type -> yandex.cloud.iot.devices.v1.Registry
	35, // 30: yandex.cloud.iot.devices.v1.RegistryService.GetByName:output_type -> yandex.cloud.iot.devices.v1.Registry
	3,  // 31: yandex.cloud.iot.devices.v1.RegistryService.List:output_type -> yandex.cloud.iot.devices.v1.ListRegistriesResponse
	41, // 32: yandex.cloud.iot.devices.v1.RegistryService.Create:output_type -> yandex.cloud.operation.Operation
	41, // 33: yandex.cloud.iot.devices.v1.RegistryService.Update:output_type -> yandex.cloud.operation.Operation
	41, // 34: yandex.cloud.iot.devices.v1.RegistryService.Delete:output_type -> yandex.cloud.operation.Operation
	11, // 35: yandex.cloud.iot.devices.v1.RegistryService.ListCertificates:output_type -> yandex.cloud.iot.devices.v1.ListRegistryCertificatesResponse
	41, // 36: yandex.cloud.iot.devices.v1.RegistryService.AddCertificate:output_type -> yandex.cloud.operation.Operation
	41, // 37: yandex.cloud.iot.devices.v1.RegistryService.DeleteCertificate:output_type -> yandex.cloud.operation.Operation
	17, // 38: yandex.cloud.iot.devices.v1.RegistryService.ListPasswords:output_type -> yandex.cloud.iot.devices.v1.ListRegistryPasswordsResponse
	41, // 39: yandex.cloud.iot.devices.v1.RegistryService.AddPassword:output_type -> yandex.cloud.operation.Operation
	41, // 40: yandex.cloud.iot.devices.v1.RegistryService.DeletePassword:output_type -> yandex.cloud.operation.Operation
	23, // 41: yandex.cloud.iot.devices.v1.RegistryService.ListDeviceTopicAliases:output_type -> yandex.cloud.iot.devices.v1.ListDeviceTopicAliasesResponse
	31, // 42: yandex.cloud.iot.devices.v1.RegistryService.ListDataStreamExports:output_type -> yandex.cloud.iot.devices.v1.ListDataStreamExportsResponse
	41, // 43: yandex.cloud.iot.devices.v1.RegistryService.AddDataStreamExport:output_type -> yandex.cloud.operation.Operation
	41, // 44: yandex.cloud.iot.devices.v1.RegistryService.DeleteDataStreamExport:output_type -> yandex.cloud.operation.Operation
	25, // 45: yandex.cloud.iot.devices.v1.RegistryService.ListOperations:output_type -> yandex.cloud.iot.devices.v1.ListRegistryOperationsResponse

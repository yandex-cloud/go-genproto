...
func (x *Cluster) GetInternetGateway() isCluster_InternetGateway {
	if x != nil {
...
func (x *Cluster) GetGatewayIpv4Address() string {
	if x != nil {
		if x, ok := x.InternetGateway.(*Cluster_GatewayIpv4Address); ok {
...
func (x *Cluster) GetNetworkImplementation() isCluster_NetworkImplementation {
	if x != nil {
...
func (x *Cluster) GetCilium() *Cilium {
	if x != nil {
		if x, ok := x.NetworkImplementation.(*Cluster_Cilium); ok {
			return x.Cilium
		}
	}
	return nil
...
func (x *Master) GetMasterType() isMaster_MasterType {
	if x != nil {
		return x.MasterType
	}
	return nil
...
func (x *Master) GetZonalMaster() *ZonalMaster {
	if x != nil {
		if x, ok := x.MasterType.(*Master_ZonalMaster); ok {
...
func (x *Master) GetRegionalMaster() *RegionalMaster {
	if x != nil {
		if x, ok := x.MasterType.(*Master_RegionalMaster); ok {
...
func (x *MasterLogging) GetDestination() isMasterLogging_Destination {
	if x != nil {
...
func (x *MasterLogging) GetLogGroupId() string {
	if x != nil {
		if x, ok := x.Destination.(*MasterLogging_LogGroupId); ok {
			return x.LogGroupId
		}
	}
	return ""
...
func (x *MasterLogging) GetFolderId() string {
	if x != nil {
		if x, ok := x.Destination.(*MasterLogging_FolderId); ok {
			return x.FolderId
		}
	}
	return ""
...
const file_yandex_cloud_k8s_v1_cluster_proto_rawDesc = "" +
	...
	"\x06labels\x18\x06 \x03(\v2(.yandex.cloud.k8s.v1.Cluster.LabelsEntryR\x06labels\x12;\n" +
	"\x06status\x18\a \x01(\x0e2#.yandex.cloud.k8s.v1.Cluster.StatusR\x06status\x12;\n" +
	"\x06health\x18\b \x01(\x0e2#.yandex.cloud.k8s.v1.Cluster.HealthR\x06health\x12\x1d\n" +
	"\n" +
	"network_id\x18\t \x01(\tR\tnetworkId\x123\n" +
	"\x06master\x18\n" +
	" \x01(\v2\x1b.yandex.cloud.k8s.v1.MasterR\x06master\x12Y\n" +
	"\x14ip_allocation_policy\x18\v \x01(\v2'.yandex.cloud.k8s.v1.IPAllocationPolicyR\x12ipAllocationPolicy\x12<\n" +
	"\x14gateway_ipv4_address\x18\f \x01(\tB\b\x8a\xc81\x04<=15H\x00R\x12gatewayIpv4Address\x12,\n" +
	"\x12service_account_id\x18\r \x01(\tR\x10serviceAccountId\x125\n" +
	"\x17node_service_account_id\x18\x0e \x01(\tR\x14nodeServiceAccountId\x12L\n" +
	"\x0frelease_channel\x18\x0f \x01(\x0e2#.yandex.cloud.k8s.v1.ReleaseChannelR\x0ereleaseChannel\x12I\n" +
	"\x0enetwork_policy\x18\x10 \x01(\v2\".yandex.cloud.k8s.v1.NetworkPolicyR\rnetworkPolicy\x12C\n" +
	"\fkms_provider\x18\x11 \x01(\v2 .yandex.cloud.k8s.v1.KMSProviderR\vkmsProvider\x12 \n" +
	...
	"\tUNHEALTHY\x10\x02B\x12\n" +
	"\x10internet_gatewayB\x18\n" +
	"\x16network_implementation\"\xe1\x06\n" +
	"\x06Master\x12E\n" +
	"\fzonal_master\x18\x01 \x01(\v2 .yandex.cloud.k8s.v1.ZonalMasterH\x00R\vzonalMaster\x12N\n" +
	"\x0fregional_master\x18\a \x01(\v2#.yandex.cloud.k8s.v1.RegionalMasterH\x00R\x0eregionalMaster\x12;\n" +
	"\tlocations\x18\n" +
	" \x03(\v2\x1d.yandex.cloud.k8s.v1.LocationR\tlocations\x12*\n" +
	"\x11etcd_cluster_size\x18\v \x01(\x03R\x0fetcdClusterSize\x12\x18\n" +
	"\aversion\x18\x02 \x01(\tR\aversion\x12B\n" +
	"\tendpoints\x18\x03 \x01(\v2$.yandex.cloud.k8s.v1.MasterEndpointsR\tendpoints\x12@\n" +
	"\vmaster_auth\x18\x04 \x01(\v2\x1f.yandex.cloud.k8s.v1.MasterAuthR\n" +
	"masterAuth\x12C\n" +
	"\fversion_info\x18\x05 \x01(\v2 .yandex.cloud.k8s.v1.VersionInfoR\vversionInfo\x12[\n" +
	"\x12maintenance_policy\x18\x06 \x01(\v2,.yandex.cloud.k8s.v1.MasterMaintenancePolicyR\x11maintenancePolicy\x12,\n" +
	"\x12security_group_ids\x18\b \x03(\tR\x10securityGroupIds\x12I\n" +
	...
	"\x13external_v4_address\x18\x03 \x01(\tR\x11externalV4Address\"\xbd\x01\n" +
	"\x0eRegionalMaster\x12\x1b\n" +
	"\tregion_id\x18\x01 \x01(\tR\bregionId\x12.\n" +
	"\x13internal_v4_address\x18\x02 \x01(\tR\x11internalV4Address\x12.\n" +
	"\x13external_v4_address\x18\x03 \x01(\tR\x11externalV4Address\x12.\n" +
	"\x13external_v6_address\x18\x04 \x01(\tR\x11externalV6Address\"@\n" +
	"\bLocation\x12\x17\n" +
	"\azone_id\x18\x01 \x01(\tR\x06zoneId\x12\x1b\n" +
	"\tsubnet_id\x18\x02 \x01(\tR\bsubnetId\"\xa7\x01\n" +
	...
	"\n" +
	"\x06CALICO\x10\x01\"$\n" +
	"\vKMSProvider\x12\x15\n" +
	"\x06key_id\x18\x01 \x01(\tR\x05keyId\"\x8d\x01\n" +
	"\x06Cilium\x12J\n" +
	"\frouting_mode\x18\x01 \x01(\x0e2'.yandex.cloud.k8s.v1.Cilium.RoutingModeR\vroutingMode\"7\n" +
...
var (
	...
	file_yandex_cloud_k8s_v1_cluster_proto_rawDescData []byte
)

func file_yandex_cloud_k8s_v1_cluster_proto_rawDescGZIP() []byte {
	file_yandex_cloud_k8s_v1_cluster_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_k8s_v1_cluster_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_yandex_cloud_k8s_v1_cluster_proto_rawDesc), len(file_yandex_cloud_k8s_v1_cluster_proto_rawDesc)))
	})

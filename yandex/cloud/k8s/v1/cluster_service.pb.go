...
var file_yandex_cloud_k8s_v1_cluster_service_proto_rawDesc = []byte{
	...
	0x6b, 0x65, 0x6e, 0x22, 0xba, 0x04, 0x0a, 0x0a, 0x4d, 0x61, 0x73, 0x74, 0x65, 0x72, 0x53, 0x70,
	...
	0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x76,
	...
	0x6e, 0x67, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x79, 0x61, 0x6e, 0x64, 0x65,
	...
	0x73, 0x74, 0x65, 0x72, 0x4c, 0x6f, 0x67, 0x67, 0x69, 0x6e, 0x67, 0x42, 0x13, 0x0a, 0x0b, 0x6d,
	0x61, 0x73, 0x74, 0x65, 0x72, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x12, 0x04, 0xc0, 0xc1, 0x31, 0x01,
...
var file_yandex_cloud_k8s_v1_cluster_service_proto_depIdxs = []int32{
	...
	35, // 23: yandex.cloud.k8s.v1.MasterSpec.maintenance_policy:type_name -> yandex.cloud.k8s.v1.MasterMaintenancePolicy
	36, // 24: yandex.cloud.k8s.v1.MasterSpec.master_logging:type_name -> yandex.cloud.k8s.v1.MasterLogging
	24, // 25: yandex.cloud.k8s.v1.ZonalMasterSpec.internal_v4_address_spec:type_name -> yandex.cloud.k8s.v1.InternalAddressSpec
	25, // 26: yandex.cloud.k8s.v1.ZonalMasterSpec.external_v4_address_spec:type_name -> yandex.cloud.k8s.v1.ExternalAddressSpec
	26, // 27: yandex.cloud.k8s.v1.RegionalMasterSpec.locations:type_name -> yandex.cloud.k8s.v1.MasterLocation
	25, // 28: yandex.cloud.k8s.v1.RegionalMasterSpec.external_v4_address_spec:type_name -> yandex.cloud.k8s.v1.ExternalAddressSpec
	25, // 29: yandex.cloud.k8s.v1.RegionalMasterSpec.external_v6_address_spec:type_name -> yandex.cloud.k8s.v1.ExternalAddressSpec
	24, // 30: yandex.cloud.k8s.v1.MasterLocation.internal_v4_address_spec:type_name -> yandex.cloud.k8s.v1.InternalAddressSpec
	0,  // 31: yandex.cloud.k8s.v1.ClusterService.Get:input_type -> yandex.cloud.k8s.v1.GetClusterRequest
	1,  // 32: yandex.cloud.k8s.v1.ClusterService.List:input_type -> yandex.cloud.k8s.v1.ListClustersRequest
	12, // 33: yandex.cloud.k8s.v1.ClusterService.Create:input_type -> yandex.cloud.k8s.v1.CreateClusterRequest
	9,  // 34: yandex.cloud.k8s.v1.ClusterService.Update:input_type -> yandex.cloud.k8s.v1.UpdateClusterRequest
	3,  // 35: yandex.cloud.k8s.v1.ClusterService.Delete:input_type -> yandex.cloud.k8s.v1.DeleteClusterRequest
	5,  // 36: yandex.cloud.k8s.v1.ClusterService.Stop:input_type -> yandex.cloud.k8s.v1.StopClusterRequest
	7,  // 37: yandex.cloud.k8s.v1.ClusterService.Start:input_type -> yandex.cloud.k8s.v1.StartClusterRequest
	17, // 38: yandex.cloud.k8s.v1.ClusterService.ListNodeGroups:input_type -> yandex.cloud.k8s.v1.ListClusterNodeGroupsRequest
	15, // 39: yandex.cloud.k8s.v1.ClusterService.ListOperations:input_type -> yandex.cloud.k8s.v1.ListClusterOperationsRequest
	19, // 40: yandex.cloud.k8s.v1.ClusterService.ListNodes:input_type -> yandex.cloud.k8s.v1.ListClusterNodesRequest
	30, // 41: yandex.cloud.k8s.v1.ClusterService.Get:output_type -> yandex.cloud.k8s.v1.Cluster
	2,  // 42: yandex.cloud.k8s.v1.ClusterService.List:output_type -> yandex.cloud.k8s.v1.ListClustersResponse
	40, // 43: yandex.cloud.k8s.v1.ClusterService.Create:output_type -> yandex.cloud.operation.Operation
	40, // 44: yandex.cloud.k8s.v1.ClusterService.Update:output_type -> yandex.cloud.operation.Operation
	40, // 45: yandex.cloud.k8s.v1.ClusterService.Delete:output_type -> yandex.cloud.operation.Operation
	40, // 46: yandex.cloud.k8s.v1.ClusterService.Stop:output_type -> yandex.cloud.operation.Operation
	40, // 47: yandex.cloud.k8s.v1.ClusterService.Start:output_type -> yandex.cloud.operation.Operation
	18, // 48: yandex.cloud.k8s.v1.ClusterService.ListNodeGroups:output_type -> yandex.cloud.k8s.v1.ListClusterNodeGroupsResponse
	16, // 49: yandex.cloud.k8s.v1.ClusterService.ListOperations:output_type -> yandex.cloud.k8s.v1.ListClusterOperationsResponse
	20, // 50: yandex.cloud.k8s.v1.ClusterService.ListNodes:output_type -> yandex.cloud.k8s.v1.ListClusterNodesResponse

...
const (
	ResourcePresetService_Get_FullMethodName  = "/yandex.cloud.k8s.v1.ResourcePresetService/Get"
	ResourcePresetService_List_FullMethodName = "/yandex.cloud.k8s.v1.ResourcePresetService/List"
)
...
var ResourcePresetService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "yandex.cloud.k8s.v1.ResourcePresetService",
	...
	Metadata: "yandex/cloud/k8s/v1/resource_preset_service.proto",
}

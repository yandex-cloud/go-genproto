...
var file_yandex_cloud_kms_v1_symmetric_crypto_service_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x74, 0x65, 0x44, 0x61, 0x74, 0x61, 0x4b, 0x65, 0x79, 0x42, 0x56, 0x0a, 0x17, 0x79,
...
func file_yandex_cloud_kms_v1_symmetric_crypto_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yandex_cloud_kms_v1_symmetric_crypto_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_kms_v1_symmetric_crypto_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_kms_v1_symmetric_crypto_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_kms_v1_symmetric_crypto_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_kms_v1_symmetric_crypto_service_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_kms_v1_symmetric_crypto_service_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_kms_v1_symmetric_crypto_service_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_kms_v1_symmetric_crypto_service_proto_msgTypes[7].Exporter = func(v any, i int) any {

...
const file_yandex_cloud_loadbalancer_v1_target_group_service_proto_rawDesc = "" +
	...
	"operations\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken2\xbd\f\n" +
	"\x12TargetGroupService\x12\x9f\x01\n" +
	"\x03Get\x123.yandex.cloud.loadbalancer.v1.GetTargetGroupRequest\x1a).yandex.cloud.loadbalancer.v1.TargetGroup\"8\x82\xd3\xe4\x93\x022\x120/load-balancer/v1/targetGroups/{target_group_id}\x12\x9d\x01\n" +
	"\x04List\x125.yandex.cloud.loadbalancer.v1.ListTargetGroupsRequest\x1a6.yandex.cloud.loadbalancer.v1.ListTargetGroupsResponse\"&\x82\xd3\xe4\x93\x02 \x12\x1e/load-balancer/v1/targetGroups\x12\xba\x01\n" +
	"\x06Create\x126.yandex.cloud.loadbalancer.v1.CreateTargetGroupRequest\x1a!.yandex.cloud.operation.Operation\"U\xb2\xd2*(\n" +
	"\x19CreateTargetGroupMetadata\x12\vTargetGroup\x82\xd3\xe4\x93\x02#:\x01*\"\x1e/load-balancer/v1/targetGroups\x12\xcc\x01\n" +
	"\x06Update\x126.yandex.cloud.loadbalancer.v1.UpdateTargetGroupRequest\x1a!.yandex.cloud.operation.Operation\"g\xb2\xd2*(\n" +
	"\x19UpdateTargetGroupMetadata\x12\vTargetGroup\x82\xd3\xe4\x93\x025:\x01*20/load-balancer/v1/targetGroups/{target_group_id}\x12\xd3\x01\n" +
	"\x06Delete\x126.yandex.cloud.loadbalancer.v1.DeleteTargetGroupRequest\x1a!.yandex.cloud.operation.Operation\"n\xb2\xd2*2\n" +
...
var (
	...
	file_yandex_cloud_loadbalancer_v1_target_group_service_proto_rawDescData []byte
)
...
func file_yandex_cloud_loadbalancer_v1_target_group_service_proto_rawDescGZIP() []byte {
	file_yandex_cloud_loadbalancer_v1_target_group_service_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_loadbalancer_v1_target_group_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_yandex_cloud_loadbalancer_v1_target_group_service_proto_rawDesc), len(file_yandex_cloud_loadbalancer_v1_target_group_service_proto_rawDesc)))
	})
...
func file_yandex_cloud_loadbalancer_v1_target_group_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_yandex_cloud_loadbalancer_v1_target_group_service_proto_rawDesc), len(file_yandex_cloud_loadbalancer_v1_target_group_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   17,
			NumExtensions: 0,
			NumServices:   1,

...
func (c *agentRegistrationServiceClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*RegisterResponse, error) {
	...
	err := c.cc.Invoke(ctx, AgentRegistrationService_Register_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentRegistrationServiceClient) ExternalAgentRegister(ctx context.Context, in *ExternalAgentRegisterRequest, opts ...grpc.CallOption) (*operation.Operation, error) {
	...
	err := c.cc.Invoke(ctx, AgentRegistrationService_ExternalAgentRegister_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedAgentRegistrationServiceServer should be embedded to have
...
func (UnimplementedAgentRegistrationServiceServer) ExternalAgentRegister(context.Context, *ExternalAgentRegisterRequest) (*operation.Operation, error) {
	return nil, status.Error(codes.Unimplemented, "method ExternalAgentRegister not implemented")
}
func (UnimplementedAgentRegistrationServiceServer) testEmbeddedByValue() {}
...
func RegisterAgentRegistrationServiceServer(s grpc.ServiceRegistrar, srv AgentRegistrationServiceServer) {
	// If the following call panics, it indicates UnimplementedAgentRegistrationServiceServer was

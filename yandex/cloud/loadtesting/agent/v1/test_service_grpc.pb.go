...
func (c *testServiceClient) Get(ctx context.Context, in *GetTestRequest, opts ...grpc.CallOption) (*Test, error) {
...
func (c *testServiceClient) Update(ctx context.Context, in *UpdateTestRequest, opts ...grpc.CallOption) (*operation.Operation, error) {
	...
	err := c.cc.Invoke(ctx, TestService_Update_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TestService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TestService_Update_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var TestService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "yandex.cloud.loadtesting.agent.v1.TestService",
	...
	Metadata: "yandex/cloud/loadtesting/agent/v1/test_service.proto",
}

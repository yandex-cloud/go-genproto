...
var file_yandex_cloud_loadtesting_api_v1_agent_log_settings_proto_goTypes = []interface{}{
...
func file_yandex_cloud_loadtesting_api_v1_agent_log_settings_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yandex_cloud_loadtesting_api_v1_agent_log_settings_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {

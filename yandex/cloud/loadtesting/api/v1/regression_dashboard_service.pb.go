...
var file_yandex_cloud_loadtesting_api_v1_regression_dashboard_service_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x42, 0x0c, 0xe8, 0xc7, 0x31, 0x01, 0x8a, 0xc8, 0x31, 0x04, 0x3c, 0x3d, 0x35, 0x34,
	...
	0x42, 0x0c, 0xe8, 0xc7, 0x31, 0x01, 0x8a, 0xc8, 0x31, 0x04, 0x3c, 0x3d, 0x35, 0x34, 0x52, 0x08,
...
func file_yandex_cloud_loadtesting_api_v1_regression_dashboard_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yandex_cloud_loadtesting_api_v1_regression_dashboard_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_loadtesting_api_v1_regression_dashboard_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_loadtesting_api_v1_regression_dashboard_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_loadtesting_api_v1_regression_dashboard_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_loadtesting_api_v1_regression_dashboard_service_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_loadtesting_api_v1_regression_dashboard_service_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_loadtesting_api_v1_regression_dashboard_service_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_loadtesting_api_v1_regression_dashboard_service_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_loadtesting_api_v1_regression_dashboard_service_proto_msgTypes[8].Exporter = func(v any, i int) any {

...
var file_yandex_cloud_loadtesting_api_v1_report_service_proto_rawDesc = []byte{
	...
	0x8a, 0xc8, 0x31, 0x04, 0x3c, 0x3d, 0x35, 0x34, 0x52, 0x08, 0x66, 0x6f, 0x6c, 0x64, 0x65, 0x72,
...
func file_yandex_cloud_loadtesting_api_v1_report_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yandex_cloud_loadtesting_api_v1_report_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_loadtesting_api_v1_report_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_loadtesting_api_v1_report_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_loadtesting_api_v1_report_service_proto_msgTypes[3].Exporter = func(v any, i int) any {

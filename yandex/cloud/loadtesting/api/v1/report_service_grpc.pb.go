...
func (c *reportServiceClient) GetTable(ctx context.Context, in *GetTableReportRequest, opts ...grpc.CallOption) (*GetTableReportResponse, error) {
	...
	err := c.cc.Invoke(ctx, ReportService_GetTable_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reportServiceClient) CalculateKpiValues(ctx context.Context, in *CalculateReportKpiValuesRequest, opts ...grpc.CallOption) (*CalculateReportKpiValuesResponse, error) {
	...
	err := c.cc.Invoke(ctx, ReportService_CalculateKpiValues_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedReportServiceServer) CalculateKpiValues(context.Context, *CalculateReportKpiValuesRequest) (*CalculateReportKpiValuesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CalculateKpiValues not implemented")
}

...
type Version struct {
	...
	DestroyAt *timestamp.Timestamp `protobuf:"bytes,4,opt,name=destroy_at,json=destroyAt,proto3" json:"destroy_at,omitempty"`
...
func (x *Version) GetDestroyAt() *timestamp.Timestamp {
	if x != nil {
		return x.DestroyAt
	}
	return nil

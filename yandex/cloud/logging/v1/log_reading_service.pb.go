...
var file_yandex_cloud_logging_v1_log_reading_service_proto_rawDesc = []byte{
	...
	0x61, 0x70, 0x69, 0x2e, 0x6c, 0x6f, 0x67, 0x67, 0x69, 0x6e, 0x67, 0x2e, 0x76, 0x31, 0x5a, 0x43,
...
func file_yandex_cloud_logging_v1_log_reading_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yandex_cloud_logging_v1_log_reading_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_logging_v1_log_reading_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_logging_v1_log_reading_service_proto_msgTypes[2].Exporter = func(v any, i int) any {

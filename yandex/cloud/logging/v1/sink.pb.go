...
func (x *Sink_Yds) Reset() {
	*x = Sink_Yds{}
	mi := &file_yandex_cloud_logging_v1_sink_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Sink_Yds) Descriptor() ([]byte, []int) {
	return file_yandex_cloud_logging_v1_sink_proto_rawDescGZIP(), []int{0, 0}
}
...
const file_yandex_cloud_logging_v1_sink_proto_rawDesc = "" +
	...
	"\x02s3\x18\n" +
	" \x01(\v2 .yandex.cloud.logging.v1.Sink.S3H\x00R\x02s3\x12\x0e\n" +
	...
	"\x12service_account_id\x18\b \x01(\tR\x10serviceAccountId\x1a1\n" +
	"\x03Yds\x12*\n" +
	...
	"\x8a\xc81\x06<=1024R\x06prefix\x1a9\n" +
...
var file_yandex_cloud_logging_v1_sink_proto_goTypes = []any{
	...
	(*Sink_Yds)(nil),              // 1: yandex.cloud.logging.v1.Sink.Yds
	(*Sink_S3)(nil),               // 2: yandex.cloud.logging.v1.Sink.S3
	nil,                           // 3: yandex.cloud.logging.v1.Sink.LabelsEntry
	(*timestamppb.Timestamp)(nil), // 4: google.protobuf.Timestamp
}
var file_yandex_cloud_logging_v1_sink_proto_depIdxs = []int32{
	1, // 0: yandex.cloud.logging.v1.Sink.yds:type_name -> yandex.cloud.logging.v1.Sink.Yds
	2, // 1: yandex.cloud.logging.v1.Sink.s3:type_name -> yandex.cloud.logging.v1.Sink.S3
	4, // 2: yandex.cloud.logging.v1.Sink.created_at:type_name -> google.protobuf.Timestamp
	3, // 3: yandex.cloud.logging.v1.Sink.labels:type_name -> yandex.cloud.logging.v1.Sink.LabelsEntry

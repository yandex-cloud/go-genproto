...
const file_yandex_cloud_marketplace_v1_metering_image_product_usage_service_proto_rawDesc = "" +
	"\n" +
	"Fyandex/cloud/marketplace/v1/metering/image_product_usage_service.proto\x12$yandex.cloud.marketplace.v1.metering\x1a\x1cgoogle/api/annotations.proto\x1a\x1dyandex/cloud/validation.proto\x1a7yandex/cloud/marketplace/v1/metering/usage_record.proto\"\xd3\x01\n" +
	...
	"\rusage_records\x18\x03 \x03(\v21.yandex.cloud.marketplace.v1.metering.UsageRecordB\b\x82\xc81\x041-25R\fusageRecords\"\xce\x01\n" +
	"\x1eWriteImageProductUsageResponse\x12U\n" +
	"\baccepted\x18\x01 \x03(\v29.yandex.cloud.marketplace.v1.metering.AcceptedUsageRecordR\baccepted\x12U\n" +
	"\brejected\x18\x02 \x03(\v29.yandex.cloud.marketplace.v1.metering.RejectedUsageRecordR\brejected2\xec\x01\n" +
	"\x18ImageProductUsageService\x12\xcf\x01\n" +
	"\x05Write\x12C.yandex.cloud.marketplace.v1.metering.WriteImageProductUsageRequest\x1aD.yandex.cloud.marketplace.v1.metering.WriteImageProductUsageResponse\";\x82\xd3\xe4\x93\x025:\x01*\"0/marketplace/v1/metering/imageProductUsage/writeB}\n" +
...
var (
	...
	file_yandex_cloud_marketplace_v1_metering_image_product_usage_service_proto_rawDescData []byte
)
...
func file_yandex_cloud_marketplace_v1_metering_image_product_usage_service_proto_rawDescGZIP() []byte {
	file_yandex_cloud_marketplace_v1_metering_image_product_usage_service_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_marketplace_v1_metering_image_product_usage_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_yandex_cloud_marketplace_v1_metering_image_product_usage_service_proto_rawDesc), len(file_yandex_cloud_marketplace_v1_metering_image_product_usage_service_proto_rawDesc)))
	})
...
var file_yandex_cloud_marketplace_v1_metering_image_product_usage_service_proto_goTypes = []any{
...
func file_yandex_cloud_marketplace_v1_metering_image_product_usage_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_yandex_cloud_marketplace_v1_metering_image_product_usage_service_proto_rawDesc), len(file_yandex_cloud_marketplace_v1_metering_image_product_usage_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,

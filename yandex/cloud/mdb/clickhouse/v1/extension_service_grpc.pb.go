...
const (
	ExtensionService_Get_FullMethodName  = "/yandex.cloud.mdb.clickhouse.v1.ExtensionService/Get"
	ExtensionService_List_FullMethodName = "/yandex.cloud.mdb.clickhouse.v1.ExtensionService/List"
)
...
var ExtensionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "yandex.cloud.mdb.clickhouse.v1.ExtensionService",
	...
	Metadata: "yandex/cloud/mdb/clickhouse/v1/extension_service.proto",
}

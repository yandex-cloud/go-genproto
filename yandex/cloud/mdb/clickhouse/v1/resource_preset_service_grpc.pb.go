...
const (
	ResourcePresetService_Get_FullMethodName  = "/yandex.cloud.mdb.clickhouse.v1.ResourcePresetService/Get"
	ResourcePresetService_List_FullMethodName = "/yandex.cloud.mdb.clickhouse.v1.ResourcePresetService/List"
)

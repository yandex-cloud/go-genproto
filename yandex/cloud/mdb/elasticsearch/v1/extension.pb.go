...
func file_yandex_cloud_mdb_elasticsearch_v1_extension_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yandex_cloud_mdb_elasticsearch_v1_extension_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_mdb_elasticsearch_v1_extension_proto_msgTypes[1].Exporter = func(v any, i int) any {

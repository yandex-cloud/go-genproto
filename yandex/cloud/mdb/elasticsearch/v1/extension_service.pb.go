...
var file_yandex_cloud_mdb_elasticsearch_v1_extension_service_proto_rawDesc = []byte{
	...
	0x64, 0x7d, 0x42, 0x7c, 0x0a, 0x25, 0x79, 0x61, 0x6e, 0x64, 0x65, 0x78, 0x2e, 0x63, 0x6c, 0x6f,
...
func file_yandex_cloud_mdb_elasticsearch_v1_extension_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yandex_cloud_mdb_elasticsearch_v1_extension_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_mdb_elasticsearch_v1_extension_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_mdb_elasticsearch_v1_extension_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_mdb_elasticsearch_v1_extension_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_mdb_elasticsearch_v1_extension_service_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_mdb_elasticsearch_v1_extension_service_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_mdb_elasticsearch_v1_extension_service_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_mdb_elasticsearch_v1_extension_service_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_mdb_elasticsearch_v1_extension_service_proto_msgTypes[8].Exporter = func(v any, i int) any {

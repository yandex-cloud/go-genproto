...
const file_yandex_cloud_mdb_greenplum_v1_backup_service_proto_rawDesc = "" +
	...
	"\x04List\x121.yandex.cloud.mdb.greenplum.v1.ListBackupsRequest\x1a2.yandex.cloud.mdb.greenplum.v1.ListBackupsResponse\"%\x82\xd3\xe4\x93\x02\x1f\x12\x1d/managed-greenplum/v1/backups\x12\xc3\x01\n" +
	"\x06Delete\x122.yandex.cloud.mdb.greenplum.v1.DeleteBackupRequest\x1a!.yandex.cloud.operation.Operation\"b\xb2\xd2*-\n" +
	"\x14DeleteBackupMetadata\x12\x15google.protobuf.Empty\x82\xd3\xe4\x93\x02+*)/managed-greenplum/v1/backups/{backup_id}Bp\n" +
...
var (
	...
	file_yandex_cloud_mdb_greenplum_v1_backup_service_proto_rawDescData []byte
)
...
func file_yandex_cloud_mdb_greenplum_v1_backup_service_proto_rawDescGZIP() []byte {
	file_yandex_cloud_mdb_greenplum_v1_backup_service_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_mdb_greenplum_v1_backup_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_greenplum_v1_backup_service_proto_rawDesc), len(file_yandex_cloud_mdb_greenplum_v1_backup_service_proto_rawDesc)))
	})
...
var file_yandex_cloud_mdb_greenplum_v1_backup_service_proto_goTypes = []any{
...
func file_yandex_cloud_mdb_greenplum_v1_backup_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_greenplum_v1_backup_service_proto_rawDesc), len(file_yandex_cloud_mdb_greenplum_v1_backup_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,

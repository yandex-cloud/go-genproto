...
func (m *MongodConfig5_0_Storage_WiredTiger_EngineConfig) SetCacheSizeGb(v *wrappers.DoubleValue) {
	m.CacheSizeGb = v
}
...
func (m *MongodConfig5_0_Storage_Journal) SetCommitInterval(v *wrappers.Int64Value) {
	m.CommitInterval = v
}
...
func (m *MongodConfig5_0_OperationProfiling) SetSlowOpThreshold(v *wrappers.Int64Value) {
	m.SlowOpThreshold = v
}

func (m *MongodConfig5_0_Network) SetMaxIncomingConnections(v *wrappers.Int64Value) {
...
func (m *MongoCfgConfig5_0_Storage_WiredTiger_EngineConfig) SetCacheSizeGb(v *wrappers.DoubleValue) {
	m.CacheSizeGb = v
}
...
func (m *MongoCfgConfig5_0_OperationProfiling) SetSlowOpThreshold(v *wrappers.Int64Value) {
	m.SlowOpThreshold = v
}

func (m *MongoCfgConfig5_0_Network) SetMaxIncomingConnections(v *wrappers.Int64Value) {
	m.MaxIncomingConnections = v
}
...
func (m *MongosConfig5_0_Network) SetMaxIncomingConnections(v *wrappers.Int64Value) {
	m.MaxIncomingConnections = v
}

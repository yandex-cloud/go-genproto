...
var file_yandex_cloud_mdb_mongodb_v1_database_service_proto_rawDesc = []byte{
	...
	0x62, 0x61, 0x73, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x7d, 0x42, 0x6a, 0x0a, 0x1f, 0x79, 0x61,
...
func file_yandex_cloud_mdb_mongodb_v1_database_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yandex_cloud_mdb_mongodb_v1_database_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_mdb_mongodb_v1_database_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_mdb_mongodb_v1_database_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_mdb_mongodb_v1_database_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_mdb_mongodb_v1_database_service_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_mdb_mongodb_v1_database_service_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_mdb_mongodb_v1_database_service_proto_msgTypes[6].Exporter = func(v any, i int) any {

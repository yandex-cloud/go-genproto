...
const file_yandex_cloud_mdb_mongodb_v1_maintenance_proto_rawDesc = "" +
	"\n" +
	"-yandex/cloud/mdb/mongodb/v1/maintenance.proto\x12\x1byandex.cloud.mdb.mongodb.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1dyandex/cloud/validation.proto\"\xea\x01\n" +
	"\x11MaintenanceWindow\x12Q\n" +
	"\aanytime\x18\x01 \x01(\v25.yandex.cloud.mdb.mongodb.v1.AnytimeMaintenanceWindowH\x00R\aanytime\x12r\n" +
	"\x19weekly_maintenance_window\x18\x02 \x01(\v24.yandex.cloud.mdb.mongodb.v1.WeeklyMaintenanceWindowH\x00R\x17weeklyMaintenanceWindowB\x0e\n" +
	"\x06policy\x12\x04\xc0\xc11\x01\"\x1a\n" +
	"\x18AnytimeMaintenanceWindow\"\xeb\x01\n" +
	"\x17WeeklyMaintenanceWindow\x12N\n" +
	"\x03day\x18\x01 \x01(\x0e2<.yandex.cloud.mdb.mongodb.v1.WeeklyMaintenanceWindow.WeekDayR\x03day\x12\x1c\n" +
	...
	"\rdelayed_until\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\fdelayedUntilBj\n" +
...
var (
	...
	file_yandex_cloud_mdb_mongodb_v1_maintenance_proto_rawDescData []byte
)
...
func file_yandex_cloud_mdb_mongodb_v1_maintenance_proto_rawDescGZIP() []byte {
	file_yandex_cloud_mdb_mongodb_v1_maintenance_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_mdb_mongodb_v1_maintenance_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_mongodb_v1_maintenance_proto_rawDesc), len(file_yandex_cloud_mdb_mongodb_v1_maintenance_proto_rawDesc)))
	})
...
var file_yandex_cloud_mdb_mongodb_v1_maintenance_proto_goTypes = []any{
...
func file_yandex_cloud_mdb_mongodb_v1_maintenance_proto_init() {
	...
	file_yandex_cloud_mdb_mongodb_v1_maintenance_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_mongodb_v1_maintenance_proto_rawDesc), len(file_yandex_cloud_mdb_mongodb_v1_maintenance_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,

...
const file_yandex_cloud_mdb_mongodb_v1_user_service_proto_rawDesc = "" +
	"\n" +
	...
	"\tuser_name\x18\x02 \x01(\tB.\xe8\xc71\x01\xf2\xc71\x1e^[a-zA-Z0-9_][a-zA-Z0-9_@.-]*$\x8a\xc81\x04<=63R\buserName\"\x92\x01\n" +
	...
	"\x05users\x18\x01 \x03(\v2!.yandex.cloud.mdb.mongodb.v1.UserR\x05users\x12&\n" +
	...
	"\tuser_spec\x18\x02 \x01(\v2%.yandex.cloud.mdb.mongodb.v1.UserSpecB\x04\xe8\xc71\x01R\buserSpec\"P\n" +
	...
	"\n" +
	"cluster_id\x18\x01 \x01(\tR\tclusterId\x12\x1b\n" +
	"\tuser_name\x18\x02 \x01(\tR\buserName\"\xe5\x01\n" +
	"\x1aGrantUserPermissionRequest\x12+\n" +
	"\n" +
	"cluster_id\x18\x01 \x01(\tB\f\xe8\xc71\x01\x8a\xc81\x04<=50R\tclusterId\x12K\n" +
	"\tuser_name\x18\x02 \x01(\tB.\xe8\xc71\x01\xf2\xc71\x1e^[a-zA-Z0-9_][a-zA-Z0-9_@.-]*$\x8a\xc81\x04<=63R\buserName\x12M\n" +
	"\n" +
	"permission\x18\x03 \x01(\v2'.yandex.cloud.mdb.mongodb.v1.PermissionB\x04\xe8\xc71\x01R\n" +
	"permission\"Y\n" +
	"\x1bGrantUserPermissionMetadata\x12\x1d\n" +
	"\n" +
	"cluster_id\x18\x01 \x01(\tR\tclusterId\x12\x1b\n" +
	"\tuser_name\x18\x02 \x01(\tR\buserName\"\xdc\x01\n" +
	"\x1bRevokeUserPermissionRequest\x12+\n" +
	"\n" +
	"cluster_id\x18\x01 \x01(\tB\f\xe8\xc71\x01\x8a\xc81\x04<=50R\tclusterId\x12K\n" +
	"\tuser_name\x18\x02 \x01(\tB.\xe8\xc71\x01\xf2\xc71\x1e^[a-zA-Z0-9_][a-zA-Z0-9_@.-]*$\x8a\xc81\x04<=63R\buserName\x12C\n" +
	...
	"\n" +
	"cluster_id\x18\x01 \x01(\tR\tclusterId\x12\x1b\n" +
	"\tuser_name\x18\x02 \x01(\tR\buserName2\xfb\n" +
	"\n" +
	...
	"\x04List\x12-.yandex.cloud.mdb.mongodb.v1.ListUsersRequest\x1a..yandex.cloud.mdb.mongodb.v1.ListUsersResponse\"7\x82\xd3\xe4\x93\x021\x12//managed-mongodb/v1/clusters/{cluster_id}/users\x12\xb5\x01\n" +
	"\x06Create\x12..yandex.cloud.mdb.mongodb.v1.CreateUserRequest\x1a!.yandex.cloud.operation.Operation\"X\xb2\xd2*\x1a\n" +
	"\x12CreateUserMetadata\x12\x04User\x82\xd3\xe4\x93\x024:\x01*\"//managed-mongodb/v1/clusters/{cluster_id}/users\x12\xc1\x01\n" +
	"\x06Update\x12..yandex.cloud.mdb.mongodb.v1.UpdateUserRequest\x1a!.yandex.cloud.operation.Operation\"d\xb2\xd2*\x1a\n" +
	"\x12UpdateUserMetadata\x12\x04User\x82\xd3\xe4\x93\x02@:\x01*2;/managed-mongodb/v1/clusters/{cluster_id}/users/{user_name}\x12\xcf\x01\n" +
	"\x06Delete\x12..yandex.cloud.mdb.mongodb.v1.DeleteUserRequest\x1a!.yandex.cloud.operation.Operation\"r\xb2\xd2*+\n" +
	"\x12DeleteUserMetadata\x12\x15google.protobuf.Empty\x82\xd3\xe4\x93\x02=*;/managed-mongodb/v1/clusters/{cluster_id}/users/{user_name}\x12\xec\x01\n" +
	"\x0fGrantPermission\x127.yandex.cloud.mdb.mongodb.v1.GrantUserPermissionRequest\x1a!.yandex.cloud.operation.Operation\"}\xb2\xd2*#\n" +
	"\x1bGrantUserPermissionMetadata\x12\x04User\x82\xd3\xe4\x93\x02P:\x01*\"K/managed-mongodb/v1/clusters/{cluster_id}/users/{user_name}:grantPermission\x12\xf0\x01\n" +
	"\x10RevokePermission\x128.yandex.cloud.mdb.mongodb.v1.RevokeUserPermissionRequest\x1a!.yandex.cloud.operation.Operation\"\x7f\xb2\xd2*$\n" +
	"\x1cRevokeUserPermissionMetadata\x12\x04User\x82\xd3\xe4\x93\x02Q:\x01*\"L/managed-mongodb/v1/clusters/{cluster_id}/users/{user_name}:revokePermissionBj\n" +
...
var (
	...
	file_yandex_cloud_mdb_mongodb_v1_user_service_proto_rawDescData []byte
)
...
func file_yandex_cloud_mdb_mongodb_v1_user_service_proto_rawDescGZIP() []byte {
	file_yandex_cloud_mdb_mongodb_v1_user_service_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_mdb_mongodb_v1_user_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_mongodb_v1_user_service_proto_rawDesc), len(file_yandex_cloud_mdb_mongodb_v1_user_service_proto_rawDesc)))
	})
...
var file_yandex_cloud_mdb_mongodb_v1_user_service_proto_goTypes = []any{
...
func file_yandex_cloud_mdb_mongodb_v1_user_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_mongodb_v1_user_service_proto_rawDesc), len(file_yandex_cloud_mdb_mongodb_v1_user_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   13,
			NumExtensions: 0,
			NumServices:   1,

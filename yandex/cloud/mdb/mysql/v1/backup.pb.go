...
const file_yandex_cloud_mdb_mysql_v1_backup_proto_rawDesc = "" +
	...
	"\x04type\x18\a \x01(\x0e24.yandex.cloud.mdb.mysql.v1.Backup.BackupCreationTypeR\x04type\x12F\n" +
	"\x06status\x18\b \x01(\x0e2..yandex.cloud.mdb.mysql.v1.Backup.BackupStatusR\x06status\x12!\n" +
	"\fjournal_size\x18\t \x01(\x03R\vjournalSize\"U\n" +
...
var (
	...
	file_yandex_cloud_mdb_mysql_v1_backup_proto_rawDescData []byte
)
...
func file_yandex_cloud_mdb_mysql_v1_backup_proto_rawDescGZIP() []byte {
	file_yandex_cloud_mdb_mysql_v1_backup_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_mdb_mysql_v1_backup_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_mysql_v1_backup_proto_rawDesc), len(file_yandex_cloud_mdb_mysql_v1_backup_proto_rawDesc)))
	})
...
func file_yandex_cloud_mdb_mysql_v1_backup_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_mysql_v1_backup_proto_rawDesc), len(file_yandex_cloud_mdb_mysql_v1_backup_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,

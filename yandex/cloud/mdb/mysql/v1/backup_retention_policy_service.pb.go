...
func (x *ListBackupRetentionPoliciesRequest) Reset() {
	*x = ListBackupRetentionPoliciesRequest{}
	mi := &file_yandex_cloud_mdb_mysql_v1_backup_retention_policy_service_proto_msgTypes[0]
...
func (*ListBackupRetentionPoliciesRequest) Descriptor() ([]byte, []int) {
	return file_yandex_cloud_mdb_mysql_v1_backup_retention_policy_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *ListBackupRetentionPoliciesByFolderRequest) Reset() {
	*x = ListBackupRetentionPoliciesByFolderRequest{}
	mi := &file_yandex_cloud_mdb_mysql_v1_backup_retention_policy_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListBackupRetentionPoliciesByFolderRequest) Descriptor() ([]byte, []int) {
	return file_yandex_cloud_mdb_mysql_v1_backup_retention_policy_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *ListBackupRetentionPoliciesResponse) Reset() {
	*x = ListBackupRetentionPoliciesResponse{}
	mi := &file_yandex_cloud_mdb_mysql_v1_backup_retention_policy_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListBackupRetentionPoliciesResponse) Descriptor() ([]byte, []int) {
	return file_yandex_cloud_mdb_mysql_v1_backup_retention_policy_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *CreateBackupRetentionPolicyRequest) Reset() {
	*x = CreateBackupRetentionPolicyRequest{}
	mi := &file_yandex_cloud_mdb_mysql_v1_backup_retention_policy_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateBackupRetentionPolicyRequest) Descriptor() ([]byte, []int) {
	return file_yandex_cloud_mdb_mysql_v1_backup_retention_policy_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *CreateBackupRetentionPolicyResponse) Reset() {
	*x = CreateBackupRetentionPolicyResponse{}
	mi := &file_yandex_cloud_mdb_mysql_v1_backup_retention_policy_service_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateBackupRetentionPolicyResponse) Descriptor() ([]byte, []int) {
	return file_yandex_cloud_mdb_mysql_v1_backup_retention_policy_service_proto_rawDescGZIP(), []int{4}
}
...
const file_yandex_cloud_mdb_mysql_v1_backup_retention_policy_service_proto_rawDesc = "" +
	"\n" +
	"?yandex/cloud/mdb/mysql/v1/backup_retention_policy_service.proto\x12\x19yandex.cloud.mdb.mysql.v1\x1a\x1cgoogle/api/annotations.proto\x1a1yandex/cloud/mdb/v1/backup_retention_policy.proto\x1a\x1dyandex/cloud/validation.proto\"\xa4\x01\n" +
...
var (
	file_yandex_cloud_mdb_mysql_v1_backup_retention_policy_service_proto_rawDescOnce sync.Once
	file_yandex_cloud_mdb_mysql_v1_backup_retention_policy_service_proto_rawDescData []byte
)

func file_yandex_cloud_mdb_mysql_v1_backup_retention_policy_service_proto_rawDescGZIP() []byte {
	file_yandex_cloud_mdb_mysql_v1_backup_retention_policy_service_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_mdb_mysql_v1_backup_retention_policy_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_mysql_v1_backup_retention_policy_service_proto_rawDesc), len(file_yandex_cloud_mdb_mysql_v1_backup_retention_policy_service_proto_rawDesc)))
	})
	return file_yandex_cloud_mdb_mysql_v1_backup_retention_policy_service_proto_rawDescData
}

var file_yandex_cloud_mdb_mysql_v1_backup_retention_policy_service_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_yandex_cloud_mdb_mysql_v1_backup_retention_policy_service_proto_goTypes = []any{
	(*ListBackupRetentionPoliciesRequest)(nil),         // 0: yandex.cloud.mdb.mysql.v1.ListBackupRetentionPoliciesRequest
	(*ListBackupRetentionPoliciesByFolderRequest)(nil), // 1: yandex.cloud.mdb.mysql.v1.ListBackupRetentionPoliciesByFolderRequest
	(*ListBackupRetentionPoliciesResponse)(nil),        // 2: yandex.cloud.mdb.mysql.v1.ListBackupRetentionPoliciesResponse
	(*CreateBackupRetentionPolicyRequest)(nil),         // 3: yandex.cloud.mdb.mysql.v1.CreateBackupRetentionPolicyRequest
	(*CreateBackupRetentionPolicyResponse)(nil),        // 4: yandex.cloud.mdb.mysql.v1.CreateBackupRetentionPolicyResponse
	(*DeleteBackupRetentionPolicyRequest)(nil),         // 5: yandex.cloud.mdb.mysql.v1.DeleteBackupRetentionPolicyRequest
	(*DeleteBackupRetentionPolicyResponse)(nil),        // 6: yandex.cloud.mdb.mysql.v1.DeleteBackupRetentionPolicyResponse
...
var file_yandex_cloud_mdb_mysql_v1_backup_retention_policy_service_proto_depIdxs = []int32{
	7, // 0: yandex.cloud.mdb.mysql.v1.ListBackupRetentionPoliciesResponse.policies:type_name -> yandex.cloud.mdb.v1.BackupRetentionPolicy
	8, // 1: yandex.cloud.mdb.mysql.v1.CreateBackupRetentionPolicyRequest.cron:type_name -> yandex.cloud.mdb.v1.CronTab
	7, // 2: yandex.cloud.mdb.mysql.v1.CreateBackupRetentionPolicyResponse.policy:type_name -> yandex.cloud.mdb.v1.BackupRetentionPolicy
	0, // 3: yandex.cloud.mdb.mysql.v1.BackupRetentionPolicyService.List:input_type -> yandex.cloud.mdb.mysql.v1.ListBackupRetentionPoliciesRequest
	1, // 4: yandex.cloud.mdb.mysql.v1.BackupRetentionPolicyService.ListByFolder:input_type -> yandex.cloud.mdb.mysql.v1.ListBackupRetentionPoliciesByFolderRequest
	3, // 5: yandex.cloud.mdb.mysql.v1.BackupRetentionPolicyService.Create:input_type -> yandex.cloud.mdb.mysql.v1.CreateBackupRetentionPolicyRequest
	...
	2, // 7: yandex.cloud.mdb.mysql.v1.BackupRetentionPolicyService.List:output_type -> yandex.cloud.mdb.mysql.v1.ListBackupRetentionPoliciesResponse
	2, // 8: yandex.cloud.mdb.mysql.v1.BackupRetentionPolicyService.ListByFolder:output_type -> yandex.cloud.mdb.mysql.v1.ListBackupRetentionPoliciesResponse
	4, // 9: yandex.cloud.mdb.mysql.v1.BackupRetentionPolicyService.Create:output_type -> yandex.cloud.mdb.mysql.v1.CreateBackupRetentionPolicyResponse
	6, // 10: yandex.cloud.mdb.mysql.v1.BackupRetentionPolicyService.Delete:output_type -> yandex.cloud.mdb.mysql.v1.DeleteBackupRetentionPolicyResponse
...
func file_yandex_cloud_mdb_mysql_v1_backup_retention_policy_service_proto_init() {
	if File_yandex_cloud_mdb_mysql_v1_backup_retention_policy_service_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_yandex_cloud_mdb_mysql_v1_backup_retention_policy_service_proto_goTypes,
		DependencyIndexes: file_yandex_cloud_mdb_mysql_v1_backup_retention_policy_service_proto_depIdxs,
		MessageInfos:      file_yandex_cloud_mdb_mysql_v1_backup_retention_policy_service_proto_msgTypes,
	}.Build()
	File_yandex_cloud_mdb_mysql_v1_backup_retention_policy_service_proto = out.File
	file_yandex_cloud_mdb_mysql_v1_backup_retention_policy_service_proto_goTypes = nil
	file_yandex_cloud_mdb_mysql_v1_backup_retention_policy_service_proto_depIdxs = nil
}

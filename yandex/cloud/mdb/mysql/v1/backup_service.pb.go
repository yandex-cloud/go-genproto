...
const file_yandex_cloud_mdb_mysql_v1_backup_service_proto_rawDesc = "" +
	"\n" +
	".yandex/cloud/mdb/mysql/v1/backup_service.proto\x12\x19yandex.cloud.mdb.mysql.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1dyandex/cloud/validation.proto\x1a yandex/cloud/api/operation.proto\x1a&yandex/cloud/operation/operation.proto\x1a&yandex/cloud/mdb/mysql/v1/backup.proto\"5\n" +
	...
	"\abackups\x18\x01 \x03(\v2!.yandex.cloud.mdb.mysql.v1.BackupR\abackups\x121\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tB\t\x8a\xc81\x05<=100R\rnextPageToken\"8\n" +
	...
	"\n" +
	"cluster_id\x18\x02 \x01(\tR\tclusterId2\xdf\x03\n" +
	...
	"\x06Delete\x12..yandex.cloud.mdb.mysql.v1.DeleteBackupRequest\x1a!.yandex.cloud.operation.Operation\"^\xb2\xd2*-\n" +
	"\x14DeleteBackupMetadata\x12\x15google.protobuf.Empty\x82\xd3\xe4\x93\x02'*%/managed-mysql/v1/backups/{backup_id}Bd\n" +
...
var (
	...
	file_yandex_cloud_mdb_mysql_v1_backup_service_proto_rawDescData []byte
)
...
func file_yandex_cloud_mdb_mysql_v1_backup_service_proto_rawDescGZIP() []byte {
	file_yandex_cloud_mdb_mysql_v1_backup_service_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_mdb_mysql_v1_backup_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_mysql_v1_backup_service_proto_rawDesc), len(file_yandex_cloud_mdb_mysql_v1_backup_service_proto_rawDesc)))
	})
...
func file_yandex_cloud_mdb_mysql_v1_backup_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_mysql_v1_backup_service_proto_rawDesc), len(file_yandex_cloud_mdb_mysql_v1_backup_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,

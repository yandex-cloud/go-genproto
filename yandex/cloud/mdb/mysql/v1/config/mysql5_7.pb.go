...
const file_yandex_cloud_mdb_mysql_v1_config_mysql5_7_proto_rawDesc = "" +
	"\n" +
	"/yandex/cloud/mdb/mysql/v1/config/mysql5_7.proto\x12 yandex.cloud.mdb.mysql.v1.config\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1dyandex/cloud/validation.proto\"\xbeP\n" +
	...
	"\bsql_mode\x18\x06 \x03(\x0e28.yandex.cloud.mdb.mysql.v1.config.MysqlConfig5_7.SQLModeR\asqlMode\x12^\n" +
	...
	"\x1ddefault_authentication_plugin\x18\b \x01(\x0e2;.yandex.cloud.mdb.mysql.v1.config.MysqlConfig5_7.AuthPluginR\x1bdefaultAuthenticationPlugin\x12g\n" +
	...
	"\x15transaction_isolation\x18\v \x01(\x0e2E.yandex.cloud.mdb.mysql.v1.config.MysqlConfig5_7.TransactionIsolationR\x14transactionIsolation\x12W\n" +
	...
	"\x10binlog_row_image\x18- \x01(\x0e2?.yandex.cloud.mdb.mysql.v1.config.MysqlConfig5_7.BinlogRowImageR\x0ebinlogRowImage\x12Z\n" +
	...
	"\x13slave_parallel_type\x180 \x01(\x0e2B.yandex.cloud.mdb.mysql.v1.config.MysqlConfig5_7.SlaveParallelTypeR\x11slaveParallelType\x12[\n" +
	"\x16slave_parallel_workers\x181 \x01(\v2\x1b.google.protobuf.Int64ValueB\b\xfa\xc71\x040-64R\x14slaveParallelWorkers\x12t\n" +
	...
	"\x1cmdb_offline_mode_disable_lag\x186 \x01(\v2\x1b.google.protobuf.Int64ValueB\f\xfa\xc71\b60-86400R\x18mdbOfflineModeDisableLag\x12r\n" +
	...
	"\x17max_prepared_stmt_count\x18R \x01(\v2\x1b.google.protobuf.Int64ValueB\r\xfa\xc71\t0-1048576R\x14maxPreparedStmtCount\x12)\n" +
	"\x10optimizer_switch\x18S \x01(\tR\x0foptimizerSwitch\x12[\n" +
	"\x16optimizer_search_depth\x18T \x01(\v2\x1b.google.protobuf.Int64ValueB\b\xfa\xc71\x040-62R\x14optimizerSearchDepth\x12U\n" +
	"\x19query_response_time_stats\x18U \x01(\v2\x1a.google.protobuf.BoolValueR\x16queryResponseTimeStats\x126\n" +
	"\buserstat\x18V \x01(\v2\x1a.google.protobuf.BoolValueR\buserstat\x12[\n" +
	"\x12max_execution_time\x18W \x01(\v2\x1b.google.protobuf.Int64ValueB\x10\xfa\xc71\f0-4294967295R\x10maxExecutionTime\x12i\n" +
	"\x10audit_log_policy\x18X \x01(\x0e2?.yandex.cloud.mdb.mysql.v1.config.MysqlConfig5_7.AuditLogPolicyR\x0eauditLogPolicy\x12b\n" +
	...
	"\x17innodb_change_buffering\x18[ \x01(\x0e2F.yandex.cloud.mdb.mysql.v1.config.MysqlConfig5_7.InnodbChangeBufferingR\x15innodbChangeBuffering\"\x99\x05\n" +
	"\aSQLMode\x12\x17\n" +
	...
	"\fNO_ZERO_DATE\x10\n" +
	"\x12\x13\n" +
	"\x0fNO_ZERO_IN_DATE\x10\v\x12\x14\n" +
	"\x10NO_FIELD_OPTIONS\x10\f\x12\x12\n" +
	...
	"\x13STRICT_TRANS_TABLES\x10\x14\x12\b\n" +
	"\x04ANSI\x10\x15\x12\x0f\n" +
	"\vTRADITIONAL\x10\x16\x12\a\n" +
	"\x03DB2\x10\x17\x12\t\n" +
	"\x05MAXDB\x10\x18\x12\t\n" +
	"\x05MSSQL\x10\x19\x12\f\n" +
	"\bMYSQL323\x10\x1a\x12\v\n" +
	"\aMYSQL40\x10\x1b\x12\n" +
	"\n" +
	...
	"\x15CACHING_SHA2_PASSWORD\x10\x02\x1a\x02\b\x01\x12\x13\n" +
	...
	"\x10effective_config\x18\x01 \x01(\v20.yandex.cloud.mdb.mysql.v1.config.MysqlConfig5_7R\x0feffectiveConfig\x12Q\n" +
	"\vuser_config\x18\x02 \x01(\v20.yandex.cloud.mdb.mysql.v1.config.MysqlConfig5_7R\n" +
	"userConfig\x12W\n" +
	"\x0edefault_config\x18\x03 \x01(\v20.yandex.cloud.mdb.mysql.v1.config.MysqlConfig5_7R\rdefaultConfigBr\n" +
...
var (
	...
	file_yandex_cloud_mdb_mysql_v1_config_mysql5_7_proto_rawDescData []byte
)
...
func file_yandex_cloud_mdb_mysql_v1_config_mysql5_7_proto_rawDescGZIP() []byte {
	file_yandex_cloud_mdb_mysql_v1_config_mysql5_7_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_mdb_mysql_v1_config_mysql5_7_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_mysql_v1_config_mysql5_7_proto_rawDesc), len(file_yandex_cloud_mdb_mysql_v1_config_mysql5_7_proto_rawDesc)))
	})
...
func file_yandex_cloud_mdb_mysql_v1_config_mysql5_7_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_mysql_v1_config_mysql5_7_proto_rawDesc), len(file_yandex_cloud_mdb_mysql_v1_config_mysql5_7_proto_rawDesc)),
			NumEnums:      10,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,

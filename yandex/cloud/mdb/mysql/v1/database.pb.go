...
var file_yandex_cloud_mdb_mysql_v1_database_proto_rawDesc = []byte{
	...
	0x33, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x42, 0x64, 0x0a, 0x1d, 0x79, 0x61, 0x6e, 0x64, 0x65,
...
func file_yandex_cloud_mdb_mysql_v1_database_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yandex_cloud_mdb_mysql_v1_database_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_mdb_mysql_v1_database_proto_msgTypes[1].Exporter = func(v any, i int) any {

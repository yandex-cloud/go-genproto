...
const file_yandex_cloud_mdb_mysql_v1_resource_preset_service_proto_rawDesc = "" +
	"\n" +
	"7yandex/cloud/mdb/mysql/v1/resource_preset_service.proto\x12\x19yandex.cloud.mdb.mysql.v1\x1a\x1cgoogle/api/annotations.proto\x1a/yandex/cloud/mdb/mysql/v1/resource_preset.proto\x1a\x1dyandex/cloud/validation.proto\"N\n" +
	...
	"\n" +
	"page_token\x18\x03 \x01(\tB\t\x8a\xc81\x05<=100R\tpageToken\"\xa6\x01\n" +
	"\x1bListResourcePresetsResponse\x12T\n" +
	"\x10resource_presets\x18\x01 \x03(\v2).yandex.cloud.mdb.mysql.v1.ResourcePresetR\x0fresourcePresets\x121\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tB\t\x8a\xc81\x05<=100R\rnextPageToken2\xe2\x02\n" +
	"\x15ResourcePresetService\x12\xa5\x01\n" +
	"\x03Get\x123.yandex.cloud.mdb.mysql.v1.GetResourcePresetRequest\x1a).yandex.cloud.mdb.mysql.v1.ResourcePreset\">\x82\xd3\xe4\x93\x028\x126/managed-mysql/v1/resourcePresets/{resource_preset_id}\x12\xa0\x01\n" +
	"\x04List\x125.yandex.cloud.mdb.mysql.v1.ListResourcePresetsRequest\x1a6.yandex.cloud.mdb.mysql.v1.ListResourcePresetsResponse\")\x82\xd3\xe4\x93\x02#\x12!/managed-mysql/v1/resourcePresetsBd\n" +
...
var (
	...
	file_yandex_cloud_mdb_mysql_v1_resource_preset_service_proto_rawDescData []byte
)
...
func file_yandex_cloud_mdb_mysql_v1_resource_preset_service_proto_rawDescGZIP() []byte {
	file_yandex_cloud_mdb_mysql_v1_resource_preset_service_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_mdb_mysql_v1_resource_preset_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_mysql_v1_resource_preset_service_proto_rawDesc), len(file_yandex_cloud_mdb_mysql_v1_resource_preset_service_proto_rawDesc)))
	})
...
var file_yandex_cloud_mdb_mysql_v1_resource_preset_service_proto_goTypes = []any{
...
func file_yandex_cloud_mdb_mysql_v1_resource_preset_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_mysql_v1_resource_preset_service_proto_rawDesc), len(file_yandex_cloud_mdb_mysql_v1_resource_preset_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,

...
const file_yandex_cloud_mdb_mysql_v1alpha_database_service_proto_rawDesc = "" +
	...
	"\tdatabases\x18\x01 \x03(\v2(.yandex.cloud.mdb.mysql.v1alpha.DatabaseR\tdatabases\x12&\n" +
	...
	"\rdatabase_spec\x18\x02 \x01(\v2,.yandex.cloud.mdb.mysql.v1alpha.DatabaseSpecB\x04\xe8\xc71\x01R\fdatabaseSpec\"\\\n" +
...
var (
	...
	file_yandex_cloud_mdb_mysql_v1alpha_database_service_proto_rawDescData []byte
)
...
func file_yandex_cloud_mdb_mysql_v1alpha_database_service_proto_rawDescGZIP() []byte {
	file_yandex_cloud_mdb_mysql_v1alpha_database_service_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_mdb_mysql_v1alpha_database_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_mysql_v1alpha_database_service_proto_rawDesc), len(file_yandex_cloud_mdb_mysql_v1alpha_database_service_proto_rawDesc)))
	})
...
func file_yandex_cloud_mdb_mysql_v1alpha_database_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_mysql_v1alpha_database_service_proto_rawDesc), len(file_yandex_cloud_mdb_mysql_v1alpha_database_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,

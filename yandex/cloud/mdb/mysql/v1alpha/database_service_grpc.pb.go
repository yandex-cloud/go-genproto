...
const (
	DatabaseService_Get_FullMethodName    = "/yandex.cloud.mdb.mysql.v1alpha.DatabaseService/Get"
	DatabaseService_List_FullMethodName   = "/yandex.cloud.mdb.mysql.v1alpha.DatabaseService/List"
	DatabaseService_Create_FullMethodName = "/yandex.cloud.mdb.mysql.v1alpha.DatabaseService/Create"
	DatabaseService_Delete_FullMethodName = "/yandex.cloud.mdb.mysql.v1alpha.DatabaseService/Delete"
)
...
func (c *databaseServiceClient) Get(ctx context.Context, in *GetDatabaseRequest, opts ...grpc.CallOption) (*Database, error) {
	out := new(Database)
	err := c.cc.Invoke(ctx, DatabaseService_Get_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *databaseServiceClient) List(ctx context.Context, in *ListDatabasesRequest, opts ...grpc.CallOption) (*ListDatabasesResponse, error) {
	...
	err := c.cc.Invoke(ctx, DatabaseService_List_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil

...
func file_yandex_cloud_mdb_opensearch_v1_cluster_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_yandex_cloud_mdb_opensearch_v1_cluster_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yandex_cloud_mdb_opensearch_v1_cluster_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {

...
const (
	ExtensionService_Get_FullMethodName    = "/yandex.cloud.mdb.opensearch.v1.ExtensionService/Get"
	ExtensionService_List_FullMethodName   = "/yandex.cloud.mdb.opensearch.v1.ExtensionService/List"
	ExtensionService_Create_FullMethodName = "/yandex.cloud.mdb.opensearch.v1.ExtensionService/Create"
	ExtensionService_Update_FullMethodName = "/yandex.cloud.mdb.opensearch.v1.ExtensionService/Update"
	ExtensionService_Delete_FullMethodName = "/yandex.cloud.mdb.opensearch.v1.ExtensionService/Delete"
)
...
func (c *extensionServiceClient) Get(ctx context.Context, in *GetExtensionRequest, opts ...grpc.CallOption) (*Extension, error) {
	...
	out := new(Extension)
	err := c.cc.Invoke(ctx, ExtensionService_Get_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *extensionServiceClient) List(ctx context.Context, in *ListExtensionsRequest, opts ...grpc.CallOption) (*ListExtensionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ExtensionService_List_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *extensionServiceClient) Create(ctx context.Context, in *CreateExtensionRequest, opts ...grpc.CallOption) (*operation.Operation, error) {
	...
	err := c.cc.Invoke(ctx, ExtensionService_Create_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *extensionServiceClient) Update(ctx context.Context, in *UpdateExtensionRequest, opts ...grpc.CallOption) (*operation.Operation, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(operation.Operation)
	err := c.cc.Invoke(ctx, ExtensionService_Update_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *extensionServiceClient) Delete(ctx context.Context, in *DeleteExtensionRequest, opts ...grpc.CallOption) (*operation.Operation, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(operation.Operation)
	err := c.cc.Invoke(ctx, ExtensionService_Delete_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedExtensionServiceServer should be embedded to have
...
func _ExtensionService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ExtensionService_Get_FullMethodName,
	}
...
func _ExtensionService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ExtensionService_List_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ExtensionService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ExtensionService_Create_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ExtensionService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ExtensionService_Update_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ExtensionService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ExtensionService_Delete_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var ExtensionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "yandex.cloud.mdb.opensearch.v1.ExtensionService",
	...
	Metadata: "yandex/cloud/mdb/opensearch/v1/extension_service.proto",
}

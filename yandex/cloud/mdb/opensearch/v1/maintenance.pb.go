...
var file_yandex_cloud_mdb_opensearch_v1_maintenance_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x57, 0x69, 0x6e, 0x64, 0x6f, 0x77, 0x54, 0x69, 0x6d, 0x65, 0x42, 0x73, 0x0a, 0x22,
...
func file_yandex_cloud_mdb_opensearch_v1_maintenance_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yandex_cloud_mdb_opensearch_v1_maintenance_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_mdb_opensearch_v1_maintenance_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_mdb_opensearch_v1_maintenance_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_mdb_opensearch_v1_maintenance_proto_msgTypes[3].Exporter = func(v any, i int) any {

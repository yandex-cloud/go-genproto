...
const file_yandex_cloud_mdb_opensearch_v1_maintenance_proto_rawDesc = "" +
	"\n" +
	"0yandex/cloud/mdb/opensearch/v1/maintenance.proto\x12\x1eyandex.cloud.mdb.opensearch.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1dyandex/cloud/validation.proto\"\xf0\x01\n" +
	"\x11MaintenanceWindow\x12T\n" +
	"\aanytime\x18\x01 \x01(\v28.yandex.cloud.mdb.opensearch.v1.AnytimeMaintenanceWindowH\x00R\aanytime\x12u\n" +
	"\x19weekly_maintenance_window\x18\x02 \x01(\v27.yandex.cloud.mdb.opensearch.v1.WeeklyMaintenanceWindowH\x00R\x17weeklyMaintenanceWindowB\x0e\n" +
	"\x06policy\x12\x04\xc0\xc11\x01\"\x1a\n" +
	"\x18AnytimeMaintenanceWindow\"\xee\x01\n" +
	"\x17WeeklyMaintenanceWindow\x12Q\n" +
	"\x03day\x18\x01 \x01(\x0e2?.yandex.cloud.mdb.opensearch.v1.WeeklyMaintenanceWindow.WeekDayR\x03day\x12\x1c\n" +
	...
	"\x1cnext_maintenance_window_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\x19nextMaintenanceWindowTimeBs\n" +
...
var (
	...
	file_yandex_cloud_mdb_opensearch_v1_maintenance_proto_rawDescData []byte
)
...
func file_yandex_cloud_mdb_opensearch_v1_maintenance_proto_rawDescGZIP() []byte {
	file_yandex_cloud_mdb_opensearch_v1_maintenance_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_mdb_opensearch_v1_maintenance_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_opensearch_v1_maintenance_proto_rawDesc), len(file_yandex_cloud_mdb_opensearch_v1_maintenance_proto_rawDesc)))
	})
...
var file_yandex_cloud_mdb_opensearch_v1_maintenance_proto_goTypes = []any{
...
func file_yandex_cloud_mdb_opensearch_v1_maintenance_proto_init() {
	...
	file_yandex_cloud_mdb_opensearch_v1_maintenance_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_opensearch_v1_maintenance_proto_rawDesc), len(file_yandex_cloud_mdb_opensearch_v1_maintenance_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,

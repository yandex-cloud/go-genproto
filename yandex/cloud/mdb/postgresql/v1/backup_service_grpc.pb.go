...
const (
	BackupService_Get_FullMethodName    = "/yandex.cloud.mdb.postgresql.v1.BackupService/Get"
	BackupService_List_FullMethodName   = "/yandex.cloud.mdb.postgresql.v1.BackupService/List"
	BackupService_Delete_FullMethodName = "/yandex.cloud.mdb.postgresql.v1.BackupService/Delete"
)

...
const (
	ClusterService_Get_FullMethodName                   = "/yandex.cloud.mdb.postgresql.v1.ClusterService/Get"
	ClusterService_List_FullMethodName                  = "/yandex.cloud.mdb.postgresql.v1.ClusterService/List"
	ClusterService_Create_FullMethodName                = "/yandex.cloud.mdb.postgresql.v1.ClusterService/Create"
	ClusterService_Update_FullMethodName                = "/yandex.cloud.mdb.postgresql.v1.ClusterService/Update"
	ClusterService_Delete_FullMethodName                = "/yandex.cloud.mdb.postgresql.v1.ClusterService/Delete"
	ClusterService_Start_FullMethodName                 = "/yandex.cloud.mdb.postgresql.v1.ClusterService/Start"
	ClusterService_Stop_FullMethodName                  = "/yandex.cloud.mdb.postgresql.v1.ClusterService/Stop"
	ClusterService_Move_FullMethodName                  = "/yandex.cloud.mdb.postgresql.v1.ClusterService/Move"
	ClusterService_Backup_FullMethodName                = "/yandex.cloud.mdb.postgresql.v1.ClusterService/Backup"
	ClusterService_Restore_FullMethodName               = "/yandex.cloud.mdb.postgresql.v1.ClusterService/Restore"
	ClusterService_RescheduleMaintenance_FullMethodName = "/yandex.cloud.mdb.postgresql.v1.ClusterService/RescheduleMaintenance"
	ClusterService_StartFailover_FullMethodName         = "/yandex.cloud.mdb.postgresql.v1.ClusterService/StartFailover"
	ClusterService_ListLogs_FullMethodName              = "/yandex.cloud.mdb.postgresql.v1.ClusterService/ListLogs"
	ClusterService_StreamLogs_FullMethodName            = "/yandex.cloud.mdb.postgresql.v1.ClusterService/StreamLogs"
	ClusterService_ListOperations_FullMethodName        = "/yandex.cloud.mdb.postgresql.v1.ClusterService/ListOperations"
	ClusterService_ListBackups_FullMethodName           = "/yandex.cloud.mdb.postgresql.v1.ClusterService/ListBackups"
	ClusterService_ListHosts_FullMethodName             = "/yandex.cloud.mdb.postgresql.v1.ClusterService/ListHosts"

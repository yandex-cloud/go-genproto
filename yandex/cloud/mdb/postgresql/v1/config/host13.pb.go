...
const file_yandex_cloud_mdb_postgresql_v1_config_host13_proto_rawDesc = "" +
	"\n" +
	"2yandex/cloud/mdb/postgresql/v1/config/host13.proto\x12%yandex.cloud.mdb.postgresql.v1.config\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1dyandex/cloud/validation.proto\"\xb98\n" +
	"\x16PostgresqlHostConfig13\x12T\n" +
	...
	"\x14constraint_exclusion\x18\t \x01(\x0e2Q.yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig13.ConstraintExclusionR\x13constraintExclusion\x12P\n" +
	...
	"\x13force_parallel_mode\x18\r \x01(\x0e2O.yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig13.ForceParallelModeR\x11forceParallelMode\x12v\n" +
	"\x13client_min_messages\x18\x0e \x01(\x0e2F.yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig13.LogLevelR\x11clientMinMessages\x12p\n" +
	"\x10log_min_messages\x18\x0f \x01(\x0e2F.yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig13.LogLevelR\x0elogMinMessages\x12}\n" +
	"\x17log_min_error_statement\x18\x10 \x01(\x0e2F.yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig13.LogLevelR\x14logMinErrorStatement\x12X\n" +
	...
	"\x13log_error_verbosity\x18\x16 \x01(\x0e2O.yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig13.LogErrorVerbosityR\x11logErrorVerbosity\x12@\n" +
	"\x0elog_lock_waits\x18\x17 \x01(\v2\x1a.google.protobuf.BoolValueR\flogLockWaits\x12o\n" +
	"\rlog_statement\x18\x18 \x01(\x0e2J.yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig13.LogStatementR\flogStatement\x12A\n" +
	...
	"\x1ddefault_transaction_isolation\x18\x1c \x01(\x0e2R.yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig13.TransactionIsolationR\x1bdefaultTransactionIsolation\x12H\n" +
	...
	"\fbytea_output\x18  \x01(\x0e2I.yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig13.ByteaOutputR\vbyteaOutput\x12e\n" +
	"\txmlbinary\x18! \x01(\x0e2G.yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig13.XmlBinaryR\txmlbinary\x12e\n" +
	"\txmloption\x18\" \x01(\x0e2G.yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig13.XmlOptionR\txmloption\x12P\n" +
	...
	"arrayNulls\x12u\n" +
	"\x0fbackslash_quote\x18( \x01(\x0e2L.yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig13.BackslashQuoteR\x0ebackslashQuote\x12F\n" +
...
var (
	...
	file_yandex_cloud_mdb_postgresql_v1_config_host13_proto_rawDescData []byte
)
...
func file_yandex_cloud_mdb_postgresql_v1_config_host13_proto_rawDescGZIP() []byte {
	file_yandex_cloud_mdb_postgresql_v1_config_host13_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_mdb_postgresql_v1_config_host13_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_postgresql_v1_config_host13_proto_rawDesc), len(file_yandex_cloud_mdb_postgresql_v1_config_host13_proto_rawDesc)))
	})
...
var file_yandex_cloud_mdb_postgresql_v1_config_host13_proto_goTypes = []any{
...
func file_yandex_cloud_mdb_postgresql_v1_config_host13_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_postgresql_v1_config_host13_proto_rawDesc), len(file_yandex_cloud_mdb_postgresql_v1_config_host13_proto_rawDesc)),
			NumEnums:      10,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,

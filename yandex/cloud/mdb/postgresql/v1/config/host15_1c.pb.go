...
const file_yandex_cloud_mdb_postgresql_v1_config_host15_1c_proto_rawDesc = "" +
	"\n" +
	"5yandex/cloud/mdb/postgresql/v1/config/host15_1c.proto\x12%yandex.cloud.mdb.postgresql.v1.config\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1dyandex/cloud/validation.proto\"\x899\n" +

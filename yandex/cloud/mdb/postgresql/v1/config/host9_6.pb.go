...
const file_yandex_cloud_mdb_postgresql_v1_config_host9_6_proto_rawDesc = "" +
	"\n" +
	"3yandex/cloud/mdb/postgresql/v1/config/host9_6.proto\x12%yandex.cloud.mdb.postgresql.v1.config\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1dyandex/cloud/validation.proto\"\xfb1\n" +

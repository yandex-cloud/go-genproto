...
const file_yandex_cloud_mdb_postgresql_v1_config_postgresql10_proto_rawDesc = "" +
	"\n" +
	"8yandex/cloud/mdb/postgresql/v1/config/postgresql10.proto\x12%yandex.cloud.mdb.postgresql.v1.config\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1dyandex/cloud/validation.proto\"\xdal\n" +
	"\x12PostgresqlConfig10\x12D\n" +

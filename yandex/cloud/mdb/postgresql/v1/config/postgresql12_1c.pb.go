...
const file_yandex_cloud_mdb_postgresql_v1_config_postgresql12_1c_proto_rawDesc = "" +
	"\n" +
	";yandex/cloud/mdb/postgresql/v1/config/postgresql12_1c.proto\x12%yandex.cloud.mdb.postgresql.v1.config\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1dyandex/cloud/validation.proto\"\xf9y\n" +
	"\x15PostgresqlConfig12_1C\x12N\n" +
	...
	"\twal_level\x18\x14 \x01(\x0e2E.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig12_1C.WalLevelR\bwalLevel\x12}\n" +
	"\x12synchronous_commit\x18\x15 \x01(\x0e2N.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig12_1C.SynchronousCommitR\x11synchronousCommit\x12^\n" +
	...
	"\x14constraint_exclusion\x18\x1d \x01(\x0e2P.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig12_1C.ConstraintExclusionR\x13constraintExclusion\x12P\n" +
	...
	"\x13force_parallel_mode\x18! \x01(\x0e2N.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig12_1C.ForceParallelModeR\x11forceParallelMode\x12u\n" +
	"\x13client_min_messages\x18\" \x01(\x0e2E.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig12_1C.LogLevelR\x11clientMinMessages\x12o\n" +
	"\x10log_min_messages\x18# \x01(\x0e2E.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig12_1C.LogLevelR\x0elogMinMessages\x12|\n" +
	"\x17log_min_error_statement\x18$ \x01(\x0e2E.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig12_1C.LogLevelR\x14logMinErrorStatement\x12X\n" +
	...
	"\x13log_error_verbosity\x18* \x01(\x0e2N.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig12_1C.LogErrorVerbosityR\x11logErrorVerbosity\x12@\n" +
	"\x0elog_lock_waits\x18+ \x01(\v2\x1a.google.protobuf.BoolValueR\flogLockWaits\x12n\n" +
	"\rlog_statement\x18, \x01(\x0e2I.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig12_1C.LogStatementR\flogStatement\x12A\n" +
	...
	"\x1ddefault_transaction_isolation\x180 \x01(\x0e2Q.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig12_1C.TransactionIsolationR\x1bdefaultTransactionIsolation\x12H\n" +
	...
	"\fbytea_output\x184 \x01(\x0e2H.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig12_1C.ByteaOutputR\vbyteaOutput\x12d\n" +
	"\txmlbinary\x185 \x01(\x0e2F.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig12_1C.XmlBinaryR\txmlbinary\x12d\n" +
	"\txmloption\x186 \x01(\x0e2F.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig12_1C.XmlOptionR\txmloption\x12P\n" +
	...
	"arrayNulls\x12t\n" +
	"\x0fbackslash_quote\x18< \x01(\x0e2K.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig12_1C.BackslashQuoteR\x0ebackslashQuote\x12F\n" +
	...
	"\x0fplan_cache_mode\x18l \x01(\x0e2J.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig12_1C.PlanCacheModeR\rplanCacheMode\x12a\n" +
	...
	"\x18shared_preload_libraries\x18o \x03(\x0e2S.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig12_1C.SharedPreloadLibrariesR\x16sharedPreloadLibraries\x12p\n" +
	...
	"\x18pg_hint_plan_debug_print\x18z \x01(\x0e2Q.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig12_1C.PgHintPlanDebugPrintR\x14pgHintPlanDebugPrint\x12\x81\x01\n" +
	"\x1apg_hint_plan_message_level\x18{ \x01(\x0e2E.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig12_1C.LogLevelR\x16pgHintPlanMessageLevel\x12L\n" +
	...
	"\x18pg_qualstats_sample_rate\x18\x80\x01 \x01(\v2\x1c.google.protobuf.DoubleValueR\x15pgQualstatsSampleRate\x12V\n" +
	...
	"\x13password_encryption\x18\xa7\x01 \x01(\x0e2O.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig12_1C.PasswordEncryptionR\x12passwordEncryption\"\x9a\x01\n" +
	...
	"\x12XML_OPTION_CONTENT\x10\x02J\x06\b\x81\x01\x10\x95\x01J\x06\b\x97\x01\x10\x98\x01J\x06\b\xa6\x01\x10\xa7\x01J\x04\bN\x10O\"\xc7\x02\n" +
	"\x18PostgresqlConfigSet12_1C\x12g\n" +
	"\x10effective_config\x18\x01 \x01(\v2<.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig12_1CR\x0feffectiveConfig\x12]\n" +
	"\vuser_config\x18\x02 \x01(\v2<.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig12_1CR\n" +
	"userConfig\x12c\n" +
	"\x0edefault_config\x18\x03 \x01(\v2<.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig12_1CR\rdefaultConfigB\x81\x01\n" +
...
var (
	...
	file_yandex_cloud_mdb_postgresql_v1_config_postgresql12_1c_proto_rawDescData []byte
)
...
func file_yandex_cloud_mdb_postgresql_v1_config_postgresql12_1c_proto_rawDescGZIP() []byte {
	file_yandex_cloud_mdb_postgresql_v1_config_postgresql12_1c_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_mdb_postgresql_v1_config_postgresql12_1c_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_postgresql_v1_config_postgresql12_1c_proto_rawDesc), len(file_yandex_cloud_mdb_postgresql_v1_config_postgresql12_1c_proto_rawDesc)))
	})
...
func file_yandex_cloud_mdb_postgresql_v1_config_postgresql12_1c_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_postgresql_v1_config_postgresql12_1c_proto_rawDesc), len(file_yandex_cloud_mdb_postgresql_v1_config_postgresql12_1c_proto_rawDesc)),
			NumEnums:      16,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,

...
const file_yandex_cloud_mdb_postgresql_v1_config_postgresql13_proto_rawDesc = "" +
	"\n" +
	"8yandex/cloud/mdb/postgresql/v1/config/postgresql13.proto\x12%yandex.cloud.mdb.postgresql.v1.config\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1dyandex/cloud/validation.proto\"\x9f\x82\x01\n" +
	"\x12PostgresqlConfig13\x12N\n" +

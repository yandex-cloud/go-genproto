...
const file_yandex_cloud_mdb_postgresql_v1_config_postgresql13_1c_proto_rawDesc = "" +
	"\n" +
	";yandex/cloud/mdb/postgresql/v1/config/postgresql13_1c.proto\x12%yandex.cloud.mdb.postgresql.v1.config\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1dyandex/cloud/validation.proto\"\xa0\x83\x01\n" +
	"\x15PostgresqlConfig13_1C\x12D\n" +
	...
	"\twal_level\x18\x14 \x01(\x0e2E.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig13_1C.WalLevelR\bwalLevel\x12}\n" +
	"\x12synchronous_commit\x18\x15 \x01(\x0e2N.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig13_1C.SynchronousCommitR\x11synchronousCommit\x12^\n" +
	...
	"\x14constraint_exclusion\x18\x1d \x01(\x0e2P.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig13_1C.ConstraintExclusionR\x13constraintExclusion\x12P\n" +
	...
	"\x13force_parallel_mode\x18! \x01(\x0e2N.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig13_1C.ForceParallelModeR\x11forceParallelMode\x12u\n" +
	"\x13client_min_messages\x18\" \x01(\x0e2E.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig13_1C.LogLevelR\x11clientMinMessages\x12o\n" +
	"\x10log_min_messages\x18# \x01(\x0e2E.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig13_1C.LogLevelR\x0elogMinMessages\x12|\n" +
	"\x17log_min_error_statement\x18$ \x01(\x0e2E.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig13_1C.LogLevelR\x14logMinErrorStatement\x12X\n" +
	...
	"\x13log_error_verbosity\x18* \x01(\x0e2N.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig13_1C.LogErrorVerbosityR\x11logErrorVerbosity\x12@\n" +
	"\x0elog_lock_waits\x18+ \x01(\v2\x1a.google.protobuf.BoolValueR\flogLockWaits\x12n\n" +
	"\rlog_statement\x18, \x01(\x0e2I.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig13_1C.LogStatementR\flogStatement\x12A\n" +
	...
	"\x1ddefault_transaction_isolation\x180 \x01(\x0e2Q.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig13_1C.TransactionIsolationR\x1bdefaultTransactionIsolation\x12H\n" +
	...
	"\fbytea_output\x184 \x01(\x0e2H.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig13_1C.ByteaOutputR\vbyteaOutput\x12d\n" +
	"\txmlbinary\x185 \x01(\x0e2F.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig13_1C.XmlBinaryR\txmlbinary\x12d\n" +
	"\txmloption\x186 \x01(\x0e2F.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig13_1C.XmlOptionR\txmloption\x12P\n" +
	...
	"arrayNulls\x12t\n" +
	"\x0fbackslash_quote\x18< \x01(\x0e2K.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig13_1C.BackslashQuoteR\x0ebackslashQuote\x12F\n" +
	...
	"\x0fplan_cache_mode\x18l \x01(\x0e2J.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig13_1C.PlanCacheModeR\rplanCacheMode\x12a\n" +
	...
	"\x18shared_preload_libraries\x18o \x03(\x0e2S.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig13_1C.SharedPreloadLibrariesR\x16sharedPreloadLibraries\x12p\n" +
	...
	"\x18pg_hint_plan_debug_print\x18z \x01(\x0e2Q.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig13_1C.PgHintPlanDebugPrintR\x14pgHintPlanDebugPrint\x12\x81\x01\n" +
	"\x1apg_hint_plan_message_level\x18{ \x01(\x0e2E.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig13_1C.LogLevelR\x16pgHintPlanMessageLevel\x12\\\n" +
	...
	"!log_parameter_max_length_on_error\x18\x88\x01 \x01(\v2\x1b.google.protobuf.Int64ValueB\x11\xfa\xc71\r-1-2147483647R\x1clogParameterMaxLengthOnError\x12M\n" +
	"\x14pg_qualstats_enabled\x18\x89\x01 \x01(\v2\x1a.google.protobuf.BoolValueR\x12pgQualstatsEnabled\x12\\\n" +
	"\x1cpg_qualstats_track_constants\x18\x8a\x01 \x01(\v2\x1a.google.protobuf.BoolValueR\x19pgQualstatsTrackConstants\x12F\n" +
	"\x10pg_qualstats_max\x18\x8b\x01 \x01(\v2\x1b.google.protobuf.Int64ValueR\x0epgQualstatsMax\x12V\n" +
	"\x19pg_qualstats_resolve_oids\x18\x8c\x01 \x01(\v2\x1a.google.protobuf.BoolValueR\x16pgQualstatsResolveOids\x12V\n" +
	"\x18pg_qualstats_sample_rate\x18\x8d\x01 \x01(\v2\x1c.google.protobuf.DoubleValueR\x15pgQualstatsSampleRate\x12V\n" +
	...
	"\x13password_encryption\x18\xa7\x01 \x01(\x0e2O.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig13_1C.PasswordEncryptionR\x12passwordEncryption\"\x9a\x01\n" +
	...
	"\x12XML_OPTION_CONTENT\x10\x02J\x04\b}\x10~J\x06\b\x8e\x01\x10\x95\x01J\x06\b\x96\x01\x10\x98\x01J\x06\b\xa6\x01\x10\xa7\x01J\x04\bN\x10O\"\xc7\x02\n" +
	"\x18PostgresqlConfigSet13_1C\x12g\n" +
	"\x10effective_config\x18\x01 \x01(\v2<.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig13_1CR\x0feffectiveConfig\x12]\n" +
	"\vuser_config\x18\x02 \x01(\v2<.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig13_1CR\n" +
	"userConfig\x12c\n" +
	"\x0edefault_config\x18\x03 \x01(\v2<.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig13_1CR\rdefaultConfigB\x81\x01\n" +
...
var (
	...
	file_yandex_cloud_mdb_postgresql_v1_config_postgresql13_1c_proto_rawDescData []byte
)
...
func file_yandex_cloud_mdb_postgresql_v1_config_postgresql13_1c_proto_rawDescGZIP() []byte {
	file_yandex_cloud_mdb_postgresql_v1_config_postgresql13_1c_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_mdb_postgresql_v1_config_postgresql13_1c_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_postgresql_v1_config_postgresql13_1c_proto_rawDesc), len(file_yandex_cloud_mdb_postgresql_v1_config_postgresql13_1c_proto_rawDesc)))
	})
...
func file_yandex_cloud_mdb_postgresql_v1_config_postgresql13_1c_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_postgresql_v1_config_postgresql13_1c_proto_rawDesc), len(file_yandex_cloud_mdb_postgresql_v1_config_postgresql13_1c_proto_rawDesc)),
			NumEnums:      16,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,

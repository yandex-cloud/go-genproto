...
func (m *PostgresqlConfig14) SetAutoExplainLogFormat(v PostgresqlConfig14_AutoExplainLogFormat) {
	m.AutoExplainLogFormat = v
}

func (m *PostgresqlConfig14) SetIdleSessionTimeout(v *wrapperspb.Int64Value) {
	m.IdleSessionTimeout = v
}

func (m *PostgresqlConfig14) SetCheckpointWarning(v *wrapperspb.Int64Value) {

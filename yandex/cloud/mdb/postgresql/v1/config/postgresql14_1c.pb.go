...
type PostgresqlConfig14_1C_AutoExplainLogFormat int32

const (
	PostgresqlConfig14_1C_AUTO_EXPLAIN_LOG_FORMAT_UNSPECIFIED PostgresqlConfig14_1C_AutoExplainLogFormat = 0
	// 'text' value for the EXPLAIN output format in auto_explain extension
	PostgresqlConfig14_1C_AUTO_EXPLAIN_LOG_FORMAT_TEXT PostgresqlConfig14_1C_AutoExplainLogFormat = 1
	// 'xml' value for the EXPLAIN output format in auto_explain extension
	PostgresqlConfig14_1C_AUTO_EXPLAIN_LOG_FORMAT_XML PostgresqlConfig14_1C_AutoExplainLogFormat = 2
	// 'json' value for the EXPLAIN output format in auto_explain extension
	PostgresqlConfig14_1C_AUTO_EXPLAIN_LOG_FORMAT_JSON PostgresqlConfig14_1C_AutoExplainLogFormat = 3
	// 'yaml' value for the EXPLAIN output format in auto_explain extension
	PostgresqlConfig14_1C_AUTO_EXPLAIN_LOG_FORMAT_YAML PostgresqlConfig14_1C_AutoExplainLogFormat = 4
)

// Enum value maps for PostgresqlConfig14_1C_AutoExplainLogFormat.
var (
	PostgresqlConfig14_1C_AutoExplainLogFormat_name = map[int32]string{
	...
	PostgresqlConfig14_1C_AutoExplainLogFormat_value = map[string]int32{
...
func (x PostgresqlConfig14_1C_AutoExplainLogFormat) Enum() *PostgresqlConfig14_1C_AutoExplainLogFormat {
	p := new(PostgresqlConfig14_1C_AutoExplainLogFormat)
	*p = x
	return p
}

func (x PostgresqlConfig14_1C_AutoExplainLogFormat) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PostgresqlConfig14_1C_AutoExplainLogFormat) Descriptor() protoreflect.EnumDescriptor {
	return file_yandex_cloud_mdb_postgresql_v1_config_postgresql14_1c_proto_enumTypes[0].Descriptor()
}

func (PostgresqlConfig14_1C_AutoExplainLogFormat) Type() protoreflect.EnumType {
	return &file_yandex_cloud_mdb_postgresql_v1_config_postgresql14_1c_proto_enumTypes[0]
}

func (x PostgresqlConfig14_1C_AutoExplainLogFormat) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PostgresqlConfig14_1C_AutoExplainLogFormat.Descriptor instead.
func (PostgresqlConfig14_1C_AutoExplainLogFormat) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	PostgresqlConfig14_1C_SHARED_PRELOAD_LIBRARIES_SPQRGUARD PostgresqlConfig14_1C_SharedPreloadLibraries = 9
)
...
func (PostgresqlConfig14_1C_XmlOption) Descriptor() protoreflect.EnumDescriptor {
	return file_yandex_cloud_mdb_postgresql_v1_config_postgresql14_1c_proto_enumTypes[16].Descriptor()
}

func (PostgresqlConfig14_1C_XmlOption) Type() protoreflect.EnumType {
	return &file_yandex_cloud_mdb_postgresql_v1_config_postgresql14_1c_proto_enumTypes[16]
}
...
func (PostgresqlConfig14_1C_XmlOption) EnumDescriptor() ([]byte, []int) {
	return file_yandex_cloud_mdb_postgresql_v1_config_postgresql14_1c_proto_rawDescGZIP(), []int{0, 16}
}
...
func (x *PostgresqlConfig14_1C) GetAutoExplainLogFormat() PostgresqlConfig14_1C_AutoExplainLogFormat {
	if x != nil {
		return x.AutoExplainLogFormat
	}
	return PostgresqlConfig14_1C_AUTO_EXPLAIN_LOG_FORMAT_UNSPECIFIED
}

func (x *PostgresqlConfig14_1C) GetIdleSessionTimeout() *wrapperspb.Int64Value {
	if x != nil {
...
func (x *PostgresqlConfig14_1C) GetCheckpointWarning() *wrapperspb.Int64Value {
	if x != nil {
...
func (x *PostgresqlConfig14_1C) GetAutovacuumVacuumThreshold() *wrapperspb.Int64Value {
	if x != nil {
...
func (x *PostgresqlConfig14_1C) GetAutovacuumAnalyzeThreshold() *wrapperspb.Int64Value {
	if x != nil {
...
const file_yandex_cloud_mdb_postgresql_v1_config_postgresql14_1c_proto_rawDesc = "" +
	"\n" +
	";yandex/cloud/mdb/postgresql/v1/config/postgresql14_1c.proto\x12%yandex.cloud.mdb.postgresql.v1.config\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1dyandex/cloud/validation.proto\"\x8e\x8d\x01\n" +
	...
	"\x16old_snapshot_threshold\x18\x13 \x01(\v2\x1b.google.protobuf.Int64ValueB\x0f\xfa\xc71\v-1-86400000R\x14oldSnapshotThreshold\x12b\n" +
	"\twal_level\x18\x14 \x01(\x0e2E.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.WalLevelR\bwalLevel\x12}\n" +
	"\x12synchronous_commit\x18\x15 \x01(\x0e2N.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.SynchronousCommitR\x11synchronousCommit\x12^\n" +
	...
	"\x14constraint_exclusion\x18\x1d \x01(\x0e2P.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.ConstraintExclusionR\x13constraintExclusion\x12P\n" +
	...
	"\x13force_parallel_mode\x18! \x01(\x0e2N.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.ForceParallelModeR\x11forceParallelMode\x12u\n" +
	"\x13client_min_messages\x18\" \x01(\x0e2E.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.LogLevelR\x11clientMinMessages\x12o\n" +
	"\x10log_min_messages\x18# \x01(\x0e2E.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.LogLevelR\x0elogMinMessages\x12|\n" +
	"\x17log_min_error_statement\x18$ \x01(\x0e2E.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.LogLevelR\x14logMinErrorStatement\x12X\n" +
	...
	"\x13log_error_verbosity\x18* \x01(\x0e2N.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.LogErrorVerbosityR\x11logErrorVerbosity\x12@\n" +
	"\x0elog_lock_waits\x18+ \x01(\v2\x1a.google.protobuf.BoolValueR\flogLockWaits\x12n\n" +
	"\rlog_statement\x18, \x01(\x0e2I.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.LogStatementR\flogStatement\x12A\n" +
	...
	"\x1ddefault_transaction_isolation\x180 \x01(\x0e2Q.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.TransactionIsolationR\x1bdefaultTransactionIsolation\x12H\n" +
	...
	"arrayNulls\x12t\n" +
	"\x0fbackslash_quote\x18< \x01(\x0e2K.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.BackslashQuoteR\x0ebackslashQuote\x12F\n" +
	...
	"\x0fplan_cache_mode\x18l \x01(\x0e2J.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.PlanCacheModeR\rplanCacheMode\x12a\n" +
	...
	"\x18shared_preload_libraries\x18o \x03(\x0e2S.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.SharedPreloadLibrariesR\x16sharedPreloadLibraries\x12p\n" +
	...
	"\x18pg_hint_plan_debug_print\x18z \x01(\x0e2Q.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.PgHintPlanDebugPrintR\x14pgHintPlanDebugPrint\x12\x81\x01\n" +
	"\x1apg_hint_plan_message_level\x18{ \x01(\x0e2E.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.LogLevelR\x16pgHintPlanMessageLevel\x12\\\n" +
	...
	"\x19plantuner_fix_empty_table\x18\x95\x01 \x01(\v2\x1a.google.protobuf.BoolValueR\x16plantunerFixEmptyTable\x12/\n" +
	...
	"\x13password_encryption\x18\xa7\x01 \x01(\x0e2O.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.PasswordEncryptionR\x12passwordEncryption\x12\x89\x01\n" +
	"\x17auto_explain_log_format\x18\xa8\x01 \x01(\x0e2Q.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.AutoExplainLogFormatR\x14autoExplainLogFormat\x12`\n" +
	...
	"\x12XML_OPTION_CONTENT\x10\x02J\x04\bN\x10OJ\x04\bj\x10kJ\x04\b}\x10~J\x06\b\x96\x01\x10\x98\x01J\x06\b\xa6\x01\x10\xa7\x01J\x04\b@\x10AJ\x06\b\xa9\x01\x10\xad\x01J\x06\b\xaf\x01\x10\xb1\x01\"\xc7\x02\n" +
	"\x18PostgresqlConfigSet14_1C\x12g\n" +
	"\x10effective_config\x18\x01 \x01(\v2<.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1CR\x0feffectiveConfig\x12]\n" +
	"\vuser_config\x18\x02 \x01(\v2<.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1CR\n" +
	"userConfig\x12c\n" +
	"\x0edefault_config\x18\x03 \x01(\v2<.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1CR\rdefaultConfigB\x81\x01\n" +
...
var (
	...
	file_yandex_cloud_mdb_postgresql_v1_config_postgresql14_1c_proto_rawDescData []byte
)
...
func file_yandex_cloud_mdb_postgresql_v1_config_postgresql14_1c_proto_rawDescGZIP() []byte {
	file_yandex_cloud_mdb_postgresql_v1_config_postgresql14_1c_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_mdb_postgresql_v1_config_postgresql14_1c_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_postgresql_v1_config_postgresql14_1c_proto_rawDesc), len(file_yandex_cloud_mdb_postgresql_v1_config_postgresql14_1c_proto_rawDesc)))
	})
	return file_yandex_cloud_mdb_postgresql_v1_config_postgresql14_1c_proto_rawDescData
}

var file_yandex_cloud_mdb_postgresql_v1_config_postgresql14_1c_proto_enumTypes = make([]protoimpl.EnumInfo, 17)
var file_yandex_cloud_mdb_postgresql_v1_config_postgresql14_1c_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_yandex_cloud_mdb_postgresql_v1_config_postgresql14_1c_proto_goTypes = []any{
	(PostgresqlConfig14_1C_AutoExplainLogFormat)(0),   // 0: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.AutoExplainLogFormat
	(PostgresqlConfig14_1C_BackslashQuote)(0),         // 1: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.BackslashQuote
	(PostgresqlConfig14_1C_ByteaOutput)(0),            // 2: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.ByteaOutput
	(PostgresqlConfig14_1C_ConstraintExclusion)(0),    // 3: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.ConstraintExclusion
	(PostgresqlConfig14_1C_ForceParallelMode)(0),      // 4: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.ForceParallelMode
	(PostgresqlConfig14_1C_LogErrorVerbosity)(0),      // 5: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.LogErrorVerbosity
	(PostgresqlConfig14_1C_LogLevel)(0),               // 6: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.LogLevel
	(PostgresqlConfig14_1C_LogStatement)(0),           // 7: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.LogStatement
	(PostgresqlConfig14_1C_PasswordEncryption)(0),     // 8: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.PasswordEncryption
	(PostgresqlConfig14_1C_PgHintPlanDebugPrint)(0),   // 9: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.PgHintPlanDebugPrint
	(PostgresqlConfig14_1C_PlanCacheMode)(0),          // 10: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.PlanCacheMode
	(PostgresqlConfig14_1C_SharedPreloadLibraries)(0), // 11: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.SharedPreloadLibraries
	(PostgresqlConfig14_1C_SynchronousCommit)(0),      // 12: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.SynchronousCommit
	(PostgresqlConfig14_1C_TransactionIsolation)(0),   // 13: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.TransactionIsolation
	(PostgresqlConfig14_1C_WalLevel)(0),               // 14: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.WalLevel
	(PostgresqlConfig14_1C_XmlBinary)(0),              // 15: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.XmlBinary
	(PostgresqlConfig14_1C_XmlOption)(0),              // 16: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.XmlOption
	(*PostgresqlConfig14_1C)(nil),                     // 17: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C
	(*PostgresqlConfigSet14_1C)(nil),                  // 18: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfigSet14_1C
...
var file_yandex_cloud_mdb_postgresql_v1_config_postgresql14_1c_proto_depIdxs = []int32{
	19,  // 0: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.max_connections:type_name -> google.protobuf.Int64Value
	19,  // 1: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.shared_buffers:type_name -> google.protobuf.Int64Value
	19,  // 2: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.temp_buffers:type_name -> google.protobuf.Int64Value
	19,  // 3: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.max_prepared_transactions:type_name -> google.protobuf.Int64Value
	19,  // 4: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.work_mem:type_name -> google.protobuf.Int64Value
	19,  // 5: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.maintenance_work_mem:type_name -> google.protobuf.Int64Value
	19,  // 6: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.autovacuum_work_mem:type_name -> google.protobuf.Int64Value
	19,  // 7: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.temp_file_limit:type_name -> google.protobuf.Int64Value
	19,  // 8: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.vacuum_cost_delay:type_name -> google.protobuf.Int64Value
	19,  // 9: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.vacuum_cost_page_hit:type_name -> google.protobuf.Int64Value
	19,  // 10: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.vacuum_cost_page_miss:type_name -> google.protobuf.Int64Value
	19,  // 11: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.vacuum_cost_page_dirty:type_name -> google.protobuf.Int64Value
	19,  // 12: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.vacuum_cost_limit:type_name -> google.protobuf.Int64Value
	19,  // 13: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.bgwriter_delay:type_name -> google.protobuf.Int64Value
	19,  // 14: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.bgwriter_lru_maxpages:type_name -> google.protobuf.Int64Value
	20,  // 15: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.bgwriter_lru_multiplier:type_name -> google.protobuf.DoubleValue
	19,  // 16: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.bgwriter_flush_after:type_name -> google.protobuf.Int64Value
	19,  // 17: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.backend_flush_after:type_name -> google.protobuf.Int64Value
	19,  // 18: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.old_snapshot_threshold:type_name -> google.protobuf.Int64Value
	14,  // 19: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.wal_level:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.WalLevel
	12,  // 20: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.synchronous_commit:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.SynchronousCommit
	19,  // 21: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.checkpoint_timeout:type_name -> google.protobuf.Int64Value
	20,  // 22: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.checkpoint_completion_target:type_name -> google.protobuf.DoubleValue
	19,  // 23: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.checkpoint_flush_after:type_name -> google.protobuf.Int64Value
	19,  // 24: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.max_wal_size:type_name -> google.protobuf.Int64Value
	19,  // 25: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.min_wal_size:type_name -> google.protobuf.Int64Value
	19,  // 26: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.max_standby_streaming_delay:type_name -> google.protobuf.Int64Value
	19,  // 27: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.default_statistics_target:type_name -> google.protobuf.Int64Value
	3,   // 28: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.constraint_exclusion:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.ConstraintExclusion
	20,  // 29: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.cursor_tuple_fraction:type_name -> google.protobuf.DoubleValue
	19,  // 30: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.from_collapse_limit:type_name -> google.protobuf.Int64Value
	19,  // 31: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.join_collapse_limit:type_name -> google.protobuf.Int64Value
	4,   // 32: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.force_parallel_mode:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.ForceParallelMode
	6,   // 33: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.client_min_messages:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.LogLevel
	6,   // 34: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.log_min_messages:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.LogLevel
	6,   // 35: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.log_min_error_statement:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.LogLevel
	19,  // 36: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.log_min_duration_statement:type_name -> google.protobuf.Int64Value
	21,  // 37: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.log_checkpoints:type_name -> google.protobuf.BoolValue
	21,  // 38: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.log_connections:type_name -> google.protobuf.BoolValue
	21,  // 39: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.log_disconnections:type_name -> google.protobuf.BoolValue
	21,  // 40: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.log_duration:type_name -> google.protobuf.BoolValue
	5,   // 41: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.log_error_verbosity:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.LogErrorVerbosity
	21,  // 42: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.log_lock_waits:type_name -> google.protobuf.BoolValue
	7,   // 43: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.log_statement:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.LogStatement
	19,  // 44: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.log_temp_files:type_name -> google.protobuf.Int64Value
	21,  // 45: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.row_security:type_name -> google.protobuf.BoolValue
	13,  // 46: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.default_transaction_isolation:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.TransactionIsolation
	19,  // 47: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.statement_timeout:type_name -> google.protobuf.Int64Value
	19,  // 48: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.lock_timeout:type_name -> google.protobuf.Int64Value
	19,  // 49: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.idle_in_transaction_session_timeout:type_name -> google.protobuf.Int64Value
	2,   // 50: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.bytea_output:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.ByteaOutput
	15,  // 51: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.xmlbinary:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.XmlBinary
	16,  // 52: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.xmloption:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.XmlOption
	19,  // 53: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.gin_pending_list_limit:type_name -> google.protobuf.Int64Value
	19,  // 54: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.deadlock_timeout:type_name -> google.protobuf.Int64Value
	19,  // 55: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.max_locks_per_transaction:type_name -> google.protobuf.Int64Value
	19,  // 56: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.max_pred_locks_per_transaction:type_name -> google.protobuf.Int64Value
	21,  // 57: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.array_nulls:type_name -> google.protobuf.BoolValue
	1,   // 58: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.backslash_quote:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.BackslashQuote
	21,  // 59: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.default_with_oids:type_name -> google.protobuf.BoolValue
	21,  // 60: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.escape_string_warning:type_name -> google.protobuf.BoolValue
	21,  // 61: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.lo_compat_privileges:type_name -> google.protobuf.BoolValue
	21,  // 62: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.quote_all_identifiers:type_name -> google.protobuf.BoolValue
	21,  // 63: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.standard_conforming_strings:type_name -> google.protobuf.BoolValue
	21,  // 64: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.synchronize_seqscans:type_name -> google.protobuf.BoolValue
	21,  // 65: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.transform_null_equals:type_name -> google.protobuf.BoolValue
	21,  // 66: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.exit_on_error:type_name -> google.protobuf.BoolValue
	20,  // 67: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.seq_page_cost:type_name -> google.protobuf.DoubleValue
	20,  // 68: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.random_page_cost:type_name -> google.protobuf.DoubleValue
	19,  // 69: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.autovacuum_max_workers:type_name -> google.protobuf.Int64Value
	19,  // 70: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.autovacuum_vacuum_cost_delay:type_name -> google.protobuf.Int64Value
	19,  // 71: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.autovacuum_vacuum_cost_limit:type_name -> google.protobuf.Int64Value
	19,  // 72: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.autovacuum_naptime:type_name -> google.protobuf.Int64Value
	19,  // 73: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.archive_timeout:type_name -> google.protobuf.Int64Value
	19,  // 74: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.track_activity_query_size:type_name -> google.protobuf.Int64Value
	21,  // 75: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.online_analyze_enable:type_name -> google.protobuf.BoolValue
	21,  // 76: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.enable_bitmapscan:type_name -> google.protobuf.BoolValue
	21,  // 77: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.enable_hashagg:type_name -> google.protobuf.BoolValue
	21,  // 78: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.enable_hashjoin:type_name -> google.protobuf.BoolValue
	21,  // 79: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.enable_indexscan:type_name -> google.protobuf.BoolValue
	21,  // 80: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.enable_indexonlyscan:type_name -> google.protobuf.BoolValue
	21,  // 81: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.enable_material:type_name -> google.protobuf.BoolValue
	21,  // 82: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.enable_mergejoin:type_name -> google.protobuf.BoolValue
	21,  // 83: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.enable_nestloop:type_name -> google.protobuf.BoolValue
	21,  // 84: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.enable_seqscan:type_name -> google.protobuf.BoolValue
	21,  // 85: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.enable_sort:type_name -> google.protobuf.BoolValue
	21,  // 86: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.enable_tidscan:type_name -> google.protobuf.BoolValue
	19,  // 87: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.max_worker_processes:type_name -> google.protobuf.Int64Value
	19,  // 88: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.max_parallel_workers:type_name -> google.protobuf.Int64Value
	19,  // 89: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.max_parallel_workers_per_gather:type_name -> google.protobuf.Int64Value
	20,  // 90: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.autovacuum_vacuum_scale_factor:type_name -> google.protobuf.DoubleValue
	20,  // 91: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.autovacuum_analyze_scale_factor:type_name -> google.protobuf.DoubleValue
	21,  // 92: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.default_transaction_read_only:type_name -> google.protobuf.BoolValue
	21,  // 93: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.enable_parallel_append:type_name -> google.protobuf.BoolValue
	21,  // 94: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.enable_parallel_hash:type_name -> google.protobuf.BoolValue
	21,  // 95: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.enable_partition_pruning:type_name -> google.protobuf.BoolValue
	21,  // 96: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.enable_partitionwise_aggregate:type_name -> google.protobuf.BoolValue
	21,  // 97: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.enable_partitionwise_join:type_name -> google.protobuf.BoolValue
	21,  // 98: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.jit:type_name -> google.protobuf.BoolValue
	19,  // 99: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.max_parallel_maintenance_workers:type_name -> google.protobuf.Int64Value
	21,  // 100: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.parallel_leader_participation:type_name -> google.protobuf.BoolValue
	20,  // 101: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.log_transaction_sample_rate:type_name -> google.protobuf.DoubleValue
	10,  // 102: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.plan_cache_mode:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.PlanCacheMode
	19,  // 103: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.effective_io_concurrency:type_name -> google.protobuf.Int64Value
	19,  // 104: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.effective_cache_size:type_name -> google.protobuf.Int64Value
	11,  // 105: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.shared_preload_libraries:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.SharedPreloadLibraries
	19,  // 106: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.auto_explain_log_min_duration:type_name -> google.protobuf.Int64Value
	21,  // 107: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.auto_explain_log_analyze:type_name -> google.protobuf.BoolValue
	21,  // 108: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.auto_explain_log_buffers:type_name -> google.protobuf.BoolValue
	21,  // 109: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.auto_explain_log_timing:type_name -> google.protobuf.BoolValue
	21,  // 110: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.auto_explain_log_triggers:type_name -> google.protobuf.BoolValue
	21,  // 111: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.auto_explain_log_verbose:type_name -> google.protobuf.BoolValue
	21,  // 112: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.auto_explain_log_nested_statements:type_name -> google.protobuf.BoolValue
	20,  // 113: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.auto_explain_sample_rate:type_name -> google.protobuf.DoubleValue
	21,  // 114: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.pg_hint_plan_enable_hint:type_name -> google.protobuf.BoolValue
	21,  // 115: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.pg_hint_plan_enable_hint_table:type_name -> google.protobuf.BoolValue
	9,   // 116: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.pg_hint_plan_debug_print:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.PgHintPlanDebugPrint
	6,   // 117: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.pg_hint_plan_message_level:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.LogLevel
	20,  // 118: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.hash_mem_multiplier:type_name -> google.protobuf.DoubleValue
	19,  // 119: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.logical_decoding_work_mem:type_name -> google.protobuf.Int64Value
	19,  // 120: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.maintenance_io_concurrency:type_name -> google.protobuf.Int64Value
	19,  // 121: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.max_slot_wal_keep_size:type_name -> google.protobuf.Int64Value
	19,  // 122: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.wal_keep_size:type_name -> google.protobuf.Int64Value
	21,  // 123: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.enable_incremental_sort:type_name -> google.protobuf.BoolValue
	19,  // 124: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.autovacuum_vacuum_insert_threshold:type_name -> google.protobuf.Int64Value
	20,  // 125: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.autovacuum_vacuum_insert_scale_factor:type_name -> google.protobuf.DoubleValue
	19,  // 126: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.log_min_duration_sample:type_name -> google.protobuf.Int64Value
	20,  // 127: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.log_statement_sample_rate:type_name -> google.protobuf.DoubleValue
	19,  // 128: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.log_parameter_max_length:type_name -> google.protobuf.Int64Value
	19,  // 129: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.log_parameter_max_length_on_error:type_name -> google.protobuf.Int64Value
	19,  // 130: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.client_connection_check_interval:type_name -> google.protobuf.Int64Value
	21,  // 131: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.enable_async_append:type_name -> google.protobuf.BoolValue
	21,  // 132: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.enable_gathermerge:type_name -> google.protobuf.BoolValue
	21,  // 133: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.enable_memoize:type_name -> google.protobuf.BoolValue
	21,  // 134: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.log_recovery_conflict_waits:type_name -> google.protobuf.BoolValue
	19,  // 135: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.vacuum_failsafe_age:type_name -> google.protobuf.Int64Value
	19,  // 136: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.vacuum_multixact_failsafe_age:type_name -> google.protobuf.Int64Value
	21,  // 137: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.pg_qualstats_enabled:type_name -> google.protobuf.BoolValue
	21,  // 138: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.pg_qualstats_track_constants:type_name -> google.protobuf.BoolValue
	19,  // 139: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.pg_qualstats_max:type_name -> google.protobuf.Int64Value
	21,  // 140: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.pg_qualstats_resolve_oids:type_name -> google.protobuf.BoolValue
	20,  // 141: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.pg_qualstats_sample_rate:type_name -> google.protobuf.DoubleValue
	21,  // 142: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.plantuner_fix_empty_table:type_name -> google.protobuf.BoolValue
	21,  // 143: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.geqo:type_name -> google.protobuf.BoolValue
	19,  // 144: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.geqo_threshold:type_name -> google.protobuf.Int64Value
	19,  // 145: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.geqo_effort:type_name -> google.protobuf.Int64Value
	19,  // 146: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.geqo_pool_size:type_name -> google.protobuf.Int64Value
	19,  // 147: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.geqo_generations:type_name -> google.protobuf.Int64Value
	20,  // 148: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.geqo_selection_bias:type_name -> google.protobuf.DoubleValue
	20,  // 149: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.geqo_seed:type_name -> google.protobuf.DoubleValue
	20,  // 150: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.pg_trgm_similarity_threshold:type_name -> google.protobuf.DoubleValue
	20,  // 151: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.pg_trgm_word_similarity_threshold:type_name -> google.protobuf.DoubleValue
	20,  // 152: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.pg_trgm_strict_word_similarity_threshold:type_name -> google.protobuf.DoubleValue
	19,  // 153: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.max_standby_archive_delay:type_name -> google.protobuf.Int64Value
	19,  // 154: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.session_duration_timeout:type_name -> google.protobuf.Int64Value
	21,  // 155: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.log_replication_commands:type_name -> google.protobuf.BoolValue
	19,  // 156: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.log_autovacuum_min_duration:type_name -> google.protobuf.Int64Value
	8,   // 157: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.password_encryption:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.PasswordEncryption
	0,   // 158: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.auto_explain_log_format:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.AutoExplainLogFormat
	19,  // 159: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.idle_session_timeout:type_name -> google.protobuf.Int64Value
	19,  // 160: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.checkpoint_warning:type_name -> google.protobuf.Int64Value
	19,  // 161: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.autovacuum_vacuum_threshold:type_name -> google.protobuf.Int64Value
	19,  // 162: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C.autovacuum_analyze_threshold:type_name -> google.protobuf.Int64Value
	17,  // 163: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfigSet14_1C.effective_config:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C
	17,  // 164: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfigSet14_1C.user_config:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C
	17,  // 165: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfigSet14_1C.default_config:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig14_1C
...
func file_yandex_cloud_mdb_postgresql_v1_config_postgresql14_1c_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_postgresql_v1_config_postgresql14_1c_proto_rawDesc), len(file_yandex_cloud_mdb_postgresql_v1_config_postgresql14_1c_proto_rawDesc)),
			NumEnums:      17,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,

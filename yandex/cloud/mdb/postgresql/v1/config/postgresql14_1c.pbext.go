...
func (m *PostgresqlConfig14_1C) SetPasswordEncryption(v PostgresqlConfig14_1C_PasswordEncryption) {
	m.PasswordEncryption = v
}

func (m *PostgresqlConfig14_1C) SetAutoExplainLogFormat(v PostgresqlConfig14_1C_AutoExplainLogFormat) {
	m.AutoExplainLogFormat = v
}

func (m *PostgresqlConfig14_1C) SetIdleSessionTimeout(v *wrapperspb.Int64Value) {
	m.IdleSessionTimeout = v
}

func (m *PostgresqlConfig14_1C) SetCheckpointWarning(v *wrapperspb.Int64Value) {

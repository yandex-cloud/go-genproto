...
type PostgresqlConfig15_AutoExplainLogFormat int32

const (
	PostgresqlConfig15_AUTO_EXPLAIN_LOG_FORMAT_UNSPECIFIED PostgresqlConfig15_AutoExplainLogFormat = 0
	// Text EXPLAIN output format
	PostgresqlConfig15_AUTO_EXPLAIN_LOG_FORMAT_TEXT PostgresqlConfig15_AutoExplainLogFormat = 1
	// XML EXPLAIN output format
	PostgresqlConfig15_AUTO_EXPLAIN_LOG_FORMAT_XML PostgresqlConfig15_AutoExplainLogFormat = 2
	// JSON EXPLAIN output format
	PostgresqlConfig15_AUTO_EXPLAIN_LOG_FORMAT_JSON PostgresqlConfig15_AutoExplainLogFormat = 3
	// YAML EXPLAIN output format
	PostgresqlConfig15_AUTO_EXPLAIN_LOG_FORMAT_YAML PostgresqlConfig15_AutoExplainLogFormat = 4
)

// Enum value maps for PostgresqlConfig15_AutoExplainLogFormat.
var (
	PostgresqlConfig15_AutoExplainLogFormat_name = map[int32]string{
	...
	PostgresqlConfig15_AutoExplainLogFormat_value = map[string]int32{
...
func (x PostgresqlConfig15_AutoExplainLogFormat) Enum() *PostgresqlConfig15_AutoExplainLogFormat {
	p := new(PostgresqlConfig15_AutoExplainLogFormat)
	*p = x
	return p
}

func (x PostgresqlConfig15_AutoExplainLogFormat) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PostgresqlConfig15_AutoExplainLogFormat) Descriptor() protoreflect.EnumDescriptor {
	return file_yandex_cloud_mdb_postgresql_v1_config_postgresql15_proto_enumTypes[0].Descriptor()
}

func (PostgresqlConfig15_AutoExplainLogFormat) Type() protoreflect.EnumType {
	return &file_yandex_cloud_mdb_postgresql_v1_config_postgresql15_proto_enumTypes[0]
}

func (x PostgresqlConfig15_AutoExplainLogFormat) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PostgresqlConfig15_AutoExplainLogFormat.Descriptor instead.
func (PostgresqlConfig15_AutoExplainLogFormat) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	PostgresqlConfig15_SHARED_PRELOAD_LIBRARIES_ANON PostgresqlConfig15_SharedPreloadLibraries = 9
	// Required for the [spqrguard](https://github.com/pg-sharding/spqrguard) extension.
	PostgresqlConfig15_SHARED_PRELOAD_LIBRARIES_SPQRGUARD PostgresqlConfig15_SharedPreloadLibraries = 10
)
...
var (
	PostgresqlConfig15_SharedPreloadLibraries_name = map[int32]string{
		...
		10: "SHARED_PRELOAD_LIBRARIES_SPQRGUARD",
	}
	PostgresqlConfig15_SharedPreloadLibraries_value = map[string]int32{
		...
		"SHARED_PRELOAD_LIBRARIES_SPQRGUARD":    10,
	}
)
...
func (PostgresqlConfig15_XmlOption) Descriptor() protoreflect.EnumDescriptor {
	return file_yandex_cloud_mdb_postgresql_v1_config_postgresql15_proto_enumTypes[16].Descriptor()
}

func (PostgresqlConfig15_XmlOption) Type() protoreflect.EnumType {
	return &file_yandex_cloud_mdb_postgresql_v1_config_postgresql15_proto_enumTypes[16]
}
...
func (PostgresqlConfig15_XmlOption) EnumDescriptor() ([]byte, []int) {
	return file_yandex_cloud_mdb_postgresql_v1_config_postgresql15_proto_rawDescGZIP(), []int{0, 16}
}
...
func (x *PostgresqlConfig15) GetAutoExplainLogFormat() PostgresqlConfig15_AutoExplainLogFormat {
	if x != nil {
		return x.AutoExplainLogFormat
	}
	return PostgresqlConfig15_AUTO_EXPLAIN_LOG_FORMAT_UNSPECIFIED
}

func (x *PostgresqlConfig15) GetIdleSessionTimeout() *wrapperspb.Int64Value {
	if x != nil {
...
func (x *PostgresqlConfig15) GetCheckpointWarning() *wrapperspb.Int64Value {
	if x != nil {
...
func (x *PostgresqlConfig15) GetPgHintPlanHintsAnywhere() *wrapperspb.BoolValue {
	if x != nil {
...
func (x *PostgresqlConfig15) GetAutovacuumVacuumThreshold() *wrapperspb.Int64Value {
	if x != nil {
...
func (x *PostgresqlConfig15) GetAutovacuumAnalyzeThreshold() *wrapperspb.Int64Value {
	if x != nil {
...
const file_yandex_cloud_mdb_postgresql_v1_config_postgresql15_proto_rawDesc = "" +
	"\n" +
	"8yandex/cloud/mdb/postgresql/v1/config/postgresql15.proto\x12%yandex.cloud.mdb.postgresql.v1.config\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1dyandex/cloud/validation.proto\"؍\x01\n" +
	"\x12PostgresqlConfig15\x12N\n" +
	...
	"\twal_level\x18\x14 \x01(\x0e2B.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.WalLevelR\bwalLevel\x12z\n" +
	"\x12synchronous_commit\x18\x15 \x01(\x0e2K.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.SynchronousCommitR\x11synchronousCommit\x12^\n" +
	...
	"\x14constraint_exclusion\x18\x1d \x01(\x0e2M.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.ConstraintExclusionR\x13constraintExclusion\x12P\n" +
	...
	"\x13force_parallel_mode\x18! \x01(\x0e2K.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.ForceParallelModeR\x11forceParallelMode\x12r\n" +
	"\x13client_min_messages\x18\" \x01(\x0e2B.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.LogLevelR\x11clientMinMessages\x12l\n" +
	"\x10log_min_messages\x18# \x01(\x0e2B.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.LogLevelR\x0elogMinMessages\x12y\n" +
	"\x17log_min_error_statement\x18$ \x01(\x0e2B.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.LogLevelR\x14logMinErrorStatement\x12X\n" +
	...
	"\x13log_error_verbosity\x18* \x01(\x0e2K.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.LogErrorVerbosityR\x11logErrorVerbosity\x12@\n" +
	"\x0elog_lock_waits\x18+ \x01(\v2\x1a.google.protobuf.BoolValueR\flogLockWaits\x12k\n" +
	"\rlog_statement\x18, \x01(\x0e2F.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.LogStatementR\flogStatement\x12A\n" +
	...
	"\x1ddefault_transaction_isolation\x180 \x01(\x0e2N.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.TransactionIsolationR\x1bdefaultTransactionIsolation\x12H\n" +
	...
	"\fbytea_output\x184 \x01(\x0e2E.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.ByteaOutputR\vbyteaOutput\x12a\n" +
	"\txmlbinary\x185 \x01(\x0e2C.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.XmlBinaryR\txmlbinary\x12a\n" +
	"\txmloption\x186 \x01(\x0e2C.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.XmlOptionR\txmloption\x12P\n" +
	...
	"arrayNulls\x12q\n" +
	"\x0fbackslash_quote\x18< \x01(\x0e2H.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.BackslashQuoteR\x0ebackslashQuote\x12F\n" +
	...
	"\x0fplan_cache_mode\x18l \x01(\x0e2G.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.PlanCacheModeR\rplanCacheMode\x12a\n" +
	...
	"\x18shared_preload_libraries\x18o \x03(\x0e2P.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.SharedPreloadLibrariesR\x16sharedPreloadLibraries\x12p\n" +
	...
	"\x18pg_hint_plan_debug_print\x18z \x01(\x0e2N.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.PgHintPlanDebugPrintR\x14pgHintPlanDebugPrint\x12~\n" +
	"\x1apg_hint_plan_message_level\x18{ \x01(\x0e2B.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.LogLevelR\x16pgHintPlanMessageLevel\x12\\\n" +
	...
	"\x13password_encryption\x18\xa7\x01 \x01(\x0e2L.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.PasswordEncryptionR\x12passwordEncryption\x12\x86\x01\n" +
	"\x17auto_explain_log_format\x18\xa8\x01 \x01(\x0e2N.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.AutoExplainLogFormatR\x14autoExplainLogFormat\x12`\n" +
	...
	"\"PLAN_CACHE_MODE_FORCE_GENERIC_PLAN\x10\x03\"\xd5\x03\n" +
	...
	"\"SHARED_PRELOAD_LIBRARIES_SPQRGUARD\x10\n" +
	"\"\xd6\x01\n" +
	...
	"\x15PostgresqlConfigSet15\x12d\n" +
	"\x10effective_config\x18\x01 \x01(\v29.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15R\x0feffectiveConfig\x12Z\n" +
	"\vuser_config\x18\x02 \x01(\v29.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15R\n" +
	"userConfig\x12`\n" +
	"\x0edefault_config\x18\x03 \x01(\v29.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15R\rdefaultConfigB\x81\x01\n" +
...
var (
	...
	file_yandex_cloud_mdb_postgresql_v1_config_postgresql15_proto_rawDescData []byte
)
...
func file_yandex_cloud_mdb_postgresql_v1_config_postgresql15_proto_rawDescGZIP() []byte {
	file_yandex_cloud_mdb_postgresql_v1_config_postgresql15_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_mdb_postgresql_v1_config_postgresql15_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_postgresql_v1_config_postgresql15_proto_rawDesc), len(file_yandex_cloud_mdb_postgresql_v1_config_postgresql15_proto_rawDesc)))
	})
	return file_yandex_cloud_mdb_postgresql_v1_config_postgresql15_proto_rawDescData
}

var file_yandex_cloud_mdb_postgresql_v1_config_postgresql15_proto_enumTypes = make([]protoimpl.EnumInfo, 17)
var file_yandex_cloud_mdb_postgresql_v1_config_postgresql15_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_yandex_cloud_mdb_postgresql_v1_config_postgresql15_proto_goTypes = []any{
	(PostgresqlConfig15_AutoExplainLogFormat)(0),   // 0: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.AutoExplainLogFormat
	(PostgresqlConfig15_BackslashQuote)(0),         // 1: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.BackslashQuote
	(PostgresqlConfig15_ByteaOutput)(0),            // 2: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.ByteaOutput
	(PostgresqlConfig15_ConstraintExclusion)(0),    // 3: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.ConstraintExclusion
	(PostgresqlConfig15_ForceParallelMode)(0),      // 4: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.ForceParallelMode
	(PostgresqlConfig15_LogErrorVerbosity)(0),      // 5: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.LogErrorVerbosity
	(PostgresqlConfig15_LogLevel)(0),               // 6: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.LogLevel
	(PostgresqlConfig15_LogStatement)(0),           // 7: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.LogStatement
	(PostgresqlConfig15_PasswordEncryption)(0),     // 8: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.PasswordEncryption
	(PostgresqlConfig15_PgHintPlanDebugPrint)(0),   // 9: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.PgHintPlanDebugPrint
	(PostgresqlConfig15_PlanCacheMode)(0),          // 10: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.PlanCacheMode
	(PostgresqlConfig15_SharedPreloadLibraries)(0), // 11: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.SharedPreloadLibraries
	(PostgresqlConfig15_SynchronousCommit)(0),      // 12: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.SynchronousCommit
	(PostgresqlConfig15_TransactionIsolation)(0),   // 13: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.TransactionIsolation
	(PostgresqlConfig15_WalLevel)(0),               // 14: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.WalLevel
	(PostgresqlConfig15_XmlBinary)(0),              // 15: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.XmlBinary
	(PostgresqlConfig15_XmlOption)(0),              // 16: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.XmlOption
	(*PostgresqlConfig15)(nil),                     // 17: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15
	(*PostgresqlConfigSet15)(nil),                  // 18: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfigSet15
...
var file_yandex_cloud_mdb_postgresql_v1_config_postgresql15_proto_depIdxs = []int32{
	19,  // 0: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.max_connections:type_name -> google.protobuf.Int64Value
	19,  // 1: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.shared_buffers:type_name -> google.protobuf.Int64Value
	19,  // 2: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.temp_buffers:type_name -> google.protobuf.Int64Value
	19,  // 3: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.max_prepared_transactions:type_name -> google.protobuf.Int64Value
	19,  // 4: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.work_mem:type_name -> google.protobuf.Int64Value
	19,  // 5: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.maintenance_work_mem:type_name -> google.protobuf.Int64Value
	19,  // 6: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.autovacuum_work_mem:type_name -> google.protobuf.Int64Value
	19,  // 7: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.temp_file_limit:type_name -> google.protobuf.Int64Value
	19,  // 8: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.vacuum_cost_delay:type_name -> google.protobuf.Int64Value
	19,  // 9: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.vacuum_cost_page_hit:type_name -> google.protobuf.Int64Value
	19,  // 10: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.vacuum_cost_page_miss:type_name -> google.protobuf.Int64Value
	19,  // 11: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.vacuum_cost_page_dirty:type_name -> google.protobuf.Int64Value
	19,  // 12: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.vacuum_cost_limit:type_name -> google.protobuf.Int64Value
	19,  // 13: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.bgwriter_delay:type_name -> google.protobuf.Int64Value
	19,  // 14: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.bgwriter_lru_maxpages:type_name -> google.protobuf.Int64Value
	20,  // 15: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.bgwriter_lru_multiplier:type_name -> google.protobuf.DoubleValue
	19,  // 16: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.bgwriter_flush_after:type_name -> google.protobuf.Int64Value
	19,  // 17: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.backend_flush_after:type_name -> google.protobuf.Int64Value
	19,  // 18: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.old_snapshot_threshold:type_name -> google.protobuf.Int64Value
	14,  // 19: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.wal_level:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.WalLevel
	12,  // 20: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.synchronous_commit:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.SynchronousCommit
	19,  // 21: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.checkpoint_timeout:type_name -> google.protobuf.Int64Value
	20,  // 22: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.checkpoint_completion_target:type_name -> google.protobuf.DoubleValue
	19,  // 23: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.checkpoint_flush_after:type_name -> google.protobuf.Int64Value
	19,  // 24: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.max_wal_size:type_name -> google.protobuf.Int64Value
	19,  // 25: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.min_wal_size:type_name -> google.protobuf.Int64Value
	19,  // 26: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.max_standby_streaming_delay:type_name -> google.protobuf.Int64Value
	19,  // 27: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.default_statistics_target:type_name -> google.protobuf.Int64Value
	3,   // 28: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.constraint_exclusion:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.ConstraintExclusion
	20,  // 29: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.cursor_tuple_fraction:type_name -> google.protobuf.DoubleValue
	19,  // 30: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.from_collapse_limit:type_name -> google.protobuf.Int64Value
	19,  // 31: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.join_collapse_limit:type_name -> google.protobuf.Int64Value
	4,   // 32: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.force_parallel_mode:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.ForceParallelMode
	6,   // 33: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.client_min_messages:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.LogLevel
	6,   // 34: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.log_min_messages:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.LogLevel
	6,   // 35: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.log_min_error_statement:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.LogLevel
	19,  // 36: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.log_min_duration_statement:type_name -> google.protobuf.Int64Value
	21,  // 37: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.log_checkpoints:type_name -> google.protobuf.BoolValue
	21,  // 38: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.log_connections:type_name -> google.protobuf.BoolValue
	21,  // 39: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.log_disconnections:type_name -> google.protobuf.BoolValue
	21,  // 40: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.log_duration:type_name -> google.protobuf.BoolValue
	5,   // 41: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.log_error_verbosity:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.LogErrorVerbosity
	21,  // 42: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.log_lock_waits:type_name -> google.protobuf.BoolValue
	7,   // 43: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.log_statement:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.LogStatement
	19,  // 44: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.log_temp_files:type_name -> google.protobuf.Int64Value
	21,  // 45: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.row_security:type_name -> google.protobuf.BoolValue
	13,  // 46: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.default_transaction_isolation:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.TransactionIsolation
	19,  // 47: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.statement_timeout:type_name -> google.protobuf.Int64Value
	19,  // 48: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.lock_timeout:type_name -> google.protobuf.Int64Value
	19,  // 49: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.idle_in_transaction_session_timeout:type_name -> google.protobuf.Int64Value
	2,   // 50: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.bytea_output:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.ByteaOutput
	15,  // 51: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.xmlbinary:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.XmlBinary
	16,  // 52: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.xmloption:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.XmlOption
	19,  // 53: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.gin_pending_list_limit:type_name -> google.protobuf.Int64Value
	19,  // 54: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.deadlock_timeout:type_name -> google.protobuf.Int64Value
	19,  // 55: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.max_locks_per_transaction:type_name -> google.protobuf.Int64Value
	19,  // 56: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.max_pred_locks_per_transaction:type_name -> google.protobuf.Int64Value
	21,  // 57: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.array_nulls:type_name -> google.protobuf.BoolValue
	1,   // 58: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.backslash_quote:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.BackslashQuote
	21,  // 59: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.default_with_oids:type_name -> google.protobuf.BoolValue
	21,  // 60: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.escape_string_warning:type_name -> google.protobuf.BoolValue
	21,  // 61: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.lo_compat_privileges:type_name -> google.protobuf.BoolValue
	21,  // 62: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.quote_all_identifiers:type_name -> google.protobuf.BoolValue
	21,  // 63: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.standard_conforming_strings:type_name -> google.protobuf.BoolValue
	21,  // 64: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.synchronize_seqscans:type_name -> google.protobuf.BoolValue
	21,  // 65: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.transform_null_equals:type_name -> google.protobuf.BoolValue
	21,  // 66: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.exit_on_error:type_name -> google.protobuf.BoolValue
	20,  // 67: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.seq_page_cost:type_name -> google.protobuf.DoubleValue
	20,  // 68: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.random_page_cost:type_name -> google.protobuf.DoubleValue
	19,  // 69: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.autovacuum_max_workers:type_name -> google.protobuf.Int64Value
	19,  // 70: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.autovacuum_vacuum_cost_delay:type_name -> google.protobuf.Int64Value
	19,  // 71: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.autovacuum_vacuum_cost_limit:type_name -> google.protobuf.Int64Value
	19,  // 72: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.autovacuum_naptime:type_name -> google.protobuf.Int64Value
	19,  // 73: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.archive_timeout:type_name -> google.protobuf.Int64Value
	19,  // 74: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.track_activity_query_size:type_name -> google.protobuf.Int64Value
	21,  // 75: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.enable_bitmapscan:type_name -> google.protobuf.BoolValue
	21,  // 76: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.enable_hashagg:type_name -> google.protobuf.BoolValue
	21,  // 77: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.enable_hashjoin:type_name -> google.protobuf.BoolValue
	21,  // 78: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.enable_indexscan:type_name -> google.protobuf.BoolValue
	21,  // 79: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.enable_indexonlyscan:type_name -> google.protobuf.BoolValue
	21,  // 80: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.enable_material:type_name -> google.protobuf.BoolValue
	21,  // 81: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.enable_mergejoin:type_name -> google.protobuf.BoolValue
	21,  // 82: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.enable_nestloop:type_name -> google.protobuf.BoolValue
	21,  // 83: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.enable_seqscan:type_name -> google.protobuf.BoolValue
	21,  // 84: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.enable_sort:type_name -> google.protobuf.BoolValue
	21,  // 85: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.enable_tidscan:type_name -> google.protobuf.BoolValue
	19,  // 86: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.max_worker_processes:type_name -> google.protobuf.Int64Value
	19,  // 87: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.max_parallel_workers:type_name -> google.protobuf.Int64Value
	19,  // 88: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.max_parallel_workers_per_gather:type_name -> google.protobuf.Int64Value
	20,  // 89: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.autovacuum_vacuum_scale_factor:type_name -> google.protobuf.DoubleValue
	20,  // 90: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.autovacuum_analyze_scale_factor:type_name -> google.protobuf.DoubleValue
	21,  // 91: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.default_transaction_read_only:type_name -> google.protobuf.BoolValue
	21,  // 92: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.enable_parallel_append:type_name -> google.protobuf.BoolValue
	21,  // 93: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.enable_parallel_hash:type_name -> google.protobuf.BoolValue
	21,  // 94: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.enable_partition_pruning:type_name -> google.protobuf.BoolValue
	21,  // 95: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.enable_partitionwise_aggregate:type_name -> google.protobuf.BoolValue
	21,  // 96: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.enable_partitionwise_join:type_name -> google.protobuf.BoolValue
	21,  // 97: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.jit:type_name -> google.protobuf.BoolValue
	19,  // 98: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.max_parallel_maintenance_workers:type_name -> google.protobuf.Int64Value
	21,  // 99: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.parallel_leader_participation:type_name -> google.protobuf.BoolValue
	20,  // 100: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.log_transaction_sample_rate:type_name -> google.protobuf.DoubleValue
	10,  // 101: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.plan_cache_mode:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.PlanCacheMode
	19,  // 102: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.effective_io_concurrency:type_name -> google.protobuf.Int64Value
	19,  // 103: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.effective_cache_size:type_name -> google.protobuf.Int64Value
	11,  // 104: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.shared_preload_libraries:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.SharedPreloadLibraries
	19,  // 105: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.auto_explain_log_min_duration:type_name -> google.protobuf.Int64Value
	21,  // 106: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.auto_explain_log_analyze:type_name -> google.protobuf.BoolValue
	21,  // 107: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.auto_explain_log_buffers:type_name -> google.protobuf.BoolValue
	21,  // 108: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.auto_explain_log_timing:type_name -> google.protobuf.BoolValue
	21,  // 109: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.auto_explain_log_triggers:type_name -> google.protobuf.BoolValue
	21,  // 110: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.auto_explain_log_verbose:type_name -> google.protobuf.BoolValue
	21,  // 111: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.auto_explain_log_nested_statements:type_name -> google.protobuf.BoolValue
	20,  // 112: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.auto_explain_sample_rate:type_name -> google.protobuf.DoubleValue
	21,  // 113: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.pg_hint_plan_enable_hint:type_name -> google.protobuf.BoolValue
	21,  // 114: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.pg_hint_plan_enable_hint_table:type_name -> google.protobuf.BoolValue
	9,   // 115: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.pg_hint_plan_debug_print:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.PgHintPlanDebugPrint
	6,   // 116: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.pg_hint_plan_message_level:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.LogLevel
	20,  // 117: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.hash_mem_multiplier:type_name -> google.protobuf.DoubleValue
	19,  // 118: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.logical_decoding_work_mem:type_name -> google.protobuf.Int64Value
	19,  // 119: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.maintenance_io_concurrency:type_name -> google.protobuf.Int64Value
	19,  // 120: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.max_slot_wal_keep_size:type_name -> google.protobuf.Int64Value
	19,  // 121: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.wal_keep_size:type_name -> google.protobuf.Int64Value
	21,  // 122: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.enable_incremental_sort:type_name -> google.protobuf.BoolValue
	19,  // 123: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.autovacuum_vacuum_insert_threshold:type_name -> google.protobuf.Int64Value
	20,  // 124: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.autovacuum_vacuum_insert_scale_factor:type_name -> google.protobuf.DoubleValue
	19,  // 125: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.log_min_duration_sample:type_name -> google.protobuf.Int64Value
	20,  // 126: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.log_statement_sample_rate:type_name -> google.protobuf.DoubleValue
	19,  // 127: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.log_parameter_max_length:type_name -> google.protobuf.Int64Value
	19,  // 128: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.log_parameter_max_length_on_error:type_name -> google.protobuf.Int64Value
	19,  // 129: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.client_connection_check_interval:type_name -> google.protobuf.Int64Value
	21,  // 130: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.enable_async_append:type_name -> google.protobuf.BoolValue
	21,  // 131: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.enable_gathermerge:type_name -> google.protobuf.BoolValue
	21,  // 132: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.enable_memoize:type_name -> google.protobuf.BoolValue
	21,  // 133: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.log_recovery_conflict_waits:type_name -> google.protobuf.BoolValue
	19,  // 134: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.vacuum_failsafe_age:type_name -> google.protobuf.Int64Value
	19,  // 135: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.vacuum_multixact_failsafe_age:type_name -> google.protobuf.Int64Value
	21,  // 136: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.pg_qualstats_enabled:type_name -> google.protobuf.BoolValue
	21,  // 137: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.pg_qualstats_track_constants:type_name -> google.protobuf.BoolValue
	19,  // 138: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.pg_qualstats_max:type_name -> google.protobuf.Int64Value
	21,  // 139: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.pg_qualstats_resolve_oids:type_name -> google.protobuf.BoolValue
	20,  // 140: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.pg_qualstats_sample_rate:type_name -> google.protobuf.DoubleValue
	19,  // 141: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.max_stack_depth:type_name -> google.protobuf.Int64Value
	21,  // 142: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.enable_group_by_reordering:type_name -> google.protobuf.BoolValue
	21,  // 143: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.geqo:type_name -> google.protobuf.BoolValue
	19,  // 144: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.geqo_threshold:type_name -> google.protobuf.Int64Value
	19,  // 145: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.geqo_effort:type_name -> google.protobuf.Int64Value
	19,  // 146: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.geqo_pool_size:type_name -> google.protobuf.Int64Value
	19,  // 147: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.geqo_generations:type_name -> google.protobuf.Int64Value
	20,  // 148: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.geqo_selection_bias:type_name -> google.protobuf.DoubleValue
	20,  // 149: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.geqo_seed:type_name -> google.protobuf.DoubleValue
	20,  // 150: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.pg_trgm_similarity_threshold:type_name -> google.protobuf.DoubleValue
	20,  // 151: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.pg_trgm_word_similarity_threshold:type_name -> google.protobuf.DoubleValue
	20,  // 152: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.pg_trgm_strict_word_similarity_threshold:type_name -> google.protobuf.DoubleValue
	19,  // 153: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.max_standby_archive_delay:type_name -> google.protobuf.Int64Value
	19,  // 154: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.session_duration_timeout:type_name -> google.protobuf.Int64Value
	21,  // 155: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.log_replication_commands:type_name -> google.protobuf.BoolValue
	19,  // 156: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.log_autovacuum_min_duration:type_name -> google.protobuf.Int64Value
	8,   // 157: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.password_encryption:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.PasswordEncryption
	0,   // 158: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.auto_explain_log_format:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.AutoExplainLogFormat
	19,  // 159: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.idle_session_timeout:type_name -> google.protobuf.Int64Value
	19,  // 160: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.checkpoint_warning:type_name -> google.protobuf.Int64Value
	21,  // 161: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.pg_hint_plan_hints_anywhere:type_name -> google.protobuf.BoolValue
	19,  // 162: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.autovacuum_vacuum_threshold:type_name -> google.protobuf.Int64Value
	19,  // 163: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15.autovacuum_analyze_threshold:type_name -> google.protobuf.Int64Value
	17,  // 164: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfigSet15.effective_config:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15
	17,  // 165: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfigSet15.user_config:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15
	17,  // 166: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfigSet15.default_config:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig15
...
func file_yandex_cloud_mdb_postgresql_v1_config_postgresql15_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_postgresql_v1_config_postgresql15_proto_rawDesc), len(file_yandex_cloud_mdb_postgresql_v1_config_postgresql15_proto_rawDesc)),
			NumEnums:      17,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,

...
func (m *PostgresqlConfig15_1C) SetWalLevel(v PostgresqlConfig15_1C_WalLevel) {
	m.WalLevel = v
}

func (m *PostgresqlConfig15_1C) SetSynchronousCommit(v PostgresqlConfig15_1C_SynchronousCommit) {
...
func (m *PostgresqlConfig15_1C) SetConstraintExclusion(v PostgresqlConfig15_1C_ConstraintExclusion) {
...
func (m *PostgresqlConfig15_1C) SetForceParallelMode(v PostgresqlConfig15_1C_ForceParallelMode) {
...
func (m *PostgresqlConfig15_1C) SetLogErrorVerbosity(v PostgresqlConfig15_1C_LogErrorVerbosity) {
...
func (m *PostgresqlConfig15_1C) SetLogStatement(v PostgresqlConfig15_1C_LogStatement) {
	m.LogStatement = v
}
...
func (m *PostgresqlConfig15_1C) SetByteaOutput(v PostgresqlConfig15_1C_ByteaOutput) {
	m.ByteaOutput = v
}

func (m *PostgresqlConfig15_1C) SetXmlbinary(v PostgresqlConfig15_1C_XmlBinary) {
	m.Xmlbinary = v
}

func (m *PostgresqlConfig15_1C) SetXmloption(v PostgresqlConfig15_1C_XmlOption) {
	m.Xmloption = v
}
...
func (m *PostgresqlConfig15_1C) SetBackslashQuote(v PostgresqlConfig15_1C_BackslashQuote) {
	m.BackslashQuote = v
}
...
func (m *PostgresqlConfig15_1C) SetJit(v *wrapperspb.BoolValue) {
	m.Jit = v
}
...
func (m *PostgresqlConfig15_1C) SetPlanCacheMode(v PostgresqlConfig15_1C_PlanCacheMode) {
	m.PlanCacheMode = v
}
...
func (m *PostgresqlConfig15_1C) SetPgHintPlanDebugPrint(v PostgresqlConfig15_1C_PgHintPlanDebugPrint) {
...
func (m *PostgresqlConfig15_1C) SetAutoExplainLogFormat(v PostgresqlConfig15_1C_AutoExplainLogFormat) {
	m.AutoExplainLogFormat = v
}

func (m *PostgresqlConfig15_1C) SetIdleSessionTimeout(v *wrapperspb.Int64Value) {
	m.IdleSessionTimeout = v
}

func (m *PostgresqlConfig15_1C) SetCheckpointWarning(v *wrapperspb.Int64Value) {
	m.CheckpointWarning = v
}

func (m *PostgresqlConfig15_1C) SetPgHintPlanHintsAnywhere(v *wrapperspb.BoolValue) {

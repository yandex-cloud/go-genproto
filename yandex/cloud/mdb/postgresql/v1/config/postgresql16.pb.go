...
type PostgresqlConfig16_AutoExplainLogFormat int32

const (
	PostgresqlConfig16_AUTO_EXPLAIN_LOG_FORMAT_UNSPECIFIED PostgresqlConfig16_AutoExplainLogFormat = 0
	// 'text' value for the EXPLAIN output format in auto_explain extension
	PostgresqlConfig16_AUTO_EXPLAIN_LOG_FORMAT_TEXT PostgresqlConfig16_AutoExplainLogFormat = 1
	// 'xml' value for the EXPLAIN output format in auto_explain extension
	PostgresqlConfig16_AUTO_EXPLAIN_LOG_FORMAT_XML PostgresqlConfig16_AutoExplainLogFormat = 2
	// 'json' value for the EXPLAIN output format in auto_explain extension
	PostgresqlConfig16_AUTO_EXPLAIN_LOG_FORMAT_JSON PostgresqlConfig16_AutoExplainLogFormat = 3
	// 'yaml' value for the EXPLAIN output format in auto_explain extension
	PostgresqlConfig16_AUTO_EXPLAIN_LOG_FORMAT_YAML PostgresqlConfig16_AutoExplainLogFormat = 4
)

// Enum value maps for PostgresqlConfig16_AutoExplainLogFormat.
var (
	PostgresqlConfig16_AutoExplainLogFormat_name = map[int32]string{
	...
	PostgresqlConfig16_AutoExplainLogFormat_value = map[string]int32{
...
func (x PostgresqlConfig16_AutoExplainLogFormat) Enum() *PostgresqlConfig16_AutoExplainLogFormat {
	p := new(PostgresqlConfig16_AutoExplainLogFormat)
	*p = x
	return p
}

func (x PostgresqlConfig16_AutoExplainLogFormat) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PostgresqlConfig16_AutoExplainLogFormat) Descriptor() protoreflect.EnumDescriptor {
	return file_yandex_cloud_mdb_postgresql_v1_config_postgresql16_proto_enumTypes[0].Descriptor()
}

func (PostgresqlConfig16_AutoExplainLogFormat) Type() protoreflect.EnumType {
	return &file_yandex_cloud_mdb_postgresql_v1_config_postgresql16_proto_enumTypes[0]
}

func (x PostgresqlConfig16_AutoExplainLogFormat) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PostgresqlConfig16_AutoExplainLogFormat.Descriptor instead.
func (PostgresqlConfig16_AutoExplainLogFormat) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	PostgresqlConfig16_SHARED_PRELOAD_LIBRARIES_ANON PostgresqlConfig16_SharedPreloadLibraries = 9
	// Required for the [age](https://age.apache.org/) extension.
	PostgresqlConfig16_SHARED_PRELOAD_LIBRARIES_AGE PostgresqlConfig16_SharedPreloadLibraries = 10
	// Required for the [spqrguard](https://github.com/pg-sharding/spqrguard) extension.
	PostgresqlConfig16_SHARED_PRELOAD_LIBRARIES_SPQRGUARD PostgresqlConfig16_SharedPreloadLibraries = 11
)
...
func (PostgresqlConfig16_XmlOption) Descriptor() protoreflect.EnumDescriptor {
	return file_yandex_cloud_mdb_postgresql_v1_config_postgresql16_proto_enumTypes[16].Descriptor()
}

func (PostgresqlConfig16_XmlOption) Type() protoreflect.EnumType {
	return &file_yandex_cloud_mdb_postgresql_v1_config_postgresql16_proto_enumTypes[16]
}
...
func (PostgresqlConfig16_XmlOption) EnumDescriptor() ([]byte, []int) {
	return file_yandex_cloud_mdb_postgresql_v1_config_postgresql16_proto_rawDescGZIP(), []int{0, 16}
}
...
type PostgresqlConfig16 struct {
	...
	AutoExplainLogFormat                PostgresqlConfig16_AutoExplainLogFormat     `protobuf:"varint,168,opt,name=auto_explain_log_format,json=autoExplainLogFormat,proto3,enum=yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16_AutoExplainLogFormat" json:"auto_explain_log_format,omitempty"` // Selects the `` EXPLAIN `` output format to be used. The allowed values are `` AUTO_EXPLAIN_LOG_FORMAT_TEXT ``, `` AUTO_EXPLAIN_LOG_FORMAT_XML ``, `` AUTO_EXPLAIN_LOG_FORMAT_JSON ``, and `` AUTO_EXPLAIN_LOG_FORMAT_YAML ``. The default is `` AUTO_EXPLAIN_LOG_FORMAT_TEXT ``.
...
func (x *PostgresqlConfig16) GetAutoExplainLogFormat() PostgresqlConfig16_AutoExplainLogFormat {
	if x != nil {
		return x.AutoExplainLogFormat
	}
	return PostgresqlConfig16_AUTO_EXPLAIN_LOG_FORMAT_UNSPECIFIED
}

func (x *PostgresqlConfig16) GetIdleSessionTimeout() *wrapperspb.Int64Value {
	if x != nil {
...
func (x *PostgresqlConfig16) GetCheckpointWarning() *wrapperspb.Int64Value {
	if x != nil {
...
func (x *PostgresqlConfig16) GetPgHintPlanHintsAnywhere() *wrapperspb.BoolValue {
	if x != nil {
		return x.PgHintPlanHintsAnywhere
	}
	return nil
}

func (x *PostgresqlConfig16) GetAutovacuumVacuumThreshold() *wrapperspb.Int64Value {
	if x != nil {
...
func (x *PostgresqlConfig16) GetAutovacuumAnalyzeThreshold() *wrapperspb.Int64Value {
	if x != nil {
...
const file_yandex_cloud_mdb_postgresql_v1_config_postgresql16_proto_rawDesc = "" +
	"\n" +
	"8yandex/cloud/mdb/postgresql/v1/config/postgresql16.proto\x12%yandex.cloud.mdb.postgresql.v1.config\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1dyandex/cloud/validation.proto\"\x96\x8e\x01\n" +
	"\x12PostgresqlConfig16\x12N\n" +
	...
	"\twal_level\x18\x14 \x01(\x0e2B.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.WalLevelR\bwalLevel\x12z\n" +
	"\x12synchronous_commit\x18\x15 \x01(\x0e2K.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.SynchronousCommitR\x11synchronousCommit\x12^\n" +
	...
	"\x14constraint_exclusion\x18\x1d \x01(\x0e2M.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.ConstraintExclusionR\x13constraintExclusion\x12P\n" +
	...
	"\x14debug_parallel_query\x18! \x01(\x0e2L.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.DebugParallelQueryR\x12debugParallelQuery\x12r\n" +
	"\x13client_min_messages\x18\" \x01(\x0e2B.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.LogLevelR\x11clientMinMessages\x12l\n" +
	"\x10log_min_messages\x18# \x01(\x0e2B.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.LogLevelR\x0elogMinMessages\x12y\n" +
	"\x17log_min_error_statement\x18$ \x01(\x0e2B.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.LogLevelR\x14logMinErrorStatement\x12X\n" +
	...
	"\x13log_error_verbosity\x18* \x01(\x0e2K.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.LogErrorVerbosityR\x11logErrorVerbosity\x12@\n" +
	"\x0elog_lock_waits\x18+ \x01(\v2\x1a.google.protobuf.BoolValueR\flogLockWaits\x12k\n" +
	"\rlog_statement\x18, \x01(\x0e2F.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.LogStatementR\flogStatement\x12A\n" +
	...
	"\x1ddefault_transaction_isolation\x180 \x01(\x0e2N.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.TransactionIsolationR\x1bdefaultTransactionIsolation\x12H\n" +
	...
	"\fbytea_output\x184 \x01(\x0e2E.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.ByteaOutputR\vbyteaOutput\x12a\n" +
	"\txmlbinary\x185 \x01(\x0e2C.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.XmlBinaryR\txmlbinary\x12a\n" +
	"\txmloption\x186 \x01(\x0e2C.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.XmlOptionR\txmloption\x12P\n" +
	...
	"arrayNulls\x12q\n" +
	"\x0fbackslash_quote\x18< \x01(\x0e2H.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.BackslashQuoteR\x0ebackslashQuote\x12F\n" +
	...
	"\x0fplan_cache_mode\x18l \x01(\x0e2G.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.PlanCacheModeR\rplanCacheMode\x12a\n" +
	...
	"\x18shared_preload_libraries\x18o \x03(\x0e2P.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.SharedPreloadLibrariesR\x16sharedPreloadLibraries\x12p\n" +
	...
	"\x18pg_hint_plan_debug_print\x18z \x01(\x0e2N.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.PgHintPlanDebugPrintR\x14pgHintPlanDebugPrint\x12~\n" +
	"\x1apg_hint_plan_message_level\x18{ \x01(\x0e2B.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.LogLevelR\x16pgHintPlanMessageLevel\x12\\\n" +
	...
	"\x13password_encryption\x18\xa7\x01 \x01(\x0e2L.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.PasswordEncryptionR\x12passwordEncryption\x12\x86\x01\n" +
	"\x17auto_explain_log_format\x18\xa8\x01 \x01(\x0e2N.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.AutoExplainLogFormatR\x14autoExplainLogFormat\x12`\n" +
	...
	"\x12XML_OPTION_CONTENT\x10\x02J\x04\bN\x10PJ\x04\bj\x10kJ\x04\b}\x10~J\x06\b\x95\x01\x10\x96\x01J\x06\b\xa6\x01\x10\xa7\x01J\x04\b@\x10AJ\x06\b\xa9\x01\x10\xad\x01J\x06\b\xb0\x01\x10\xb1\x01\"\xbb\x02\n" +
	"\x15PostgresqlConfigSet16\x12d\n" +
	"\x10effective_config\x18\x01 \x01(\v29.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16R\x0feffectiveConfig\x12Z\n" +
	"\vuser_config\x18\x02 \x01(\v29.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16R\n" +
	"userConfig\x12`\n" +
	"\x0edefault_config\x18\x03 \x01(\v29.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16R\rdefaultConfigB\x81\x01\n" +
...
var (
	...
	file_yandex_cloud_mdb_postgresql_v1_config_postgresql16_proto_rawDescData []byte
)
...
func file_yandex_cloud_mdb_postgresql_v1_config_postgresql16_proto_rawDescGZIP() []byte {
	file_yandex_cloud_mdb_postgresql_v1_config_postgresql16_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_mdb_postgresql_v1_config_postgresql16_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_postgresql_v1_config_postgresql16_proto_rawDesc), len(file_yandex_cloud_mdb_postgresql_v1_config_postgresql16_proto_rawDesc)))
	})
	return file_yandex_cloud_mdb_postgresql_v1_config_postgresql16_proto_rawDescData
}

var file_yandex_cloud_mdb_postgresql_v1_config_postgresql16_proto_enumTypes = make([]protoimpl.EnumInfo, 17)
var file_yandex_cloud_mdb_postgresql_v1_config_postgresql16_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_yandex_cloud_mdb_postgresql_v1_config_postgresql16_proto_goTypes = []any{
	(PostgresqlConfig16_AutoExplainLogFormat)(0),   // 0: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.AutoExplainLogFormat
	(PostgresqlConfig16_BackslashQuote)(0),         // 1: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.BackslashQuote
	(PostgresqlConfig16_ByteaOutput)(0),            // 2: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.ByteaOutput
	(PostgresqlConfig16_ConstraintExclusion)(0),    // 3: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.ConstraintExclusion
	(PostgresqlConfig16_DebugParallelQuery)(0),     // 4: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.DebugParallelQuery
	(PostgresqlConfig16_LogErrorVerbosity)(0),      // 5: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.LogErrorVerbosity
	(PostgresqlConfig16_LogLevel)(0),               // 6: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.LogLevel
	(PostgresqlConfig16_LogStatement)(0),           // 7: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.LogStatement
	(PostgresqlConfig16_PasswordEncryption)(0),     // 8: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.PasswordEncryption
	(PostgresqlConfig16_PgHintPlanDebugPrint)(0),   // 9: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.PgHintPlanDebugPrint
	(PostgresqlConfig16_PlanCacheMode)(0),          // 10: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.PlanCacheMode
	(PostgresqlConfig16_SharedPreloadLibraries)(0), // 11: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.SharedPreloadLibraries
	(PostgresqlConfig16_SynchronousCommit)(0),      // 12: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.SynchronousCommit
	(PostgresqlConfig16_TransactionIsolation)(0),   // 13: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.TransactionIsolation
	(PostgresqlConfig16_WalLevel)(0),               // 14: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.WalLevel
	(PostgresqlConfig16_XmlBinary)(0),              // 15: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.XmlBinary
	(PostgresqlConfig16_XmlOption)(0),              // 16: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.XmlOption
	(*PostgresqlConfig16)(nil),                     // 17: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16
	(*PostgresqlConfigSet16)(nil),                  // 18: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfigSet16
...
var file_yandex_cloud_mdb_postgresql_v1_config_postgresql16_proto_depIdxs = []int32{
	19,  // 0: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.max_connections:type_name -> google.protobuf.Int64Value
	19,  // 1: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.shared_buffers:type_name -> google.protobuf.Int64Value
	19,  // 2: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.temp_buffers:type_name -> google.protobuf.Int64Value
	19,  // 3: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.max_prepared_transactions:type_name -> google.protobuf.Int64Value
	19,  // 4: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.work_mem:type_name -> google.protobuf.Int64Value
	19,  // 5: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.maintenance_work_mem:type_name -> google.protobuf.Int64Value
	19,  // 6: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.autovacuum_work_mem:type_name -> google.protobuf.Int64Value
	19,  // 7: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.temp_file_limit:type_name -> google.protobuf.Int64Value
	19,  // 8: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.vacuum_cost_delay:type_name -> google.protobuf.Int64Value
	19,  // 9: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.vacuum_cost_page_hit:type_name -> google.protobuf.Int64Value
	19,  // 10: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.vacuum_cost_page_miss:type_name -> google.protobuf.Int64Value
	19,  // 11: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.vacuum_cost_page_dirty:type_name -> google.protobuf.Int64Value
	19,  // 12: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.vacuum_cost_limit:type_name -> google.protobuf.Int64Value
	19,  // 13: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.bgwriter_delay:type_name -> google.protobuf.Int64Value
	19,  // 14: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.bgwriter_lru_maxpages:type_name -> google.protobuf.Int64Value
	20,  // 15: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.bgwriter_lru_multiplier:type_name -> google.protobuf.DoubleValue
	19,  // 16: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.bgwriter_flush_after:type_name -> google.protobuf.Int64Value
	19,  // 17: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.backend_flush_after:type_name -> google.protobuf.Int64Value
	19,  // 18: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.old_snapshot_threshold:type_name -> google.protobuf.Int64Value
	14,  // 19: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.wal_level:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.WalLevel
	12,  // 20: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.synchronous_commit:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.SynchronousCommit
	19,  // 21: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.checkpoint_timeout:type_name -> google.protobuf.Int64Value
	20,  // 22: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.checkpoint_completion_target:type_name -> google.protobuf.DoubleValue
	19,  // 23: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.checkpoint_flush_after:type_name -> google.protobuf.Int64Value
	19,  // 24: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.max_wal_size:type_name -> google.protobuf.Int64Value
	19,  // 25: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.min_wal_size:type_name -> google.protobuf.Int64Value
	19,  // 26: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.max_standby_streaming_delay:type_name -> google.protobuf.Int64Value
	19,  // 27: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.default_statistics_target:type_name -> google.protobuf.Int64Value
	3,   // 28: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.constraint_exclusion:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.ConstraintExclusion
	20,  // 29: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.cursor_tuple_fraction:type_name -> google.protobuf.DoubleValue
	19,  // 30: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.from_collapse_limit:type_name -> google.protobuf.Int64Value
	19,  // 31: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.join_collapse_limit:type_name -> google.protobuf.Int64Value
	4,   // 32: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.debug_parallel_query:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.DebugParallelQuery
	6,   // 33: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.client_min_messages:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.LogLevel
	6,   // 34: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.log_min_messages:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.LogLevel
	6,   // 35: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.log_min_error_statement:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.LogLevel
	19,  // 36: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.log_min_duration_statement:type_name -> google.protobuf.Int64Value
	21,  // 37: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.log_checkpoints:type_name -> google.protobuf.BoolValue
	21,  // 38: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.log_connections:type_name -> google.protobuf.BoolValue
	21,  // 39: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.log_disconnections:type_name -> google.protobuf.BoolValue
	21,  // 40: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.log_duration:type_name -> google.protobuf.BoolValue
	5,   // 41: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.log_error_verbosity:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.LogErrorVerbosity
	21,  // 42: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.log_lock_waits:type_name -> google.protobuf.BoolValue
	7,   // 43: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.log_statement:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.LogStatement
	19,  // 44: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.log_temp_files:type_name -> google.protobuf.Int64Value
	21,  // 45: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.row_security:type_name -> google.protobuf.BoolValue
	13,  // 46: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.default_transaction_isolation:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.TransactionIsolation
	19,  // 47: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.statement_timeout:type_name -> google.protobuf.Int64Value
	19,  // 48: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.lock_timeout:type_name -> google.protobuf.Int64Value
	19,  // 49: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.idle_in_transaction_session_timeout:type_name -> google.protobuf.Int64Value
	2,   // 50: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.bytea_output:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.ByteaOutput
	15,  // 51: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.xmlbinary:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.XmlBinary
	16,  // 52: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.xmloption:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.XmlOption
	19,  // 53: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.gin_pending_list_limit:type_name -> google.protobuf.Int64Value
	19,  // 54: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.deadlock_timeout:type_name -> google.protobuf.Int64Value
	19,  // 55: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.max_locks_per_transaction:type_name -> google.protobuf.Int64Value
	19,  // 56: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.max_pred_locks_per_transaction:type_name -> google.protobuf.Int64Value
	21,  // 57: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.array_nulls:type_name -> google.protobuf.BoolValue
	1,   // 58: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.backslash_quote:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.BackslashQuote
	21,  // 59: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.default_with_oids:type_name -> google.protobuf.BoolValue
	21,  // 60: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.escape_string_warning:type_name -> google.protobuf.BoolValue
	21,  // 61: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.lo_compat_privileges:type_name -> google.protobuf.BoolValue
	21,  // 62: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.quote_all_identifiers:type_name -> google.protobuf.BoolValue
	21,  // 63: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.standard_conforming_strings:type_name -> google.protobuf.BoolValue
	21,  // 64: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.synchronize_seqscans:type_name -> google.protobuf.BoolValue
	21,  // 65: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.transform_null_equals:type_name -> google.protobuf.BoolValue
	21,  // 66: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.exit_on_error:type_name -> google.protobuf.BoolValue
	20,  // 67: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.seq_page_cost:type_name -> google.protobuf.DoubleValue
	20,  // 68: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.random_page_cost:type_name -> google.protobuf.DoubleValue
	19,  // 69: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.autovacuum_max_workers:type_name -> google.protobuf.Int64Value
	19,  // 70: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.autovacuum_vacuum_cost_delay:type_name -> google.protobuf.Int64Value
	19,  // 71: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.autovacuum_vacuum_cost_limit:type_name -> google.protobuf.Int64Value
	19,  // 72: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.autovacuum_naptime:type_name -> google.protobuf.Int64Value
	19,  // 73: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.archive_timeout:type_name -> google.protobuf.Int64Value
	19,  // 74: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.track_activity_query_size:type_name -> google.protobuf.Int64Value
	21,  // 75: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.enable_bitmapscan:type_name -> google.protobuf.BoolValue
	21,  // 76: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.enable_hashagg:type_name -> google.protobuf.BoolValue
	21,  // 77: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.enable_hashjoin:type_name -> google.protobuf.BoolValue
	21,  // 78: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.enable_indexscan:type_name -> google.protobuf.BoolValue
	21,  // 79: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.enable_indexonlyscan:type_name -> google.protobuf.BoolValue
	21,  // 80: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.enable_material:type_name -> google.protobuf.BoolValue
	21,  // 81: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.enable_mergejoin:type_name -> google.protobuf.BoolValue
	21,  // 82: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.enable_nestloop:type_name -> google.protobuf.BoolValue
	21,  // 83: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.enable_seqscan:type_name -> google.protobuf.BoolValue
	21,  // 84: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.enable_sort:type_name -> google.protobuf.BoolValue
	21,  // 85: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.enable_tidscan:type_name -> google.protobuf.BoolValue
	19,  // 86: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.max_worker_processes:type_name -> google.protobuf.Int64Value
	19,  // 87: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.max_parallel_workers:type_name -> google.protobuf.Int64Value
	19,  // 88: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.max_parallel_workers_per_gather:type_name -> google.protobuf.Int64Value
	20,  // 89: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.autovacuum_vacuum_scale_factor:type_name -> google.protobuf.DoubleValue
	20,  // 90: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.autovacuum_analyze_scale_factor:type_name -> google.protobuf.DoubleValue
	21,  // 91: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.default_transaction_read_only:type_name -> google.protobuf.BoolValue
	21,  // 92: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.enable_parallel_append:type_name -> google.protobuf.BoolValue
	21,  // 93: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.enable_parallel_hash:type_name -> google.protobuf.BoolValue
	21,  // 94: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.enable_partition_pruning:type_name -> google.protobuf.BoolValue
	21,  // 95: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.enable_partitionwise_aggregate:type_name -> google.protobuf.BoolValue
	21,  // 96: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.enable_partitionwise_join:type_name -> google.protobuf.BoolValue
	21,  // 97: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.jit:type_name -> google.protobuf.BoolValue
	19,  // 98: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.max_parallel_maintenance_workers:type_name -> google.protobuf.Int64Value
	21,  // 99: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.parallel_leader_participation:type_name -> google.protobuf.BoolValue
	20,  // 100: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.log_transaction_sample_rate:type_name -> google.protobuf.DoubleValue
	10,  // 101: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.plan_cache_mode:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.PlanCacheMode
	19,  // 102: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.effective_io_concurrency:type_name -> google.protobuf.Int64Value
	19,  // 103: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.effective_cache_size:type_name -> google.protobuf.Int64Value
	11,  // 104: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.shared_preload_libraries:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.SharedPreloadLibraries
	19,  // 105: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.auto_explain_log_min_duration:type_name -> google.protobuf.Int64Value
	21,  // 106: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.auto_explain_log_analyze:type_name -> google.protobuf.BoolValue
	21,  // 107: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.auto_explain_log_buffers:type_name -> google.protobuf.BoolValue
	21,  // 108: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.auto_explain_log_timing:type_name -> google.protobuf.BoolValue
	21,  // 109: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.auto_explain_log_triggers:type_name -> google.protobuf.BoolValue
	21,  // 110: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.auto_explain_log_verbose:type_name -> google.protobuf.BoolValue
	21,  // 111: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.auto_explain_log_nested_statements:type_name -> google.protobuf.BoolValue
	20,  // 112: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.auto_explain_sample_rate:type_name -> google.protobuf.DoubleValue
	21,  // 113: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.pg_hint_plan_enable_hint:type_name -> google.protobuf.BoolValue
	21,  // 114: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.pg_hint_plan_enable_hint_table:type_name -> google.protobuf.BoolValue
	9,   // 115: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.pg_hint_plan_debug_print:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.PgHintPlanDebugPrint
	6,   // 116: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.pg_hint_plan_message_level:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.LogLevel
	20,  // 117: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.hash_mem_multiplier:type_name -> google.protobuf.DoubleValue
	19,  // 118: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.logical_decoding_work_mem:type_name -> google.protobuf.Int64Value
	19,  // 119: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.maintenance_io_concurrency:type_name -> google.protobuf.Int64Value
	19,  // 120: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.max_slot_wal_keep_size:type_name -> google.protobuf.Int64Value
	19,  // 121: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.wal_keep_size:type_name -> google.protobuf.Int64Value
	21,  // 122: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.enable_incremental_sort:type_name -> google.protobuf.BoolValue
	19,  // 123: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.autovacuum_vacuum_insert_threshold:type_name -> google.protobuf.Int64Value
	20,  // 124: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.autovacuum_vacuum_insert_scale_factor:type_name -> google.protobuf.DoubleValue
	19,  // 125: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.log_min_duration_sample:type_name -> google.protobuf.Int64Value
	20,  // 126: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.log_statement_sample_rate:type_name -> google.protobuf.DoubleValue
	19,  // 127: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.log_parameter_max_length:type_name -> google.protobuf.Int64Value
	19,  // 128: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.log_parameter_max_length_on_error:type_name -> google.protobuf.Int64Value
	19,  // 129: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.client_connection_check_interval:type_name -> google.protobuf.Int64Value
	21,  // 130: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.enable_async_append:type_name -> google.protobuf.BoolValue
	21,  // 131: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.enable_gathermerge:type_name -> google.protobuf.BoolValue
	21,  // 132: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.enable_memoize:type_name -> google.protobuf.BoolValue
	21,  // 133: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.log_recovery_conflict_waits:type_name -> google.protobuf.BoolValue
	19,  // 134: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.vacuum_failsafe_age:type_name -> google.protobuf.Int64Value
	19,  // 135: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.vacuum_multixact_failsafe_age:type_name -> google.protobuf.Int64Value
	21,  // 136: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.pg_qualstats_enabled:type_name -> google.protobuf.BoolValue
	21,  // 137: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.pg_qualstats_track_constants:type_name -> google.protobuf.BoolValue
	19,  // 138: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.pg_qualstats_max:type_name -> google.protobuf.Int64Value
	21,  // 139: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.pg_qualstats_resolve_oids:type_name -> google.protobuf.BoolValue
	20,  // 140: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.pg_qualstats_sample_rate:type_name -> google.protobuf.DoubleValue
	19,  // 141: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.max_stack_depth:type_name -> google.protobuf.Int64Value
	21,  // 142: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.enable_group_by_reordering:type_name -> google.protobuf.BoolValue
	21,  // 143: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.geqo:type_name -> google.protobuf.BoolValue
	19,  // 144: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.geqo_threshold:type_name -> google.protobuf.Int64Value
	19,  // 145: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.geqo_effort:type_name -> google.protobuf.Int64Value
	19,  // 146: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.geqo_pool_size:type_name -> google.protobuf.Int64Value
	19,  // 147: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.geqo_generations:type_name -> google.protobuf.Int64Value
	20,  // 148: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.geqo_selection_bias:type_name -> google.protobuf.DoubleValue
	20,  // 149: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.geqo_seed:type_name -> google.protobuf.DoubleValue
	20,  // 150: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.pg_trgm_similarity_threshold:type_name -> google.protobuf.DoubleValue
	20,  // 151: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.pg_trgm_word_similarity_threshold:type_name -> google.protobuf.DoubleValue
	20,  // 152: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.pg_trgm_strict_word_similarity_threshold:type_name -> google.protobuf.DoubleValue
	19,  // 153: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.max_standby_archive_delay:type_name -> google.protobuf.Int64Value
	19,  // 154: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.session_duration_timeout:type_name -> google.protobuf.Int64Value
	21,  // 155: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.log_replication_commands:type_name -> google.protobuf.BoolValue
	19,  // 156: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.log_autovacuum_min_duration:type_name -> google.protobuf.Int64Value
	8,   // 157: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.password_encryption:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.PasswordEncryption
	0,   // 158: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.auto_explain_log_format:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.AutoExplainLogFormat
	19,  // 159: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.idle_session_timeout:type_name -> google.protobuf.Int64Value
	19,  // 160: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.checkpoint_warning:type_name -> google.protobuf.Int64Value
	21,  // 161: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.pg_hint_plan_hints_anywhere:type_name -> google.protobuf.BoolValue
	19,  // 162: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.autovacuum_vacuum_threshold:type_name -> google.protobuf.Int64Value
	19,  // 163: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.autovacuum_analyze_threshold:type_name -> google.protobuf.Int64Value
	17,  // 164: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfigSet16.effective_config:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16
	17,  // 165: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfigSet16.user_config:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16
	17,  // 166: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfigSet16.default_config:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16
...
func file_yandex_cloud_mdb_postgresql_v1_config_postgresql16_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_postgresql_v1_config_postgresql16_proto_rawDesc), len(file_yandex_cloud_mdb_postgresql_v1_config_postgresql16_proto_rawDesc)),
			NumEnums:      17,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,

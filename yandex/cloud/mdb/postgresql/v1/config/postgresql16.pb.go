...
const file_yandex_cloud_mdb_postgresql_v1_config_postgresql16_proto_rawDesc = "" +
	"\n" +
	"8yandex/cloud/mdb/postgresql/v1/config/postgresql16.proto\x12%yandex.cloud.mdb.postgresql.v1.config\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1dyandex/cloud/validation.proto\"\xbb\x89\x01\n" +
	...
	"\x17auto_explain_log_format\x18\xa8\x01 \x01(\x0e2N.yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16.AutoExplainLogFormatR\x14autoExplainLogFormat\"\xc6\x01\n" +
	...
	"\x12XML_OPTION_CONTENT\x10\x02J\x04\bN\x10PJ\x04\bj\x10kJ\x04\b}\x10~J\x06\b\x95\x01\x10\x96\x01J\x06\b\xa6\x01\x10\xa7\x01J\x04\b@\x10A\"\xbb\x02\n" +
...
var file_yandex_cloud_mdb_postgresql_v1_config_postgresql16_proto_depIdxs = []int32{
	...
	17,  // 159: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfigSet16.effective_config:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16
	17,  // 160: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfigSet16.user_config:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16
	17,  // 161: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfigSet16.default_config:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16

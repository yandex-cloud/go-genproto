...
const file_yandex_cloud_mdb_postgresql_v1_config_postgresql16_proto_rawDesc = "" +
	"\n" +
	"8yandex/cloud/mdb/postgresql/v1/config/postgresql16.proto\x12%yandex.cloud.mdb.postgresql.v1.config\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1dyandex/cloud/validation.proto\"\xef\x8a\x01\n" +
...
var file_yandex_cloud_mdb_postgresql_v1_config_postgresql16_proto_depIdxs = []int32{
	...
	17,  // 160: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfigSet16.effective_config:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16
	17,  // 161: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfigSet16.user_config:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16
	17,  // 162: yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfigSet16.default_config:type_name -> yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig16

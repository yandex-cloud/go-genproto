...
const file_yandex_cloud_mdb_postgresql_v1_config_postgresql16_1c_proto_rawDesc = "" +
	"\n" +
	";yandex/cloud/mdb/postgresql/v1/config/postgresql16_1c.proto\x12%yandex.cloud.mdb.postgresql.v1.config\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1dyandex/cloud/validation.proto\"\x93\x8b\x01\n" +
	"\x15PostgresqlConfig16_1C\x12D\n" +

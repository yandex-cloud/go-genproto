...
var file_yandex_cloud_mdb_postgresql_v1_database_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x74, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x73,
...
func file_yandex_cloud_mdb_postgresql_v1_database_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yandex_cloud_mdb_postgresql_v1_database_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_mdb_postgresql_v1_database_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_mdb_postgresql_v1_database_proto_msgTypes[2].Exporter = func(v any, i int) any {

...
func (x *RedisConfig6_2) GetTimeout() *wrappers.Int64Value {
	if x != nil {
		return x.Timeout
	}
	return nil
...
func (x *RedisConfig6_2) GetDatabases() *wrappers.Int64Value {
	if x != nil {
		return x.Databases
	}
	return nil
...
func (x *RedisConfig6_2) GetSlowlogLogSlowerThan() *wrappers.Int64Value {
	if x != nil {
...
func (x *RedisConfig6_2) GetSlowlogMaxLen() *wrappers.Int64Value {
	if x != nil {
...
var file_yandex_cloud_mdb_redis_v1_config_redis6_2_proto_rawDesc = []byte{
	...
	0x66, 0x69, 0x67, 0x53, 0x65, 0x74, 0x36, 0x5f, 0x32, 0x12, 0x5b, 0x0a, 0x10, 0x65, 0x66, 0x66,
	...
	0x69, 0x67, 0x36, 0x5f, 0x32, 0x52, 0x0f, 0x65, 0x66, 0x66, 0x65, 0x63, 0x74, 0x69, 0x76, 0x65,
	...
	0x65, 0x64, 0x69, 0x73, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x36, 0x5f, 0x32, 0x52, 0x0a, 0x75,
	...
	0x36, 0x5f, 0x32, 0x52, 0x0d, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x43, 0x6f, 0x6e, 0x66,
...
var file_yandex_cloud_mdb_redis_v1_config_redis6_2_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_yandex_cloud_mdb_redis_v1_config_redis6_2_proto_depIdxs = []int32{
	...
	3, // 1: yandex.cloud.mdb.redis.v1.config.RedisConfig6_2.timeout:type_name -> google.protobuf.Int64Value
	3, // 2: yandex.cloud.mdb.redis.v1.config.RedisConfig6_2.databases:type_name -> google.protobuf.Int64Value
	3, // 3: yandex.cloud.mdb.redis.v1.config.RedisConfig6_2.slowlog_log_slower_than:type_name -> google.protobuf.Int64Value
	3, // 4: yandex.cloud.mdb.redis.v1.config.RedisConfig6_2.slowlog_max_len:type_name -> google.protobuf.Int64Value
	1, // 5: yandex.cloud.mdb.redis.v1.config.RedisConfigSet6_2.effective_config:type_name -> yandex.cloud.mdb.redis.v1.config.RedisConfig6_2
	1, // 6: yandex.cloud.mdb.redis.v1.config.RedisConfigSet6_2.user_config:type_name -> yandex.cloud.mdb.redis.v1.config.RedisConfig6_2
	1, // 7: yandex.cloud.mdb.redis.v1.config.RedisConfigSet6_2.default_config:type_name -> yandex.cloud.mdb.redis.v1.config.RedisConfig6_2

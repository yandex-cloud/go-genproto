...
const file_yandex_cloud_mdb_redis_v1_config_redis7_0_proto_rawDesc = "" +
	"\n" +
	"/yandex/cloud/mdb/redis/v1/config/redis7_0.proto\x12 yandex.cloud.mdb.redis.v1.config\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1dyandex/cloud/validation.proto\"\x89\v\n" +
	"\x0eRedisConfig7_0\x12k\n" +
	"\x10maxmemory_policy\x18\x01 \x01(\x0e2@.yandex.cloud.mdb.redis.v1.config.RedisConfig7_0.MaxmemoryPolicyR\x0fmaxmemoryPolicy\x12>\n" +
	...
	"!client_output_buffer_limit_pubsub\x18\b \x01(\v2H.yandex.cloud.mdb.redis.v1.config.RedisConfig7_0.ClientOutputBufferLimitR\x1dclientOutputBufferLimitPubsub\x12\x92\x01\n" +
	"!client_output_buffer_limit_normal\x18\t \x01(\v2H.yandex.cloud.mdb.redis.v1.config.RedisConfig7_0.ClientOutputBufferLimitR\x1dclientOutputBufferLimitNormal\x12R\n" +
	...
	"\x11RedisConfigSet7_0\x12[\n" +
	"\x10effective_config\x18\x01 \x01(\v20.yandex.cloud.mdb.redis.v1.config.RedisConfig7_0R\x0feffectiveConfig\x12Q\n" +
	"\vuser_config\x18\x02 \x01(\v20.yandex.cloud.mdb.redis.v1.config.RedisConfig7_0R\n" +
	"userConfig\x12W\n" +
	"\x0edefault_config\x18\x03 \x01(\v20.yandex.cloud.mdb.redis.v1.config.RedisConfig7_0R\rdefaultConfigBr\n" +
...
var (
	...
	file_yandex_cloud_mdb_redis_v1_config_redis7_0_proto_rawDescData []byte
)
...
func file_yandex_cloud_mdb_redis_v1_config_redis7_0_proto_rawDescGZIP() []byte {
	file_yandex_cloud_mdb_redis_v1_config_redis7_0_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_mdb_redis_v1_config_redis7_0_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_redis_v1_config_redis7_0_proto_rawDesc), len(file_yandex_cloud_mdb_redis_v1_config_redis7_0_proto_rawDesc)))
	})
...
var file_yandex_cloud_mdb_redis_v1_config_redis7_0_proto_goTypes = []any{
...
func file_yandex_cloud_mdb_redis_v1_config_redis7_0_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_redis_v1_config_redis7_0_proto_rawDesc), len(file_yandex_cloud_mdb_redis_v1_config_redis7_0_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,

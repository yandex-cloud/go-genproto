...
const file_yandex_cloud_mdb_redis_v1_config_redis7_0_proto_rawDesc = "" +
	"\n" +
	"/yandex/cloud/mdb/redis/v1/config/redis7_0.proto\x12 yandex.cloud.mdb.redis.v1.config\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1dyandex/cloud/validation.proto\"\xf7\n" +
	"\n" +
	"\x0eRedisConfig7_0\x12k\n" +
	"\x10maxmemory_policy\x18\x01 \x01(\x0e2@.yandex.cloud.mdb.redis.v1.config.RedisConfig7_0.MaxmemoryPolicyR\x0fmaxmemoryPolicy\x125\n" +

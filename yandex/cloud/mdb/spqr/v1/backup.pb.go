...
var (
	...
	file_yandex_cloud_mdb_spqr_v1_backup_proto_rawDescData []byte
)
...
func file_yandex_cloud_mdb_spqr_v1_backup_proto_rawDescGZIP() []byte {
	file_yandex_cloud_mdb_spqr_v1_backup_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_mdb_spqr_v1_backup_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_spqr_v1_backup_proto_rawDesc), len(file_yandex_cloud_mdb_spqr_v1_backup_proto_rawDesc)))
	})

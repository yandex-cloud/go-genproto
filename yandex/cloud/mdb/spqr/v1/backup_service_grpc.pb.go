...
const (
	BackupService_Get_FullMethodName    = "/yandex.cloud.mdb.spqr.v1.BackupService/Get"
	BackupService_List_FullMethodName   = "/yandex.cloud.mdb.spqr.v1.BackupService/List"
	BackupService_Delete_FullMethodName = "/yandex.cloud.mdb.spqr.v1.BackupService/Delete"
)
...
var BackupService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "yandex.cloud.mdb.spqr.v1.BackupService",
	...
	Metadata: "yandex/cloud/mdb/spqr/v1/backup_service.proto",
}

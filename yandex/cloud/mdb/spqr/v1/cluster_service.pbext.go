...
func (m *BackupListFilter) SetStartTime(v *timestamppb.Timestamp) {
	m.StartTime = v
}

func (m *BackupListFilter) SetEndTime(v *timestamppb.Timestamp) {
	m.EndTime = v
}

func (m *BackupListFilter) SetRetentionPolicyId(v string) {
...
func (m *SpqrSpec) SetRouter(v *SpqrSpec_Router) {
	m.Router = v
}

func (m *SpqrSpec) SetCoordinator(v *SpqrSpec_Coordinator) {
	m.Coordinator = v
}

func (m *SpqrSpec) SetPostgresql(v *SpqrSpec_PostgreSQL) {
	m.Postgresql = v
}

func (m *SpqrSpec) SetInfra(v *SpqrSpec_Infra) {
	m.Infra = v
}

func (m *SpqrSpec) SetConsolePassword(v string) {
	m.ConsolePassword = v
}

func (m *SpqrSpec) SetLogLevel(v LogLevel) {
	m.LogLevel = v
}

func (m *SpqrSpec) SetBalancer(v *BalancerSettings) {
	m.Balancer = v
}
...
func (m *SpqrSpec_Router) SetResources(v *Resources) {
	m.Resources = v
}

func (m *SpqrSpec_Coordinator) SetConfig(v *CoordinatorSettings) {
	m.Config = v
}

func (m *SpqrSpec_Coordinator) SetResources(v *Resources) {
	m.Resources = v
}

func (m *SpqrSpec_PostgreSQL) SetConfig(v *PostgreSQLSettings) {
	m.Config = v
}

func (m *SpqrSpec_PostgreSQL) SetResources(v *Resources) {
	m.Resources = v
}

func (m *SpqrSpec_Infra) SetResources(v *Resources) {
	m.Resources = v
}

func (m *SpqrSpec_Infra) SetRouter(v *RouterSettings) {
	m.Router = v
}

func (m *SpqrSpec_Infra) SetCoordinator(v *CoordinatorSettings) {
	m.Coordinator = v
}

func (m *ConfigSpec) SetSpqrSpec(v *SpqrSpec) {
	m.SpqrSpec = v
}
...
func (m *ConfigSpec) SetSoxAudit(v *wrapperspb.BoolValue) {
	m.SoxAudit = v
}
...
func (m *AddSubclusterRequest) SetClusterId(v string) {
	m.ClusterId = v
}

func (m *AddSubclusterRequest) SetHostSpecs(v []*HostSpec) {
	m.HostSpecs = v
}

func (m *AddSubclusterRequest) SetResources(v *Resources) {
	m.Resources = v
}

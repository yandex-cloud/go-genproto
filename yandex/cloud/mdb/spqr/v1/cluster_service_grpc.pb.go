...
const (
	...
	ClusterService_Delete_FullMethodName                = "/yandex.cloud.mdb.spqr.v1.ClusterService/Delete"
	ClusterService_AddSubcluster_FullMethodName         = "/yandex.cloud.mdb.spqr.v1.ClusterService/AddSubcluster"
	ClusterService_Start_FullMethodName                 = "/yandex.cloud.mdb.spqr.v1.ClusterService/Start"
	ClusterService_Stop_FullMethodName                  = "/yandex.cloud.mdb.spqr.v1.ClusterService/Stop"
	ClusterService_Move_FullMethodName                  = "/yandex.cloud.mdb.spqr.v1.ClusterService/Move"
	ClusterService_Backup_FullMethodName                = "/yandex.cloud.mdb.spqr.v1.ClusterService/Backup"
	ClusterService_Restore_FullMethodName               = "/yandex.cloud.mdb.spqr.v1.ClusterService/Restore"
	ClusterService_RescheduleMaintenance_FullMethodName = "/yandex.cloud.mdb.spqr.v1.ClusterService/RescheduleMaintenance"
	ClusterService_ListLogs_FullMethodName              = "/yandex.cloud.mdb.spqr.v1.ClusterService/ListLogs"
	ClusterService_StreamLogs_FullMethodName            = "/yandex.cloud.mdb.spqr.v1.ClusterService/StreamLogs"
	...
	ClusterService_ListAccessBindings_FullMethodName    = "/yandex.cloud.mdb.spqr.v1.ClusterService/ListAccessBindings"
	ClusterService_SetAccessBindings_FullMethodName     = "/yandex.cloud.mdb.spqr.v1.ClusterService/SetAccessBindings"
	ClusterService_UpdateAccessBindings_FullMethodName  = "/yandex.cloud.mdb.spqr.v1.ClusterService/UpdateAccessBindings"
)
...
type ClusterServiceClient interface {
	...
	AddSubcluster(ctx context.Context, in *AddSubclusterRequest, opts ...grpc.CallOption) (*operation.Operation, error)
...
func (c *clusterServiceClient) AddSubcluster(ctx context.Context, in *AddSubclusterRequest, opts ...grpc.CallOption) (*operation.Operation, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(operation.Operation)
	err := c.cc.Invoke(ctx, ClusterService_AddSubcluster_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clusterServiceClient) ResetupHosts(ctx context.Context, in *ResetupHostsRequest, opts ...grpc.CallOption) (*operation.Operation, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(operation.Operation)
	err := c.cc.Invoke(ctx, ClusterService_ResetupHosts_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ClusterServiceServer interface {
	...
	AddSubcluster(context.Context, *AddSubclusterRequest) (*operation.Operation, error)
	// Start the specified SPQR cluster.
...
func (UnimplementedClusterServiceServer) AddSubcluster(context.Context, *AddSubclusterRequest) (*operation.Operation, error) {
	return nil, status.Error(codes.Unimplemented, "method AddSubcluster not implemented")
}
...
func (UnimplementedClusterServiceServer) ResetupHosts(context.Context, *ResetupHostsRequest) (*operation.Operation, error) {
	return nil, status.Error(codes.Unimplemented, "method ResetupHosts not implemented")
}
...
func _ClusterService_AddSubcluster_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddSubclusterRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClusterServiceServer).AddSubcluster(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ClusterService_AddSubcluster_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClusterServiceServer).AddSubcluster(ctx, req.(*AddSubclusterRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ClusterService_ResetupHosts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ClusterService_ResetupHosts_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var ClusterService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "yandex.cloud.mdb.spqr.v1.ClusterService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AddSubcluster",
			Handler:    _ClusterService_AddSubcluster_Handler,
		},
		{
			MethodName: "Start",
	...
	Metadata: "yandex/cloud/mdb/spqr/v1/cluster_service.proto",
}

...
const (
	BackupService_Get_FullMethodName  = "/yandex.cloud.mdb.sqlserver.v1.BackupService/Get"
	BackupService_List_FullMethodName = "/yandex.cloud.mdb.sqlserver.v1.BackupService/List"
)

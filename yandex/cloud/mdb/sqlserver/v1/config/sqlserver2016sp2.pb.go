...
const file_yandex_cloud_mdb_sqlserver_v1_config_sqlserver2016sp2_proto_rawDesc = "" +
	"\n" +
	";yandex/cloud/mdb/sqlserver/v1/config/sqlserver2016sp2.proto\x12$yandex.cloud.mdb.sqlserver.v1.config\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1dyandex/cloud/validation.proto\"\xe9\x03\n" +
	"\x19SQLServerConfig2016sp2std\x12`\n" +
	...
	"\x1doptimize_for_ad_hoc_workloads\x18\x05 \x01(\v2\x1a.google.protobuf.BoolValueR\x19optimizeForAdHocWorkloads\"\xd4\x02\n" +
	"\x1cSQLServerConfigSet2016sp2std\x12j\n" +
	"\x10effective_config\x18\x01 \x01(\v2?.yandex.cloud.mdb.sqlserver.v1.config.SQLServerConfig2016sp2stdR\x0feffectiveConfig\x12`\n" +
	"\vuser_config\x18\x02 \x01(\v2?.yandex.cloud.mdb.sqlserver.v1.config.SQLServerConfig2016sp2stdR\n" +
	"userConfig\x12f\n" +
	"\x0edefault_config\x18\x03 \x01(\v2?.yandex.cloud.mdb.sqlserver.v1.config.SQLServerConfig2016sp2stdR\rdefaultConfig\"\xe9\x03\n" +
	"\x19SQLServerConfig2016sp2ent\x12`\n" +
	"\x19max_degree_of_parallelism\x18\x01 \x01(\v2\x1b.google.protobuf.Int64ValueB\b\xfa\xc71\x041-99R\x16maxDegreeOfParallelism\x12m\n" +
	"\x1ecost_threshold_for_parallelism\x18\x02 \x01(\v2\x1b.google.protobuf.Int64ValueB\v\xfa\xc71\a5-32767R\x1bcostThresholdForParallelism\x12E\n" +
	"\vaudit_level\x18\x03 \x01(\v2\x1b.google.protobuf.Int64ValueB\a\xfa\xc71\x030-3R\n" +
	"auditLevel\x12V\n" +
	"\x13fill_factor_percent\x18\x04 \x01(\v2\x1b.google.protobuf.Int64ValueB\t\xfa\xc71\x050-100R\x11fillFactorPercent\x12\\\n" +
	"\x1doptimize_for_ad_hoc_workloads\x18\x05 \x01(\v2\x1a.google.protobuf.BoolValueR\x19optimizeForAdHocWorkloads\"\xd4\x02\n" +
	"\x1cSQLServerConfigSet2016sp2ent\x12j\n" +
	"\x10effective_config\x18\x01 \x01(\v2?.yandex.cloud.mdb.sqlserver.v1.config.SQLServerConfig2016sp2entR\x0feffectiveConfig\x12`\n" +
	"\vuser_config\x18\x02 \x01(\v2?.yandex.cloud.mdb.sqlserver.v1.config.SQLServerConfig2016sp2entR\n" +
	"userConfig\x12f\n" +
	"\x0edefault_config\x18\x03 \x01(\v2?.yandex.cloud.mdb.sqlserver.v1.config.SQLServerConfig2016sp2entR\rdefaultConfigB~\n" +
...
var (
	...
	file_yandex_cloud_mdb_sqlserver_v1_config_sqlserver2016sp2_proto_rawDescData []byte
)
...
func file_yandex_cloud_mdb_sqlserver_v1_config_sqlserver2016sp2_proto_rawDescGZIP() []byte {
	file_yandex_cloud_mdb_sqlserver_v1_config_sqlserver2016sp2_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_mdb_sqlserver_v1_config_sqlserver2016sp2_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_sqlserver_v1_config_sqlserver2016sp2_proto_rawDesc), len(file_yandex_cloud_mdb_sqlserver_v1_config_sqlserver2016sp2_proto_rawDesc)))
	})
...
var file_yandex_cloud_mdb_sqlserver_v1_config_sqlserver2016sp2_proto_goTypes = []any{
...
func file_yandex_cloud_mdb_sqlserver_v1_config_sqlserver2016sp2_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_sqlserver_v1_config_sqlserver2016sp2_proto_rawDesc), len(file_yandex_cloud_mdb_sqlserver_v1_config_sqlserver2016sp2_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,

...
const (
	DatabaseService_Get_FullMethodName          = "/yandex.cloud.mdb.sqlserver.v1.DatabaseService/Get"
	DatabaseService_List_FullMethodName         = "/yandex.cloud.mdb.sqlserver.v1.DatabaseService/List"
	DatabaseService_Create_FullMethodName       = "/yandex.cloud.mdb.sqlserver.v1.DatabaseService/Create"
	DatabaseService_Restore_FullMethodName      = "/yandex.cloud.mdb.sqlserver.v1.DatabaseService/Restore"
	DatabaseService_ImportBackup_FullMethodName = "/yandex.cloud.mdb.sqlserver.v1.DatabaseService/ImportBackup"
	DatabaseService_ExportBackup_FullMethodName = "/yandex.cloud.mdb.sqlserver.v1.DatabaseService/ExportBackup"
	DatabaseService_Delete_FullMethodName       = "/yandex.cloud.mdb.sqlserver.v1.DatabaseService/Delete"
)
...
func (c *databaseServiceClient) ImportBackup(ctx context.Context, in *ImportDatabaseBackupRequest, opts ...grpc.CallOption) (*operation.Operation, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(operation.Operation)
	err := c.cc.Invoke(ctx, DatabaseService_ImportBackup_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *databaseServiceClient) ExportBackup(ctx context.Context, in *ExportDatabaseBackupRequest, opts ...grpc.CallOption) (*operation.Operation, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(operation.Operation)
	err := c.cc.Invoke(ctx, DatabaseService_ExportBackup_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DatabaseService_ImportBackup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DatabaseService_ImportBackup_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DatabaseService_ExportBackup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DatabaseService_ExportBackup_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {

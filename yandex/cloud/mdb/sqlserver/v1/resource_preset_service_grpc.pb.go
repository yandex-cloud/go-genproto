...
const (
	ResourcePresetService_Get_FullMethodName  = "/yandex.cloud.mdb.sqlserver.v1.ResourcePresetService/Get"
	ResourcePresetService_List_FullMethodName = "/yandex.cloud.mdb.sqlserver.v1.ResourcePresetService/List"
)

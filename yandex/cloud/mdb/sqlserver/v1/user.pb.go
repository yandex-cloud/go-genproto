...
var file_yandex_cloud_mdb_sqlserver_v1_user_proto_rawDesc = []byte{
	...
	0x5a, 0x30, 0x2d, 0x39, 0x5f, 0x5d, 0x2a, 0x8a, 0xc8, 0x31, 0x04, 0x3c, 0x3d, 0x33, 0x32, 0x52,
...
func file_yandex_cloud_mdb_sqlserver_v1_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yandex_cloud_mdb_sqlserver_v1_user_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
		...
		file_yandex_cloud_mdb_sqlserver_v1_user_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_yandex_cloud_mdb_sqlserver_v1_user_proto_msgTypes[2].Exporter = func(v any, i int) any {

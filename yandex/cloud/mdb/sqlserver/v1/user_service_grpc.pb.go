...
const (
	UserService_Get_FullMethodName              = "/yandex.cloud.mdb.sqlserver.v1.UserService/Get"
	UserService_List_FullMethodName             = "/yandex.cloud.mdb.sqlserver.v1.UserService/List"
	UserService_Create_FullMethodName           = "/yandex.cloud.mdb.sqlserver.v1.UserService/Create"
	UserService_Update_FullMethodName           = "/yandex.cloud.mdb.sqlserver.v1.UserService/Update"
	UserService_Delete_FullMethodName           = "/yandex.cloud.mdb.sqlserver.v1.UserService/Delete"
	UserService_GrantPermission_FullMethodName  = "/yandex.cloud.mdb.sqlserver.v1.UserService/GrantPermission"
	UserService_RevokePermission_FullMethodName = "/yandex.cloud.mdb.sqlserver.v1.UserService/RevokePermission"
)

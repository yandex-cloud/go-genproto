...
func (x *CronTab) Reset() {
	*x = CronTab{}
	mi := &file_yandex_cloud_mdb_v1_backup_retention_policy_proto_msgTypes[0]
...
func (x *BackupRetentionPolicy) Reset() {
	*x = BackupRetentionPolicy{}
	mi := &file_yandex_cloud_mdb_v1_backup_retention_policy_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BackupRetentionPolicy) Descriptor() ([]byte, []int) {
	return file_yandex_cloud_mdb_v1_backup_retention_policy_proto_rawDescGZIP(), []int{1}
}
...
func (x *BackupRetentionPolicySpec) Reset() {
	*x = BackupRetentionPolicySpec{}
	mi := &file_yandex_cloud_mdb_v1_backup_retention_policy_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BackupRetentionPolicySpec) Descriptor() ([]byte, []int) {
	return file_yandex_cloud_mdb_v1_backup_retention_policy_proto_rawDescGZIP(), []int{2}
}
...
const file_yandex_cloud_mdb_v1_backup_retention_policy_proto_rawDesc = "" +
	...
	"\x04cron\x18\x05 \x01(\v2\x1c.yandex.cloud.mdb.v1.CronTabR\x04cron\x12&\n" +
	"\x0fretain_for_days\x18\x06 \x01(\x03R\rretainForDays\x12 \n" +
	"\vdescription\x18\a \x01(\tR\vdescription\"\xbe\x01\n" +
...
var (
	file_yandex_cloud_mdb_v1_backup_retention_policy_proto_rawDescOnce sync.Once
	file_yandex_cloud_mdb_v1_backup_retention_policy_proto_rawDescData []byte
)

func file_yandex_cloud_mdb_v1_backup_retention_policy_proto_rawDescGZIP() []byte {
	file_yandex_cloud_mdb_v1_backup_retention_policy_proto_rawDescOnce.Do(func() {
		file_yandex_cloud_mdb_v1_backup_retention_policy_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_yandex_cloud_mdb_v1_backup_retention_policy_proto_rawDesc), len(file_yandex_cloud_mdb_v1_backup_retention_policy_proto_rawDesc)))
	})
...
func init() { file_yandex_cloud_mdb_v1_backup_retention_policy_proto_init() }
func file_yandex_cloud_mdb_v1_backup_retention_policy_proto_init() {
	if File_yandex_cloud_mdb_v1_backup_retention_policy_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_yandex_cloud_mdb_v1_backup_retention_policy_proto_goTypes,
		DependencyIndexes: file_yandex_cloud_mdb_v1_backup_retention_policy_proto_depIdxs,
		MessageInfos:      file_yandex_cloud_mdb_v1_backup_retention_policy_proto_msgTypes,
	}.Build()
	File_yandex_cloud_mdb_v1_backup_retention_policy_proto = out.File
	file_yandex_cloud_mdb_v1_backup_retention_policy_proto_goTypes = nil
	file_yandex_cloud_mdb_v1_backup_retention_policy_proto_depIdxs = nil
}

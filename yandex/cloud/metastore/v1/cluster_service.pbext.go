...
func (m *CreateClusterRequest) SetVersion(v string) {
	m.Version = v
}
...
func (m *ImportDataRequest) SetClusterId(v string) {
	m.ClusterId = v
}

func (m *ImportDataRequest) SetBucket(v string) {
	m.Bucket = v
}

func (m *ImportDataRequest) SetFilepath(v string) {
	m.Filepath = v
}

func (m *ImportDataMetadata) SetClusterId(v string) {
	m.ClusterId = v
}

func (m *ExportDataRequest) SetClusterId(v string) {
	m.ClusterId = v
}

func (m *ExportDataRequest) SetBucket(v string) {
	m.Bucket = v
}

func (m *ExportDataRequest) SetFilepath(v string) {
	m.Filepath = v
}

func (m *ExportDataMetadata) SetClusterId(v string) {
	m.ClusterId = v
}

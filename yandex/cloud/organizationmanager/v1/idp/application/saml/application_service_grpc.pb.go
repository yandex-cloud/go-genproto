...
const (
	ApplicationService_Get_FullMethodName                          = "/yandex.cloud.organizationmanager.v1.idp.application.saml.ApplicationService/Get"
	ApplicationService_List_FullMethodName                         = "/yandex.cloud.organizationmanager.v1.idp.application.saml.ApplicationService/List"
	ApplicationService_Create_FullMethodName                       = "/yandex.cloud.organizationmanager.v1.idp.application.saml.ApplicationService/Create"
	ApplicationService_Update_FullMethodName                       = "/yandex.cloud.organizationmanager.v1.idp.application.saml.ApplicationService/Update"
	ApplicationService_Delete_FullMethodName                       = "/yandex.cloud.organizationmanager.v1.idp.application.saml.ApplicationService/Delete"
	ApplicationService_Suspend_FullMethodName                      = "/yandex.cloud.organizationmanager.v1.idp.application.saml.ApplicationService/Suspend"
	ApplicationService_Reactivate_FullMethodName                   = "/yandex.cloud.organizationmanager.v1.idp.application.saml.ApplicationService/Reactivate"
	ApplicationService_ListSupportedAttributeValues_FullMethodName = "/yandex.cloud.organizationmanager.v1.idp.application.saml.ApplicationService/ListSupportedAttributeValues"
	ApplicationService_ListOperations_FullMethodName               = "/yandex.cloud.organizationmanager.v1.idp.application.saml.ApplicationService/ListOperations"
	ApplicationService_ListAccessBindings_FullMethodName           = "/yandex.cloud.organizationmanager.v1.idp.application.saml.ApplicationService/ListAccessBindings"
	ApplicationService_SetAccessBindings_FullMethodName            = "/yandex.cloud.organizationmanager.v1.idp.application.saml.ApplicationService/SetAccessBindings"
	ApplicationService_UpdateAccessBindings_FullMethodName         = "/yandex.cloud.organizationmanager.v1.idp.application.saml.ApplicationService/UpdateAccessBindings"
	ApplicationService_ListAssignments_FullMethodName              = "/yandex.cloud.organizationmanager.v1.idp.application.saml.ApplicationService/ListAssignments"
	ApplicationService_UpdateAssignments_FullMethodName            = "/yandex.cloud.organizationmanager.v1.idp.application.saml.ApplicationService/UpdateAssignments"
)
...
type ApplicationServiceClient interface {
	...
	ListSupportedAttributeValues(ctx context.Context, in *ListSupportedAttributeValuesRequest, opts ...grpc.CallOption) (*ListSupportedAttributeValuesResponse, error)
...
func (c *applicationServiceClient) ListSupportedAttributeValues(ctx context.Context, in *ListSupportedAttributeValuesRequest, opts ...grpc.CallOption) (*ListSupportedAttributeValuesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListSupportedAttributeValuesResponse)
	err := c.cc.Invoke(ctx, ApplicationService_ListSupportedAttributeValues_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ApplicationServiceServer interface {
	...
	// Returns the list of supported attribute values for SAML applications.
	ListSupportedAttributeValues(context.Context, *ListSupportedAttributeValuesRequest) (*ListSupportedAttributeValuesResponse, error)
	// Lists operations for the specified SAML application.
...
func (UnimplementedApplicationServiceServer) ListSupportedAttributeValues(context.Context, *ListSupportedAttributeValuesRequest) (*ListSupportedAttributeValuesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListSupportedAttributeValues not implemented")
}
...
func _ApplicationService_ListSupportedAttributeValues_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListSupportedAttributeValuesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApplicationServiceServer).ListSupportedAttributeValues(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ApplicationService_ListSupportedAttributeValues_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApplicationServiceServer).ListSupportedAttributeValues(ctx, req.(*ListSupportedAttributeValuesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ApplicationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "yandex.cloud.organizationmanager.v1.idp.application.saml.ApplicationService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListSupportedAttributeValues",
			Handler:    _ApplicationService_ListSupportedAttributeValues_Handler,
		},
		{
	...
	Metadata: "yandex/cloud/organizationmanager/v1/idp/application/saml/application_service.proto",
}

...
const file_yandex_cloud_organizationmanager_v1_os_login_service_proto_rawDesc = "" +
	...
	"\x05shell\x18\b \x01(\tR\x05shell\"\xcf\x02\n" +
	"\x1bUpdateOsLoginProfileRequest\x12;\n" +
	"\x13os_login_profile_id\x18\x01 \x01(\tB\f\xe8\xc71\x01\x8a\xc81\x04<=50R\x10osLoginProfileId\x123\n" +
	"\x05login\x18\x02 \x01(\tB\x1d\xe8\xc71\x01\xf2\xc71\r^[^.]*?[^~.]$\x8a\xc81\x04<=32R\x05login\x12.\n" +
	...
	"\x02id\x18\x01 \x01(\tB\f\xe8\xc71\x01\x8a\xc81\x04<=50R\x02id\"\xb5\x02\n" +
	"\x1bCreateOsLoginProfileRequest\x125\n" +
	"\x0forganization_id\x18\x01 \x01(\tB\f\xe8\xc71\x01\x8a\xc81\x04<=50R\x0eorganizationId\x12'\n" +
	"\n" +
	"subject_id\x18\x02 \x01(\tB\b\x8a\xc81\x04<=50R\tsubjectId\x123\n" +
	"\x05login\x18\x03 \x01(\tB\x1d\xe8\xc71\x01\xf2\xc71\r^[^.]*?[^~.]$\x8a\xc81\x04<=32R\x05login\x12.\n" +

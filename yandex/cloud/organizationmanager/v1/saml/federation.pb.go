...
type Federation struct {
	...
	CookieMaxAge *duration.Duration `protobuf:"bytes,6,opt,name=cookie_max_age,json=cookieMaxAge,proto3" json:"cookie_max_age,omitempty"`
...
func (x *Federation) GetCreatedAt() *timestamp.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
func (x *Federation) GetCookieMaxAge() *duration.Duration {
	if x != nil {
...
var file_yandex_cloud_organizationmanager_v1_saml_federation_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xdb, 0x05, 0x0a, 0x0a, 0x46, 0x65, 0x64, 0x65, 0x72, 0x61,
	...
	0x49, 0x46, 0x41, 0x43, 0x54, 0x10, 0x03, 0x42, 0x81, 0x01, 0x0a, 0x2c, 0x79, 0x61, 0x6e, 0x64,
	...
	0x2e, 0x76, 0x31, 0x2e, 0x73, 0x61, 0x6d, 0x6c, 0x5a, 0x51, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	...
	0x31, 0x2f, 0x73, 0x61, 0x6d, 0x6c, 0x3b, 0x73, 0x61, 0x6d, 0x6c, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_yandex_cloud_organizationmanager_v1_saml_federation_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_yandex_cloud_organizationmanager_v1_saml_federation_proto_depIdxs = []int32{
	3, // 0: yandex.cloud.organizationmanager.v1.saml.Federation.created_at:type_name -> google.protobuf.Timestamp
	4, // 1: yandex.cloud.organizationmanager.v1.saml.Federation.cookie_max_age:type_name -> google.protobuf.Duration

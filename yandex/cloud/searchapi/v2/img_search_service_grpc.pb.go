...
func (c *imageSearchServiceClient) Search(ctx context.Context, in *ImageSearchRequest, opts ...grpc.CallOption) (*ImageSearchResponse, error) {
	...
	err := c.cc.Invoke(ctx, ImageSearchService_Search_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func RegisterImageSearchServiceServer(s grpc.ServiceRegistrar, srv ImageSearchServiceServer) {
	// If the following call panics, it indicates UnimplementedImageSearchServiceServer was
...
var ImageSearchService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "yandex.cloud.searchapi.v2.ImageSearchService",
	...
	Metadata: "yandex/cloud/searchapi/v2/img_search_service.proto",
}

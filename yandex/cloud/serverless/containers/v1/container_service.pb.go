...
var file_yandex_cloud_serverless_containers_v1_container_service_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xf2, 0x06, 0x0a, 0x1e, 0x44, 0x65, 0x70,
	...
	0x73, 0x52, 0x0a, 0x6c, 0x6f, 0x67, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xa7, 0x03,
...
var file_yandex_cloud_serverless_containers_v1_container_service_proto_goTypes = []interface{}{
	...
	(*Command)(nil),                            // 32: yandex.cloud.serverless.containers.v1.Command
	(*Args)(nil),                               // 33: yandex.cloud.serverless.containers.v1.Args
...
var file_yandex_cloud_serverless_containers_v1_container_service_proto_depIdxs = []int32{
	...
	32, // 13: yandex.cloud.serverless.containers.v1.ImageSpec.command:type_name -> yandex.cloud.serverless.containers.v1.Command
	33, // 14: yandex.cloud.serverless.containers.v1.ImageSpec.args:type_name -> yandex.cloud.serverless.containers.v1.Args
	21, // 15: yandex.cloud.serverless.containers.v1.ImageSpec.environment:type_name -> yandex.cloud.serverless.containers.v1.ImageSpec.EnvironmentEntry
	34, // 16: yandex.cloud.serverless.containers.v1.ListContainerOperationsResponse.operations:type_name -> yandex.cloud.operation.Operation
	0,  // 17: yandex.cloud.serverless.containers.v1.ContainerService.Get:input_type -> yandex.cloud.serverless.containers.v1.GetContainerRequest
	1,  // 18: yandex.cloud.serverless.containers.v1.ContainerService.List:input_type -> yandex.cloud.serverless.containers.v1.ListContainersRequest
	3,  // 19: yandex.cloud.serverless.containers.v1.ContainerService.Create:input_type -> yandex.cloud.serverless.containers.v1.CreateContainerRequest
	5,  // 20: yandex.cloud.serverless.containers.v1.ContainerService.Update:input_type -> yandex.cloud.serverless.containers.v1.UpdateContainerRequest
	7,  // 21: yandex.cloud.serverless.containers.v1.ContainerService.Delete:input_type -> yandex.cloud.serverless.containers.v1.DeleteContainerRequest
	12, // 22: yandex.cloud.serverless.containers.v1.ContainerService.DeployRevision:input_type -> yandex.cloud.serverless.containers.v1.DeployContainerRevisionRequest
	15, // 23: yandex.cloud.serverless.containers.v1.ContainerService.Rollback:input_type -> yandex.cloud.serverless.containers.v1.RollbackContainerRequest
	9,  // 24: yandex.cloud.serverless.containers.v1.ContainerService.GetRevision:input_type -> yandex.cloud.serverless.containers.v1.GetContainerRevisionRequest
	10, // 25: yandex.cloud.serverless.containers.v1.ContainerService.ListRevisions:input_type -> yandex.cloud.serverless.containers.v1.ListContainersRevisionsRequest
	17, // 26: yandex.cloud.serverless.containers.v1.ContainerService.ListOperations:input_type -> yandex.cloud.serverless.containers.v1.ListContainerOperationsRequest
	35, // 27: yandex.cloud.serverless.containers.v1.ContainerService.ListAccessBindings:input_type -> yandex.cloud.access.ListAccessBindingsRequest
	36, // 28: yandex.cloud.serverless.containers.v1.ContainerService.SetAccessBindings:input_type -> yandex.cloud.access.SetAccessBindingsRequest
	37, // 29: yandex.cloud.serverless.containers.v1.ContainerService.UpdateAccessBindings:input_type -> yandex.cloud.access.UpdateAccessBindingsRequest
	22, // 30: yandex.cloud.serverless.containers.v1.ContainerService.Get:output_type -> yandex.cloud.serverless.containers.v1.Container
	2,  // 31: yandex.cloud.serverless.containers.v1.ContainerService.List:output_type -> yandex.cloud.serverless.containers.v1.ListContainersResponse
	34, // 32: yandex.cloud.serverless.containers.v1.ContainerService.Create:output_type -> yandex.cloud.operation.Operation
	34, // 33: yandex.cloud.serverless.containers.v1.ContainerService.Update:output_type -> yandex.cloud.operation.Operation
	34, // 34: yandex.cloud.serverless.containers.v1.ContainerService.Delete:output_type -> yandex.cloud.operation.Operation
	34, // 35: yandex.cloud.serverless.containers.v1.ContainerService.DeployRevision:output_type -> yandex.cloud.operation.Operation
	34, // 36: yandex.cloud.serverless.containers.v1.ContainerService.Rollback:output_type -> yandex.cloud.operation.Operation
	24, // 37: yandex.cloud.serverless.containers.v1.ContainerService.GetRevision:output_type -> yandex.cloud.serverless.containers.v1.Revision
	11, // 38: yandex.cloud.serverless.containers.v1.ContainerService.ListRevisions:output_type -> yandex.cloud.serverless.containers.v1.ListContainersRevisionsResponse
	18, // 39: yandex.cloud.serverless.containers.v1.ContainerService.ListOperations:output_type -> yandex.cloud.serverless.containers.v1.ListContainerOperationsResponse
	38, // 40: yandex.cloud.serverless.containers.v1.ContainerService.ListAccessBindings:output_type -> yandex.cloud.access.ListAccessBindingsResponse
	34, // 41: yandex.cloud.serverless.containers.v1.ContainerService.SetAccessBindings:output_type -> yandex.cloud.operation.Operation
	34, // 42: yandex.cloud.serverless.containers.v1.ContainerService.UpdateAccessBindings:output_type -> yandex.cloud.operation.Operation

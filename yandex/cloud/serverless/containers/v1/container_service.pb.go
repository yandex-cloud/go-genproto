...
var file_yandex_cloud_serverless_containers_v1_container_service_proto_rawDesc = []byte{
	...
	0x22, 0xde, 0x04, 0x0a, 0x1e, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x43, 0x6f, 0x6e, 0x74, 0x61,
...
var file_yandex_cloud_serverless_containers_v1_container_service_proto_goTypes = []interface{}{
	...
	(*Command)(nil),                            // 29: yandex.cloud.serverless.containers.v1.Command
	(*Args)(nil),                               // 30: yandex.cloud.serverless.containers.v1.Args
...
var file_yandex_cloud_serverless_containers_v1_container_service_proto_depIdxs = []int32{
	...
	29, // 10: yandex.cloud.serverless.containers.v1.ImageSpec.command:type_name -> yandex.cloud.serverless.containers.v1.Command
	30, // 11: yandex.cloud.serverless.containers.v1.ImageSpec.args:type_name -> yandex.cloud.serverless.containers.v1.Args
	21, // 12: yandex.cloud.serverless.containers.v1.ImageSpec.environment:type_name -> yandex.cloud.serverless.containers.v1.ImageSpec.EnvironmentEntry
	31, // 13: yandex.cloud.serverless.containers.v1.ListContainerOperationsResponse.operations:type_name -> yandex.cloud.operation.Operation
	0,  // 14: yandex.cloud.serverless.containers.v1.ContainerService.Get:input_type -> yandex.cloud.serverless.containers.v1.GetContainerRequest
	1,  // 15: yandex.cloud.serverless.containers.v1.ContainerService.List:input_type -> yandex.cloud.serverless.containers.v1.ListContainersRequest
	3,  // 16: yandex.cloud.serverless.containers.v1.ContainerService.Create:input_type -> yandex.cloud.serverless.containers.v1.CreateContainerRequest
	5,  // 17: yandex.cloud.serverless.containers.v1.ContainerService.Update:input_type -> yandex.cloud.serverless.containers.v1.UpdateContainerRequest
	7,  // 18: yandex.cloud.serverless.containers.v1.ContainerService.Delete:input_type -> yandex.cloud.serverless.containers.v1.DeleteContainerRequest
	12, // 19: yandex.cloud.serverless.containers.v1.ContainerService.DeployRevision:input_type -> yandex.cloud.serverless.containers.v1.DeployContainerRevisionRequest
	15, // 20: yandex.cloud.serverless.containers.v1.ContainerService.Rollback:input_type -> yandex.cloud.serverless.containers.v1.RollbackContainerRequest
	9,  // 21: yandex.cloud.serverless.containers.v1.ContainerService.GetRevision:input_type -> yandex.cloud.serverless.containers.v1.GetContainerRevisionRequest
	10, // 22: yandex.cloud.serverless.containers.v1.ContainerService.ListRevisions:input_type -> yandex.cloud.serverless.containers.v1.ListContainersRevisionsRequest
	17, // 23: yandex.cloud.serverless.containers.v1.ContainerService.ListOperations:input_type -> yandex.cloud.serverless.containers.v1.ListContainerOperationsRequest
	32, // 24: yandex.cloud.serverless.containers.v1.ContainerService.ListAccessBindings:input_type -> yandex.cloud.access.ListAccessBindingsRequest
	33, // 25: yandex.cloud.serverless.containers.v1.ContainerService.SetAccessBindings:input_type -> yandex.cloud.access.SetAccessBindingsRequest
	34, // 26: yandex.cloud.serverless.containers.v1.ContainerService.UpdateAccessBindings:input_type -> yandex.cloud.access.UpdateAccessBindingsRequest
	22, // 27: yandex.cloud.serverless.containers.v1.ContainerService.Get:output_type -> yandex.cloud.serverless.containers.v1.Container
	2,  // 28: yandex.cloud.serverless.containers.v1.ContainerService.List:output_type -> yandex.cloud.serverless.containers.v1.ListContainersResponse
	31, // 29: yandex.cloud.serverless.containers.v1.ContainerService.Create:output_type -> yandex.cloud.operation.Operation
	31, // 30: yandex.cloud.serverless.containers.v1.ContainerService.Update:output_type -> yandex.cloud.operation.Operation
	31, // 31: yandex.cloud.serverless.containers.v1.ContainerService.Delete:output_type -> yandex.cloud.operation.Operation
	31, // 32: yandex.cloud.serverless.containers.v1.ContainerService.DeployRevision:output_type -> yandex.cloud.operation.Operation
	31, // 33: yandex.cloud.serverless.containers.v1.ContainerService.Rollback:output_type -> yandex.cloud.operation.Operation
	24, // 34: yandex.cloud.serverless.containers.v1.ContainerService.GetRevision:output_type -> yandex.cloud.serverless.containers.v1.Revision
	11, // 35: yandex.cloud.serverless.containers.v1.ContainerService.ListRevisions:output_type -> yandex.cloud.serverless.containers.v1.ListContainersRevisionsResponse
	18, // 36: yandex.cloud.serverless.containers.v1.ContainerService.ListOperations:output_type -> yandex.cloud.serverless.containers.v1.ListContainerOperationsResponse
	35, // 37: yandex.cloud.serverless.containers.v1.ContainerService.ListAccessBindings:output_type -> yandex.cloud.access.ListAccessBindingsResponse
	31, // 38: yandex.cloud.serverless.containers.v1.ContainerService.SetAccessBindings:output_type -> yandex.cloud.operation.Operation
	31, // 39: yandex.cloud.serverless.containers.v1.ContainerService.UpdateAccessBindings:output_type -> yandex.cloud.operation.Operation

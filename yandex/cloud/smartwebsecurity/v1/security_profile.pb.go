...
func file_yandex_cloud_smartwebsecurity_v1_security_profile_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_yandex_cloud_smartwebsecurity_v1_security_profile_proto_msgTypes[4].Exporter = func(v any, i int) any {
	...
	file_yandex_cloud_smartwebsecurity_v1_security_profile_proto_msgTypes[7].OneofWrappers = []any{

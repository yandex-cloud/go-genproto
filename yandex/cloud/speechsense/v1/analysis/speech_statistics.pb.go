...
var file_yandex_cloud_speechsense_v1_analysis_speech_statistics_proto_goTypes = []interface{}{
...
func file_yandex_cloud_speechsense_v1_analysis_speech_statistics_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yandex_cloud_speechsense_v1_analysis_speech_statistics_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {

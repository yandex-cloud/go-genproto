...
type UploadTextRequest struct {
	...
	Metadata    *TalkMetadata  `protobuf:"bytes,1,opt,name=metadata,proto3" json:"metadata,omitempty"`
	TextContent []*TextContent `protobuf:"bytes,2,rep,name=text_content,json=textContent,proto3" json:"text_content,omitempty"`
}
...
var file_yandex_cloud_speechsense_v1_talk_service_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x78, 0x74, 0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x03,

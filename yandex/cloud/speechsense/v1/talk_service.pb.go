...
type UploadTalkRequest struct {
	...
	//
	//	*UploadTalkRequest_Audio
	//	*UploadTalkRequest_Text
	Payload isUploadTalkRequest_Payload `protobuf_oneof:"payload"`
}
...
func (m *UploadTalkRequest) GetPayload() isUploadTalkRequest_Payload {
	if m != nil {
		return m.Payload
	}
	return nil
...
func (x *UploadTalkRequest) GetAudio() *AudioRequest {
	if x, ok := x.GetPayload().(*UploadTalkRequest_Audio); ok {
		return x.Audio
	}
	return nil
}

func (x *UploadTalkRequest) GetText() *TextRequest {
	if x, ok := x.GetPayload().(*UploadTalkRequest_Text); ok {
		return x.Text
	}
	return nil
}

type isUploadTalkRequest_Payload interface {
	isUploadTalkRequest_Payload()
}

type UploadTalkRequest_Audio struct {
	Audio *AudioRequest `protobuf:"bytes,2,opt,name=audio,proto3,oneof"`
}

type UploadTalkRequest_Text struct {
	Text *TextRequest `protobuf:"bytes,3,opt,name=text,proto3,oneof"`
}

func (*UploadTalkRequest_Audio) isUploadTalkRequest_Payload() {}

func (*UploadTalkRequest_Text) isUploadTalkRequest_Payload() {}
...
var file_yandex_cloud_speechsense_v1_talk_service_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x22, 0xe8, 0x01, 0x0a, 0x11, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x54, 0x61, 0x6c,
	...
	0x41, 0x0a, 0x05, 0x61, 0x75, 0x64, 0x69, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x29,
	...
	0x69, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x48, 0x00, 0x52, 0x05, 0x61, 0x75, 0x64,
	0x69, 0x6f, 0x12, 0x3e, 0x0a, 0x04, 0x74, 0x65, 0x78, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b,
	...
	0x65, 0x78, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x48, 0x00, 0x52, 0x04, 0x74, 0x65,
	0x78, 0x74, 0x42, 0x09, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0xbd, 0x01,
	0x0a, 0x0c, 0x54, 0x61, 0x6c, 0x6b, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x23,
	...
	0x6e, 0x49, 0x64, 0x12, 0x4d, 0x0a, 0x06, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x18, 0x02, 0x20,
	...
	0x31, 0x2e, 0x54, 0x61, 0x6c, 0x6b, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x46,
	...
	,
	...
	0x6e, 0x64, 0x65, 0x78, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x73, 0x70, 0x65, 0x65, 0x63,
	0x68, 0x73, 0x65, 0x6e, 0x73, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64,
	0x54, 0x61, 0x6c, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x79, 0x0a, 0x1f,
...
var file_yandex_cloud_speechsense_v1_talk_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_yandex_cloud_speechsense_v1_talk_service_proto_goTypes = []interface{}{
	...
	(*TalkMetadata)(nil),          // 2: yandex.cloud.speechsense.v1.TalkMetadata
	(*UploadTalkResponse)(nil),    // 3: yandex.cloud.speechsense.v1.UploadTalkResponse
	nil,                           // 4: yandex.cloud.speechsense.v1.TalkMetadata.FieldsEntry
	(*AudioStreamingRequest)(nil), // 5: yandex.cloud.speechsense.v1.AudioStreamingRequest
	(*AudioRequest)(nil),          // 6: yandex.cloud.speechsense.v1.AudioRequest
	(*TextRequest)(nil),           // 7: yandex.cloud.speechsense.v1.TextRequest
}
var file_yandex_cloud_speechsense_v1_talk_service_proto_depIdxs = []int32{
	2, // 0: yandex.cloud.speechsense.v1.StreamTalkRequest.metadata:type_name -> yandex.cloud.speechsense.v1.TalkMetadata
	5, // 1: yandex.cloud.speechsense.v1.StreamTalkRequest.audio:type_name -> yandex.cloud.speechsense.v1.AudioStreamingRequest
	2, // 2: yandex.cloud.speechsense.v1.UploadTalkRequest.metadata:type_name -> yandex.cloud.speechsense.v1.TalkMetadata
	6, // 3: yandex.cloud.speechsense.v1.UploadTalkRequest.audio:type_name -> yandex.cloud.speechsense.v1.AudioRequest
	7, // 4: yandex.cloud.speechsense.v1.UploadTalkRequest.text:type_name -> yandex.cloud.speechsense.v1.TextRequest
	4, // 5: yandex.cloud.speechsense.v1.TalkMetadata.fields:type_name -> yandex.cloud.speechsense.v1.TalkMetadata.FieldsEntry
	0, // 6: yandex.cloud.speechsense.v1.TalkService.UploadAsStream:input_type -> yandex.cloud.speechsense.v1.StreamTalkRequest
	1, // 7: yandex.cloud.speechsense.v1.TalkService.Upload:input_type -> yandex.cloud.speechsense.v1.UploadTalkRequest
	3, // 8: yandex.cloud.speechsense.v1.TalkService.UploadAsStream:output_type -> yandex.cloud.speechsense.v1.UploadTalkResponse
	3, // 9: yandex.cloud.speechsense.v1.TalkService.Upload:output_type -> yandex.cloud.speechsense.v1.UploadTalkResponse
...
func file_yandex_cloud_speechsense_v1_talk_service_proto_init() {
	...
	file_yandex_cloud_speechsense_v1_talk_service_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*UploadTalkRequest_Audio)(nil),
		(*UploadTalkRequest_Text)(nil),
	}
	type x struct{}

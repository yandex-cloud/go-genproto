...
func (UnimplementedTalkServiceServer) UploadAsStream(grpc.ClientStreamingServer[StreamTalkRequest, UploadTalkResponse]) error {
	return status.Error(codes.Unimplemented, "method UploadAsStream not implemented")
}
...
func (UnimplementedTalkServiceServer) UploadText(context.Context, *UploadTextRequest) (*UploadTextResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UploadText not implemented")
}
func (UnimplementedTalkServiceServer) UploadBadge(grpc.ClientStreamingServer[StreamTalkRequest, operation.Operation]) error {
	return status.Error(codes.Unimplemented, "method UploadBadge not implemented")
}
...
func RegisterTalkServiceServer(s grpc.ServiceRegistrar, srv TalkServiceServer) {
	// If the following call panics, it indicates UnimplementedTalkServiceServer was

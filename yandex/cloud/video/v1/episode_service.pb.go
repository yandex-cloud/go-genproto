...
func file_yandex_cloud_video_v1_episode_service_proto_init() {
	...
	file_yandex_cloud_video_v1_episode_service_proto_msgTypes[3].OneofWrappers = []any{
	...
	file_yandex_cloud_video_v1_episode_service_proto_msgTypes[7].OneofWrappers = []any{
		(*UpdateEpisodeRequest_PublicAccess)(nil),
		(*UpdateEpisodeRequest_AuthSystemAccess)(nil),
	}
	file_yandex_cloud_video_v1_episode_service_proto_msgTypes[11].OneofWrappers = []any{

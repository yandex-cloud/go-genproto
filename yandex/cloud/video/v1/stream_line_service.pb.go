...
func file_yandex_cloud_video_v1_stream_line_service_proto_init() {
	...
	file_yandex_cloud_video_v1_stream_line_service_proto_msgTypes[3].OneofWrappers = []any{
	...
	file_yandex_cloud_video_v1_stream_line_service_proto_msgTypes[9].OneofWrappers = []any{

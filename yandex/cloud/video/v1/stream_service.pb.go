...
func file_yandex_cloud_video_v1_stream_service_proto_init() {
	...
	file_yandex_cloud_video_v1_stream_service_proto_msgTypes[3].OneofWrappers = []any{
		(*CreateStreamRequest_OnDemand)(nil),
		(*CreateStreamRequest_Schedule)(nil),
	}
	file_yandex_cloud_video_v1_stream_service_proto_msgTypes[7].OneofWrappers = []any{
		(*UpdateStreamRequest_OnDemand)(nil),
		(*UpdateStreamRequest_Schedule)(nil),
	}
	file_yandex_cloud_video_v1_stream_service_proto_msgTypes[11].OneofWrappers = []any{

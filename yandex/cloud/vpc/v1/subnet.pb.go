...
func file_yandex_cloud_vpc_v1_subnet_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yandex_cloud_vpc_v1_subnet_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Subnet); i {
			case 0:
				return &v.state
			case 1:
		...
		file_yandex_cloud_vpc_v1_subnet_proto_msgTypes[1].Exporter = func(v any, i int) any {
